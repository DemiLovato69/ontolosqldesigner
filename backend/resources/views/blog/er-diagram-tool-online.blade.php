...
@section('content')
    <article class="blog-post">
        ...
        <p>
            ...
            represents a table. Inside each entity you list the attributes (columns) with their data types. Lines
            between entities represent relationships — typically foreign key references — and the notation on each end
            of the line indicates the cardinality (one-to-one, one-to-many, many-to-many).
        </p>
        <p>
            ER diagrams originated in the 1970s with Peter Chen's paper on the entity-relationship model, and they
            remain the standard tool for database design communication today. Most database tools, from heavyweight
            enterprise software to modern online editors, produce diagrams in this format.
        </p>

        <h2>Why Use an Online ER Diagram Tool?</h2>
        <p>
            Desktop tools like MySQL Workbench can produce excellent ER diagrams, but they require installation and can
            be overkill when you just need to sketch a schema. Online tools have several advantages:
        </p>
        <ul>
            <li><strong>No installation</strong> — open your browser and start immediately.</li>
            <li><strong>Available anywhere</strong> — work from any machine, including ones where you don't have admin
                rights to install software.
            </li>
            <li><strong>Faster iteration</strong> — purpose-built online editors are often faster to work with for
                schema design specifically, without the overhead of a full DBMS GUI.
            </li>
        ...
        <p>
            Not all online diagram tools are MySQL-aware. Generic tools like draw.io or Lucidchart let you draw boxes
            and lines, but they don't understand MySQL data types, don't enforce relational constraints, and can't
            export SQL. A purpose-built MySQL ER tool should offer:
        </p>
        <ul>
            <li>MySQL-specific column types (<code>INT</code>, <code>VARCHAR</code>, <code>DECIMAL</code>, <code>DATETIME</code>,
                <code>TINYINT(1)</code>, etc.)
            </li>
            <li>Constraint support: <code>PRIMARY KEY</code>, <code>UNIQUE</code>, <code>NOT NULL</code>, <code>AUTO_INCREMENT</code>
            </li>
        ...
        <p>
            SQL Designer is a free, browser-based tool built specifically for MySQL schema design. It gives you a
            drag-and-drop canvas where you place tables, define their columns with MySQL-specific types, set
            constraints, and draw foreign key lines between tables. When you're done, you export a ready-to-run <code>CREATE
                TABLE</code> SQL script.
        </p>
        <p>
            There's no installation, no trial period, and no subscription. Create a free account with your email and you
            can start immediately. Your diagrams are saved to your account so you can return to them from any device.
        </p>
        ...
        <ul>
            ...
            <li><strong>3. Add columns</strong> — for each column, specify the name, MySQL data type, and constraints
                (PK, UQ, NN).
            </li>
            ...
            <li><strong>5. Export SQL</strong> — click the export button to generate a MySQL <code>CREATE TABLE</code>
                script you can run directly in your database client.
            </li>
        </ul>
        <p>
        ...
        <p>
            Use a generic tool (draw.io, Lucidchart, Figma) when you need a high-level conceptual model to discuss with
            stakeholders who don't need to see SQL syntax. Use a MySQL-specific tool when you're designing the actual
            schema that will be implemented — you want the diagram to map 1:1 to your DDL and be able to export it
            directly.
        </p>
        ...
        <div class="cta-box">
            ...
            <p>SQL Designer is a free, browser-based MySQL schema editor. No installation, no subscription — just create
                an account and start designing.</p>
