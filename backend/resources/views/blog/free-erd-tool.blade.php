...
@section('head')
    ...
    <script type="application/ld+json">
        ...
        },
        {
            ...
            "mainEntityOfPage": { "@type": "WebPage", "@id": "https://sql-designer.com/blog/free-erd-tool" }
        },
        {
            "@context": "https://schema.org",
            "@type": "FAQPage",
...
@section('content')
    <article class="blog-post">
        ...
        <p class="post-meta"><time datetime="2026-04-09">April 2026</time> &mdash; <time datetime="2026-05-14">Last updated: May 2026</time> &mdash; by <a href="/about" style="color:var(--color-primary-text);">Dmitriy Snyatkov</a> &mdash; 10 min read</p>
