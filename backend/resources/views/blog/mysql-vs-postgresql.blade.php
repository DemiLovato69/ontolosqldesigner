...
@section('head')
    ...
    <style>
        ...
        .key-takeaways { background: rgba(93,181,131,0.06); border: 1px solid rgba(93,181,131,0.2); border-radius: 8px; padding: 1.1rem 1.4rem; margin: 0 0 1.8rem; }
        .key-takeaways-label { font-family: 'JetBrains Mono', monospace; font-size: 0.72rem; letter-spacing: 0.12em; text-transform: uppercase; color: var(--color-primary-text); margin: 0 0 0.6rem; font-weight: 600; }
        .key-takeaways ul { margin: 0; padding: 0 0 0 1.1rem; }
        .key-takeaways li { font-size: 0.88rem; color: var(--text-secondary); line-height: 1.65; margin-bottom: 0.3rem; }

        .article-body figure { margin: 1.5rem 0; }
        .article-body figure img { width: 100%; height: auto; border-radius: 8px; display: block; border: 1px solid var(--border-color); }
        .article-body figcaption { font-size: 0.78rem; color: var(--text-muted); margin-top: 0.5rem; text-align: center; font-family: 'JetBrains Mono', monospace; }
        .article-body figure svg { width: 100%; height: auto; display: block; border-radius: 8px; }
        .article-body .video-wrap { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 8px; border: 1px solid var(--border-color); }
...
<div class="article-layout">
    ...
    <article class="article-body">
        ...
        <div class="key-takeaways">
            <p class="key-takeaways-label">Key Takeaways</p>
            <ul>
