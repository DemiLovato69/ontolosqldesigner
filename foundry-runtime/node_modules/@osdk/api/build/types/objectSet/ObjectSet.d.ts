...
import type { ApplyModifiersArg, PropertyModifierValue } from "../ontology/PropertyModifiers.js";
...
> = keyof D extends never ? Q : DerivedObjectOrInterfaceDefinition.WithDerivedProperties<Q, D>;
...
> extends BaseObjectSet<Q>, FetchPage<Q, RDPs>, AsyncIter<Q, RDPs, ORDER_BY_OPTIONS>, Where<Q, RDPs>, AsyncIterLinks<Q>, Subscribe<MergeObjectSet<Q, RDPs>> {}
...
type ModifiersToSelectStrings<M> = { [K in keyof M] : K extends string ? M[K] extends PropertyModifierValue ? `${K}:${M[K]}` : never : never }[keyof M];
interface FetchPage<
	Q extends ObjectOrInterfaceDefinition,
	RDPs extends Record<string, SimplePropertyDef> = {}
> {
...
> {
	...
	*/
	<
		...
		ORDER_BY_OPTIONS extends ObjectSetArgs.OrderByOptions<PropertyKeys<Q>> = {},
		const MODIFIERS extends ApplyModifiersArg<Q> = {}
	>(args?: AsyncIterArgs<Q, L, R, A, S, T, never, ORDER_BY_OPTIONS, PROPERTY_SECURITIES, MODIFIERS>): AsyncIterableIterator<MaybeScore<Osdk.Instance<Q, ExtractOptions<R, S, T, PROPERTY_SECURITIES>, NoInfer<SubSelectKeys<Q, NonNullable<typeof args>>>, SubSelectRDPs<RDPs, NonNullable<typeof args>>>, ORDER_BY_OPTIONS>>;
}
interface AsyncIter<
	Q extends ObjectOrInterfaceDefinition,
	RDPs extends Record<string, SimplePropertyDef> = {},
...
interface ObjectSetCleanedTypes<
	...
	ORDER_BY_OPTIONS extends ObjectSetArgs.OrderByOptions<PropertyKeys<Q>> = {}
> extends MinimalObjectSet<Q, D, ORDER_BY_OPTIONS>, WithProperties<Q, D>, Aggregate<MERGED>, SetArithmetic<MERGED>, PivotTo<Q>, FetchOne<Q, D>, NearestNeighbors<Q>, NarrowToType<Q> {}
export {};
