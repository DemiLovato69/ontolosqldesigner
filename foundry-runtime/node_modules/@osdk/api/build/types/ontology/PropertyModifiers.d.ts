...
import type { CompileTimeMetadata, ObjectMetadata } from "./ObjectTypeDefinition.js";
...
export type PropsWithBoth<Q extends ObjectOrInterfaceDefinition> = PropsWithMainValue<Q> & PropsWithReducers<Q>;
export type PropsWithOnlyMainValue<Q extends ObjectOrInterfaceDefinition> = Exclude<PropsWithMainValue<Q>, PropsWithReducers<Q>>;
export type PropsWithOnlyReducers<Q extends ObjectOrInterfaceDefinition> = Exclude<PropsWithReducers<Q>, PropsWithMainValue<Q>>;
export type ApplyModifiersArg<Q extends ObjectOrInterfaceDefinition> = { [P in PropsWithOnlyMainValue<Q>]? : "applyMainValue" } & { [P in PropsWithOnlyReducers<Q>]? : "applyReducers" } & { [P in PropsWithBoth<Q>]? : "applyMainValue" | "applyReducers" | "applyReducersAndExtractMainValue" };
