...
import type { BlockSetInstallationRid as _api_BlockSetInstallationRid, ListBlockInstallationJobsResponseV2 as _api_ListBlockInstallationJobsResponseV2, ListBlockInstallationJobsV2PageToken as _api_ListBlockInstallationJobsV2PageToken, MarketplaceRid as _api_MarketplaceRid, PageSizeLimitHint as _api_PageSizeLimitHint } from "../__components.js";
/**
...
* `marketplaceRid`.
*/
export declare function listBlockInstallationJobsV2(ctx: ConjureContext, marketplaceRid: _api_MarketplaceRid, blockSetInstallationRid: _api_BlockSetInstallationRid | null | undefined, pageToken: _api_ListBlockInstallationJobsV2PageToken | null | undefined, limit: _api_PageSizeLimitHint | null | undefined): Promise<_api_ListBlockInstallationJobsResponseV2>;
