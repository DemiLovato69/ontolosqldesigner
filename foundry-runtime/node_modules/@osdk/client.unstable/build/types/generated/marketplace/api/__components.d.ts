import type { EnumParameter as _api_eddie_transformations_api_EnumParameter, ExplicitType as _api_eddie_transformations_api_ExplicitType, InputParameterType as _api_eddie_transformations_api_InputParameterType, LiteralConstraint as _api_eddie_transformations_api_LiteralConstraint, LiteralParameter as _api_eddie_transformations_api_LiteralParameter, Parameter as _api_eddie_transformations_api_Parameter, ParameterId as _api_eddie_transformations_api_ParameterId, RegexParameter as _api_eddie_transformations_api_RegexParameter, RegexParameterType as _api_eddie_transformations_api_RegexParameterType } from "./eddie/transformations/api/__components.js";
import type { MarketplaceSerializableError as _api_errors_MarketplaceSerializableError } from "./errors/__components.js";
import type { ContractExpression as _api_function_contracts_ContractExpression } from "./function/contracts/__components.js";
import type { CustomType as _api_functions_CustomType, CustomTypeFieldName as _api_functions_CustomTypeFieldName, CustomTypeId as _api_functions_CustomTypeId, DataType as _api_functions_DataType } from "./functions/__components.js";
export interface AbortedStatusV3 {
...
export type ActionParameterRidOrId = ActionParameterRidOrId_rid | ActionParameterRidOrId_id;
...
*/
export type ActionParameterV1MappingInfo = Record<ActionParameterShapeId, BlockSetShapeId>;
export type ActionTypeApiName = string;
/**
* DEPRECATED: Replaced by block set shapes internal recommendations.
...
export interface ActionTypeBlockSetRecommendation {
	...
	inputParameterShapesFulfilledBy: Record<ActionParameterShapeId, ActionParameterShapeId>;
...
export type ActionTypeIdentifier = ActionTypeIdentifier_ridWithoutNestedParameters | ActionTypeIdentifier_rid | ActionTypeIdentifier_ridWithParameters;
...
export type ActionTypeParameterIdentifier = ActionTypeParameterIdentifier_parameterAndAction;
/**
...
export interface ActionTypeShapeDisplayMetadata {
	about: LocalizedTitleAndDescription;
	parameters: Record<ActionParameterShapeId, ActionTypeParameterShapeDisplayMetadata>;
}
...
export type AllPossibleVersionsMissingInputsConstraintFailure = Record<BlockSetVersionId, BlockSetVersionMissingInputsConstraintFailure>;
export type AllPossibleVersionsMissingInputsConstraintFailureV2 = Record<BlockSetVersionId, BlockSetVersionMissingInputsConstraintFailureV2>;
/**
* Logical AND - destination function must satisfy ALL nested expressions.
*/
export interface AndExpressionIdentifier {
	expressions: Array<ContractExpressionIdentifier>;
}
/**
...
/**
* The names of secrets needed for an Apollo agent to operate. This is only used for unprivileged agents right now.
*/
export type ApolloAgentSecretType = "TOFU_SECRET" | "PRIVATE_KEY_PASSPHRASE";
/**
...
export type ApolloBlockSetPublishingStatus = ApolloBlockSetPublishingStatus_success | ApolloBlockSetPublishingStatus_inProgress | ApolloBlockSetPublishingStatus_failure;
/**
...
/**
* A simple wrapper around ApolloEnvironmentId that exposes whether the environment is privileged or not.
*/
export interface ApolloEnvironment {
	id: ApolloEnvironmentId;
	privileged: boolean;
}
/**
...
* `enrollmentsRids` and of the `organizationRids`. A given resource identifier cannot appear in both its allowed
* and disallowed configuration.
* If the allowed and disallowed configuration options overlap, the organization-level configuration takes
* precedence over enrollment-level configuration; configurers can disallow an enrollment and allow an
* organization in that enrollment.
...
export interface ApolloGranularConfig {
	disallowedEnrollmentRids: Array<EnrollmentRid>;
	disallowedOrganizationRids: Array<OrganizationRid>;
...
/**
* A uniquely identified Apollo secret by its name and key.
*/
export interface ApolloSecretAndKeyName {
	secretKeyName: SecretKey;
	secretName: ApolloSecretName;
}
/**
...
export interface ApolloSpaceToPublishingStatus {
	apolloSpacePublishingStatus: Record<ApolloSpaceId, ApolloBlockSetPublishingStatus>;
}
export interface ApolloStackLevelConfig {
	...
	forceDefault?: boolean | null | undefined;
}
...
*/
export type ApolloStackManagementConfig = ApolloStackManagementConfig_stackLevelConfig | ApolloStackManagementConfig_granularConfig;
...
export interface AppConfigOutputSpecConfig {
	schemaVersion?: number | null | undefined;
}
/**
...
/**
* Creates a Gotham artifacts peer producer profile block for the given peer producer profile rid
*/
export interface ArtifactsPeerProducerProfileCreateBlockRequest {
	peerProducerProfileRid: string;
}
...
export interface AsCodeBlockSetMetadata {
	buildToolOrigin: BuildToolOrigin;
...
export type AssociatedBlockSetInstallation = AssociatedBlockSetInstallation_newBlockSet | AssociatedBlockSetInstallation_existingBlockSet;
/**
...
export type AttachResourceValidationErrors = AttachResourceValidationErrors_attachResourcesNotSupportedForBlockType;
...
export type AuthoringLibraryLocator = AuthoringLibraryLocator_condaLocator | AuthoringLibraryLocator_condaLocatorV2;
/**
...
* and libraries
*/
export type AuthoringRepositoryEnvironmentIdentificationMethod = AuthoringRepositoryEnvironmentIdentificationMethod_jobSpecs;
/**
...
export interface AuthoringRepositoryOutputSpecConfig {
	...
	library?: Array<LibraryLocatorEnvironmentIdentificationMethod> | null | undefined;
	sourceCodeConfig?: AuthoringRepositorySourceCodeConfig | null | undefined;
	templatizeSourceCode?: boolean | null | undefined;
}
export type AuthoringRepositoryReference = BlockInternalId;
...
*/
export type AuthoringRepositorySourceCodeConfig = "OMIT_SOURCE_CODE" | "SHALLOW_CLONE" | "DEEP_CLONE";
export interface AutomappedInput {
	level: AutomappingLevel;
	resolvedInput: ResolvedBlockSetInputShape;
}
export interface AutomappingLevel_topLevel {
	type: "topLevel";
	topLevel: TopLevelAutomapping;
}
export interface AutomappingLevel_childLevel {
	type: "childLevel";
	childLevel: ChildLevelAutomapping;
}
export type AutomappingLevel = AutomappingLevel_topLevel | AutomappingLevel_childLevel;
...
export type AutomationStatus = AutomationStatus_idle | AutomationStatus_processing | AutomationStatus_failedConstraints | AutomationStatus_upgrading;
export interface AutopilotWorkbenchCreateBlockRequest {
	rid: string;
}
export interface AutopilotWorkbenchIdentifier {
	rid: AutopilotWorkbenchRid;
}
export type AutopilotWorkbenchRid = string;
export interface AutopilotWorkbenchShape {
	about: LocalizedTitleAndDescription;
}
...
export interface BatchEditBlockSetVersionError_draftGroupNotEditable {
	type: "draftGroupNotEditable";
	draftGroupNotEditable: Void;
}
export interface BatchEditBlockSetVersionError_editPermissionDenied {
	type: "editPermissionDenied";
	editPermissionDenied: BatchEditPermissionDeniedError;
}
export interface BatchEditBlockSetVersionError_notFound {
	type: "notFound";
	notFound: Void;
}
export interface BatchEditBlockSetVersionError_notInEditableState {
	type: "notInEditableState";
	notInEditableState: Void;
}
export interface BatchEditBlockSetVersionError_ownedByOtherUser {
	type: "ownedByOtherUser";
	ownedByOtherUser: BatchOwnedByOtherUserError;
}
/**
* Describes why a specific block set version could not be edited in a batch update operation.
*/
export type BatchEditBlockSetVersionError = BatchEditBlockSetVersionError_draftGroupNotEditable | BatchEditBlockSetVersionError_editPermissionDenied | BatchEditBlockSetVersionError_notFound | BatchEditBlockSetVersionError_notInEditableState | BatchEditBlockSetVersionError_ownedByOtherUser;
export interface BatchEditPermissionDeniedError {
	marketplaceRid: MarketplaceRid;
}
...
export interface BatchGetApolloBlockSetVersionPublishingStatusResponse {
	blockSetVersionIdToSpacesStatus: Record<BlockSetVersionId, ApolloSpaceToPublishingStatus>;
}
...
export interface BatchGetBlockSetVersionStatusV3Request {
	blockSetVersionIds: Array<BlockSetVersionId>;
}
export interface BatchGetBlockSetVersionStatusV3Response {
	statuses: Record<BlockSetVersionId, BlockSetVersionStatusV3>;
}
...
export interface BatchGetPendingBlockSetVersionMetadataRequest {
	blockSetVersionIds: Array<BlockSetVersionId>;
}
export interface BatchGetPendingBlockSetVersionMetadataResponse {
	metadata: Record<BlockSetVersionId, PendingBlockSetVersionMetadata>;
}
export interface BatchOwnedByOtherUserError {
	owningUser: MultipassUserId;
}
export interface BatchUpdatePendingBlockSetVersionMetadataRequestItemV3 {
	blockSetVersionId: BlockSetVersionId;
	request: UpdatePendingBlockSetVersionMetadataRequestV3;
}
...
export type BlockCreationError = BlockCreationError_aborted | BlockCreationError_dataUploadTimeout | BlockCreationError_dataUploadFailed | BlockCreationError_generic;
...
* Errors specific to ActionParameterTypeShape(s).
*/
export type BlockInstallActionTypeParameterShapeErrorV2 = BlockInstallActionTypeParameterShapeErrorV2_shapeTypeMismatch | BlockInstallActionTypeParameterShapeErrorV2_shapeTypeObjectTypeIdUnresolvable | BlockInstallActionTypeParameterShapeErrorV2_shapeTypeInterfaceTypeRidUnresolvable | BlockInstallActionTypeParameterShapeErrorV2_shapeTypeUnknown;
/**
...
* Shape groups are installed at the same time and are affected by the same error.
*/
export interface BlockInstallationFailureV2 {
	affectedShapes: Array<OutputBlockSetShapeId>;
	blockType: BlockType;
...
export interface BlockInstallationJob {
	...
	cleanupUnusedShapesStatuses: Record<BlockSetInstallationRid, CleanupUnusedShapesStatuses>;
...
export type BlockInstallBlobsterResourceShapeError = BlockInstallBlobsterResourceShapeError_serviceMismatch | BlockInstallBlobsterResourceShapeError_typeMismatch;
/**
...
export type BlockInstallColumnShapeError = BlockInstallColumnShapeError_typeMismatch | BlockInstallColumnShapeError_datasourceReferenceMismatch | BlockInstallColumnShapeError_datasourceReferenceUnresolvable | BlockInstallColumnShapeError_missingColumnTypeClass;
/**
...
export type BlockInstallCompassResourceShapeError = BlockInstallCompassResourceShapeError_typeMismatch | BlockInstallCompassResourceShapeError_outputTypeMismatch;
/**
...
/**
* Block API level installation error. Errors may relate to specific blocks, or the job as a whole.
*/
export type BlockInstallError = BlockInstallError_installFailure | BlockInstallError_buildFailure | BlockInstallError_buildTimeout | BlockInstallError_installTimedOut | BlockInstallError_inputDependencyCycles | BlockInstallError_noProcessableInstallationInstructions | BlockInstallError_illegalRequestError | BlockInstallError_failedToDeleteResources | BlockInstallError_indexFailure | BlockInstallError_reconcileBlockInstallationResponseError | BlockInstallError_buildOrchestrationFailure;
/**
* Either a generic integration error or marketplace error.
*/
...
export interface BlockInstallFunctionShapeError_doesNotSatisfyContractExpression {
	type: "doesNotSatisfyContractExpression";
	doesNotSatisfyContractExpression: FunctionDoesNotSatisfyContractExpression;
}
...
export interface BlockInstallFunctionShapeError_outputTypeMismatch {
	type: "outputTypeMismatch";
	outputTypeMismatch: FunctionOutputTypeMismatch;
}
...
export type BlockInstallFunctionShapeErrorV2 = BlockInstallFunctionShapeErrorV2_shapeConversion | BlockInstallFunctionShapeErrorV2_incompatibleSignature;
/**
...
export type BlockInstallInputShapeNotSpecified = BlockInstallInputShapeNotSpecified_requiredInputShape | BlockInstallInputShapeNotSpecified_usedByInputGroup;
/**
...
/**
* The InterfaceActionTypeConstraint does not include all the necessary parameter constraints.
*/
...
export interface BlockInstallInterfaceActionTypeConstraintShapeError_interfaceTypeReferenceUnresolvable {
	type: "interfaceTypeReferenceUnresolvable";
	interfaceTypeReferenceUnresolvable: InterfaceTypeReferenceUnresolvable;
}
export interface BlockInstallInterfaceActionTypeConstraintShapeError_interfaceTypeReferenceMismatch {
...
export interface BlockInstallInterfaceParameterConstraintNotFound {
	interfaceActionTypeConstraintRid: InterfaceActionTypeConstraintRid;
...
export type BlockInstallModelShapeError = BlockInstallModelShapeError_serviceMismatch | BlockInstallModelShapeError_ridTypeMismatch | BlockInstallModelShapeError_modelTypeMismatch | BlockInstallModelShapeError_modelTypeMismatchV2 | BlockInstallModelShapeError_modelTypeMismatchV3;
/**
...
export type BlockInstallNotepadTemplateParameterShapeError = BlockInstallNotepadTemplateParameterShapeError_parameterTypeMismatch;
/**
...
export type BlockInstallObjectTypeShapeError = BlockInstallObjectTypeShapeError_backendIncompatible | BlockInstallObjectTypeShapeError_editsSupportIncompatible | BlockInstallObjectTypeShapeError_objectsBackendUnknown | BlockInstallObjectTypeShapeError_outputBackendMismatch | BlockInstallObjectTypeShapeError_outputEditsSupportMismatch;
/**
...
*/
export type BlockInstallPrefixShapeError = BlockInstallPrefixShapeError_prefixInvalid | BlockInstallPrefixShapeError_inconsistentPrefix;
/**
...
export interface BlockInstallPropertyTypeShapeError_vectorTypeMismatchNonBlocking {
	type: "vectorTypeMismatchNonBlocking";
	vectorTypeMismatchNonBlocking: PropertyTypeMismatch;
}
...
*/
export type BlockInstallTabularDatasourceShapeError = BlockInstallTabularDatasourceShapeError_typeNotSupported | BlockInstallTabularDatasourceShapeError_typeUnknown;
...
export type BlockReference = BlockReference_existingBlock | BlockReference_newBlock;
export interface BlockSet {
	about: LocalizedTitleAndDescription;
	additionalRecommendationVariants: Record<BlockSetRecommendationId, BlockSetRecommendationVariant>;
...
export type BlockSetCreationAbortReason = BlockSetCreationAbortReason_userRequested | BlockSetCreationAbortReason_error;
export interface BlockSetDocumentation {
	...
	localizedFreeFormSections?: LocalizedFreeFormDocumentationSections | null | undefined;
...
export type BlockSetInputGroups = Record<BlockSetInputGroupId, InputGroupBlockSetMappingInfo>;
/**
* The block set contains blocks that have a cyclical preallocate access dependency on each other. Marketplace
* won't be able to install this block set in its current state as there is no valid ordering that ensures all
* required outputs are preallocated before the blocks that depend on them.
*/
export interface BlockSetInputsAccessedInPreallocateCycle {
...
export type BlockSetInputShapeDiffSeverity = "REQUIRES_ADDITIONAL_CONFIGURATION" | "BACKWARDS_COMPATIBLE";
...
export type BlockSetInputShapeDiffType = BlockSetInputShapeDiffType_inputShapeAdded | BlockSetInputShapeDiffType_inputShapeRemoved | BlockSetInputShapeDiffType_inputShapeModified;
...
export type BlockSetInputShapes = Record<InputBlockSetShapeId, InputBlockSetMappingInfo>;
/**
...
*/
export interface BlockSetInputShapesNotMergeableError {
	error?: _api_errors_MarketplaceSerializableError | null | undefined;
...
export type BlockSetInstallationHintsV1 = Record<BlockSetInstallationHintId, BlockSetInstallationHint>;
...
export interface BlockSetInstallationJob {
	...
	jobErrors: Array<_api_errors_MarketplaceSerializableError>;
...
export type BlockSetInstallationJobStatus = BlockSetInstallationJobStatus_inProgress | BlockSetInstallationJobStatus_building | BlockSetInstallationJobStatus_success | BlockSetInstallationJobStatus_error;
/**
...
export interface BlockSetInstallationMetadata {
	...
	targetVersionV2?: BlockSetVersionId | null | undefined;
...
export interface BlockSetInstallationResolvedEntities {
	...
	resolvedInputsV2: Record<InputBlockSetShapeId, BlockSetInstallationResolvedInput>;
...
export type BlockSetInstallationResolvedInputSource = BlockSetInstallationResolvedInputSource_externallyRecommendedOutput | BlockSetInstallationResolvedInputSource_manuallyProvided | BlockSetInstallationResolvedInputSource_fromDefault;
...
export type BlockSetInstallationResolvedInputSourceV2 = BlockSetInstallationResolvedInputSourceV2_externallyRecommendedOutput | BlockSetInstallationResolvedInputSourceV2_manuallyProvided | BlockSetInstallationResolvedInputSourceV2_fromDefault;
export interface BlockSetInstallationResolvedInputSourceV3_externallyRecommendedOutput {
	type: "externallyRecommendedOutput";
	externallyRecommendedOutput: ExternallyRecommendedOutputV2;
}
export interface BlockSetInstallationResolvedInputSourceV3_manuallyProvided {
	type: "manuallyProvided";
	manuallyProvided: ManuallyProvidedInputV2;
}
export interface BlockSetInstallationResolvedInputSourceV3_fromDefault {
	type: "fromDefault";
	fromDefault: FromDefaultInput;
}
export interface BlockSetInstallationResolvedInputSourceV3_automapped {
	type: "automapped";
	automapped: AutomappedInput;
}
export type BlockSetInstallationResolvedInputSourceV3 = BlockSetInstallationResolvedInputSourceV3_externallyRecommendedOutput | BlockSetInstallationResolvedInputSourceV3_manuallyProvided | BlockSetInstallationResolvedInputSourceV3_fromDefault | BlockSetInstallationResolvedInputSourceV3_automapped;
export interface BlockSetInstallationResolvedInputV2 {
	source: BlockSetInstallationResolvedInputSourceV2;
}
export interface BlockSetInstallationResolvedInputV3 {
	source: BlockSetInstallationResolvedInputSourceV3;
}
export interface BlockSetInstallationResolvedShapes {
	resolvedInputGroups: Record<BlockSetInputGroupId, ResolvedBlockSetInputGroup>;
	resolvedInputs: Record<InputBlockSetShapeId, BlockSetInstallationResolvedInputV2>;
	resolvedOutputs: Record<OutputBlockSetShapeId, ResolvedBlockSetOutputShape>;
}
/**
...
export interface BlockSetInstallationTargetState {
	...
	resolvedInputShapesV2: Record<InputBlockSetShapeId, InstallationResolvedInputShape>;
	resolvedOutputShapesToAttach: Record<OutputBlockSetShapeId, ResolvedBlockSetOutputShape>;
...
export interface BlockSetInstallationV2 {
	appliedRecommendations: Array<AppliedExternalRecommendationV2>;
	blockInstanceInstallationRids: Record<BlockSetBlockInstanceId, BlockInstallationRid>;
	blockSetId: BlockSetId;
	blockSetInstallationRid: BlockSetInstallationRid;
	blockSetVersionId: BlockSetVersionId;
	blockSetVersionIdV2?: BlockSetVersionId | null | undefined;
	blockSetVersions: Array<BlockSetVersionId>;
...
export interface BlockSetInstallValidationErrorDetailV2_incompatibleLinkedProduct {
	type: "incompatibleLinkedProduct";
	incompatibleLinkedProduct: IncompatibleLinkedProduct;
}
...
export interface BlockSetInstallValidationErrorDetailV2_invalidLinkedProduct {
	type: "invalidLinkedProduct";
	invalidLinkedProduct: InvalidLinkedProduct;
}
...
export type BlockSetOutputShapeDiffSeverity = "BACKWARDS_INCOMPATIBLE" | "BACKWARDS_COMPATIBLE";
...
export type BlockSetOutputShapeDiffType = BlockSetOutputShapeDiffType_outputShapeAdded | BlockSetOutputShapeDiffType_outputShapeRemoved | BlockSetOutputShapeDiffType_outputShapeModified;
export interface BlockSetOutputShapeMetadata {
	createdAt: string;
...
export type BlockSetOutputShapes = Record<OutputBlockSetShapeId, OutputBlockSetMappingInfo>;
...
/**
* A member sourced from a marketplace store.
*/
export interface BlockSetProductGroupMember {
	blockSetId: BlockSetId;
	marketplaceRid: MarketplaceRid;
	versionPolicy: BlockSetProductGroupMemberVersionPolicy;
}
export interface BlockSetProductGroupMemberVersionPolicy_latest {
	type: "latest";
	latest: LatestVersionPolicy;
}
export interface BlockSetProductGroupMemberVersionPolicy_pinnedVersion {
	type: "pinnedVersion";
	pinnedVersion: PinnedVersionPolicy;
}
export interface BlockSetProductGroupMemberVersionPolicy_releaseChannel {
	type: "releaseChannel";
	releaseChannel: ReleaseChannelVersionPolicy;
}
/**
* Determines which version of a block set is resolved for a product group member.
*/
export type BlockSetProductGroupMemberVersionPolicy = BlockSetProductGroupMemberVersionPolicy_latest | BlockSetProductGroupMemberVersionPolicy_pinnedVersion | BlockSetProductGroupMemberVersionPolicy_releaseChannel;
...
* DEPRECATED: Replaced by block set shapes internal recommendations.
*/
export type BlockSetRecommendationBody = BlockSetRecommendationBody_simple | BlockSetRecommendationBody_actionType;
...
export type BlockSetReference = BlockSetReference_existingBlockSet | BlockSetReference_newBlockSet;
/**
...
export interface BlockSetShapeDependencies {
	...
	metadata?: BlockSetOutputShapeMetadata | null | undefined;
...
export interface BlockSetShapeDiffCounts {
	added: number;
	modified: number;
	removed: number;
}
...
* DEPRECATED
*/
export type BlockSetShapeInternal = BlockSetShapeInternal_input | BlockSetShapeInternal_output;
/**
* Mapping information between shapes on all blocks and the corresponding deduplicated BlockSetShapes.
*/
export type BlockSetShapeMappingInfo = Record<BlockSetBlockInstanceId, BlockShapesMappingInfo>;
/**
...
*/
export type BlockSetShapeVisibility = BlockSetShapeVisibility_visible | BlockSetShapeVisibility_invisible;
/**
...
export interface BlockSetSizeLimitThresholdReached {
	...
	blockSetOutputLimitCount?: BlockSetOutputShapeSizeLimitCount | null | undefined;
...
export interface BlockSetVersionDiffSummary {
	inputShapes: BlockSetShapeDiffCounts;
	outputShapes: BlockSetShapeDiffCounts;
}
/**
...
*/
export type BlockSetVersionErrorRecovery = BlockSetVersionErrorRecovery_idle | BlockSetVersionErrorRecovery_materializing | BlockSetVersionErrorRecovery_finalizing;
...
export interface BlockSetVersionMaterializingError {
	erroredUpdateId?: UpdatePendingBlockSetVersionSpecsRequestId | null | undefined;
	errorMessage: string;
}
export type BlockSetVersionMissingInputsConstraintFailure = Record<BlockVersionId, Array<BlockShapeId>>;
export type BlockSetVersionMissingInputsConstraintFailureV2 = Array<InputBlockSetShapeId>;
...
export interface BlockSetVersionStatusResponse_idle {
	type: "idle";
	idle: IdleBlockSetVersionStatus;
}
export interface BlockSetVersionStatusResponse_materializing {
	type: "materializing";
	materializing: MaterializingBlockSetVersionStatus;
}
export interface BlockSetVersionStatusResponse_finalizing {
	type: "finalizing";
	finalizing: Void;
}
export interface BlockSetVersionStatusResponse_finalized {
	type: "finalized";
	finalized: FinalizedBlockSetVersionStatus;
}
export interface BlockSetVersionStatusResponse_aborted {
	type: "aborted";
	aborted: BlockSetCreationAbortReason;
}
export type BlockSetVersionStatusResponse = BlockSetVersionStatusResponse_initializing | BlockSetVersionStatusResponse_idle | BlockSetVersionStatusResponse_materializing | BlockSetVersionStatusResponse_finalizing | BlockSetVersionStatusResponse_finalized | BlockSetVersionStatusResponse_aborted;
export interface BlockSetVersionStatusV3_initializing {
	type: "initializing";
	initializing: InitializingStatusV3;
}
export interface BlockSetVersionStatusV3_idle {
	type: "idle";
	idle: IdleStatusV3;
}
export interface BlockSetVersionStatusV3_processing {
	type: "processing";
	processing: ProcessingStatusV3;
}
export interface BlockSetVersionStatusV3_uploading {
	type: "uploading";
	uploading: UploadingStatusV3;
}
export interface BlockSetVersionStatusV3_finalizing {
	type: "finalizing";
	finalizing: FinalizingStatusV3;
}
export interface BlockSetVersionStatusV3_finalized {
	type: "finalized";
	finalized: FinalizedStatusV3;
}
export interface BlockSetVersionStatusV3_aborted {
	type: "aborted";
	aborted: AbortedStatusV3;
}
export type BlockSetVersionStatusV3 = BlockSetVersionStatusV3_initializing | BlockSetVersionStatusV3_idle | BlockSetVersionStatusV3_processing | BlockSetVersionStatusV3_uploading | BlockSetVersionStatusV3_finalizing | BlockSetVersionStatusV3_finalized | BlockSetVersionStatusV3_aborted;
...
export interface BlockSetVersionValidationErrorDetail_emptyOutputSpecs {
	type: "emptyOutputSpecs";
	emptyOutputSpecs: BlockSetVersionEmptyOutputSpecsError;
}
export interface BlockSetVersionValidationErrorDetail_emptyTitle {
	type: "emptyTitle";
	emptyTitle: BlockSetVersionEmptyTitleError;
}
...
export interface BlockSetVersionValidationErrorDetail_inputShapeInvalidReference {
...
export interface BlockSetVersionValidationErrorDetail_inputShapesNotMergeable {
	type: "inputShapesNotMergeable";
	inputShapesNotMergeable: BlockSetInputShapesNotMergeableError;
}
export interface BlockSetVersionValidationErrorDetail_inputsAccessedInPreallocateCycle {
	type: "inputsAccessedInPreallocateCycle";
	inputsAccessedInPreallocateCycle: BlockSetInputsAccessedInPreallocateCycle;
}
export interface BlockSetVersionValidationErrorDetail_inputsAccessedInReconcileCycle {
...
export interface BlockSetVersionValidationErrorDetail_missingInternalRecommendation {
	type: "missingInternalRecommendation";
	missingInternalRecommendation: MissingInternalRecommendationError;
}
export interface BlockSetVersionValidationErrorDetail_sizeLimitThresholdReachedV3 {
	type: "sizeLimitThresholdReachedV3";
	sizeLimitThresholdReachedV3: BlockSetSizeLimitThresholdReached;
}
export interface BlockSetVersionValidationErrorDetail_strictFolderTrackingNoDiscoverySpec {
	type: "strictFolderTrackingNoDiscoverySpec";
	strictFolderTrackingNoDiscoverySpec: StrictFolderTrackingNoDiscoverySpec;
}
...
*/
export type BlockShapeBuildMetadata = BlockShapeBuildMetadata_shapeJobSpecsBuildMetadata;
/**
...
export interface BlockSpecificConfiguration_artifactsPeerProducerProfile {
	type: "artifactsPeerProducerProfile";
	artifactsPeerProducerProfile: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_foundryPeerProducerProfile {
	type: "foundryPeerProducerProfile";
	foundryPeerProducerProfile: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_functionPackageConfiguration {
	type: "functionPackageConfiguration";
	functionPackageConfiguration: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_modelStudio {
	type: "modelStudio";
	modelStudio: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_peerProfile {
	type: "peerProfile";
	peerProfile: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_savedSearchAroundV2 {
	type: "savedSearchAroundV2";
	savedSearchAroundV2: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_storedProcedure {
	type: "storedProcedure";
	storedProcedure: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificConfiguration_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: DefaultBlockSpecificConfiguration;
}
export interface BlockSpecificConfiguration_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: DefaultBlockSpecificConfiguration;
}
export interface BlockSpecificConfiguration_workflowGraph {
	type: "workflowGraph";
	workflowGraph: DefaultBlockSpecificConfiguration;
}
export interface BlockSpecificConfiguration_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: DefaultBlockSpecificConfiguration;
}
...
export interface BlockSpecificCreateRequest_artifactsPeerProducerProfile {
	type: "artifactsPeerProducerProfile";
	artifactsPeerProducerProfile: ArtifactsPeerProducerProfileCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: AutopilotWorkbenchCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_contour {
	type: "contour";
	contour: ContourCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_foundryPeerProducerProfile {
	type: "foundryPeerProducerProfile";
	foundryPeerProducerProfile: FoundryPeerProducerProfileCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_functionPackageConfiguration {
	type: "functionPackageConfiguration";
	functionPackageConfiguration: FunctionPackageConfigurationCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_modelStudio {
	type: "modelStudio";
	modelStudio: ModelStudioCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_peerProfile {
	type: "peerProfile";
	peerProfile: PeerProfileCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_savedSearchAroundV2 {
	type: "savedSearchAroundV2";
	savedSearchAroundV2: SavedSearchAroundV2CreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_storedProcedure {
	type: "storedProcedure";
	storedProcedure: StoredProcedureCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: VersionedObjectSetCreateBlockRequest;
}
...
export interface BlockSpecificCreateRequest_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: WorkbenchTemplateCreateBlockRequest;
}
export interface BlockSpecificCreateRequest_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: WorkflowBuilderGraphCreateBlockRequest;
}
export interface BlockSpecificCreateRequest_workflowGraph {
	type: "workflowGraph";
	workflowGraph: WorkflowGraphCreateBlockRequest;
}
export interface BlockSpecificCreateRequest_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: SqlWorksheetCreateBlockRequest;
}
...
export interface BlockV1 {
	...
	knownIdentifiers: Record<KnownIdentifier, BlockInternalId>;
...
export type BlockVersionCreationPendingStatus = BlockVersionCreationPendingStatus_waitingForData | BlockVersionCreationPendingStatus_waitingForFinalization;
...
export type BlockVersionCreationStatus = BlockVersionCreationStatus_pending | BlockVersionCreationStatus_success | BlockVersionCreationStatus_error;
/**
...
/**
* The build tool used to produce this OAC bundle
*/
export type BuildToolOrigin = "GRADLE" | "CLI";
export interface BulkCreateBlockSetVersionRequest {
	requests: Array<CreateBlockSetVersionRequest>;
}
export interface BulkCreateBlockSetVersionResponse {
	responses: Array<CreateBlockSetVersionResponse>;
}
...
export type CancelInstallationJobAllowance = CancelInstallationJobAllowance_allowed | CancelInstallationJobAllowance_disallowed;
...
export type CanCreateBlockVersionWithOutputResult = CanCreateBlockVersionWithOutputResult_ok | CanCreateBlockVersionWithOutputResult_error;
...
export type CanCreateBlockVersionWithOutputResultError = CanCreateBlockVersionWithOutputResultError_resourcePermissionDenied | CanCreateBlockVersionWithOutputResultError_notAuthorizedToUseMarkings | CanCreateBlockVersionWithOutputResultError_notAuthorizedToDeclassify;
...
export interface CarbonCreateBlockRequest {
	workspaceRid: string;
	workspaceVersion?: number | null | undefined;
}
...
export interface ChildLevelAutomapping {
	parentShapeId: InputBlockSetShapeId;
}
...
export type CmafAudioCodec = "AAC" | "OPUS";
export interface CmafStreamingFormat {
	audioCodec?: CmafAudioCodec | null | undefined;
	videoCodec: CmafVideoCodec;
}
export type CmafVideoCodec = "H264" | "H265";
...
export type ComputeModuleIncludeFunctionsType = "INCLUDED_AS_OUTPUTS" | "EXCLUDED";
...
*/
export type ConfigBlock = Record<ConfigBlockKey, ConfigBlockValue>;
/**
* Configuration key for untyped config objects
*/
export type ConfigBlockKey = string;
/**
* Configuration value for untyped config objects
*/
export type ConfigBlockValue = any;
/**
...
*/
export type ConstraintFailure = ConstraintFailure_outsideMaintenanceWindows | ConstraintFailure_noNewerVersionsOnReleaseChannel | ConstraintFailure_lastUpgradeFailed | ConstraintFailure_missingInputs | ConstraintFailure_missingInputsV2 | ConstraintFailure_installationSpanningMultipleVersions | ConstraintFailure_inProgressJobForBlockSetInstallation | ConstraintFailure_automationDisabled | ConstraintFailure_continuousInstallationHasBeenUpdatedRecently | ConstraintFailure_unhandledValidationFailure | ConstraintFailure_unhandledValidationFailureV2 | ConstraintFailure_unhandledValidationFailureV3 | ConstraintFailure_noMaintenanceWindowsSet | ConstraintFailure_isPartiallyDeletedInstallation | ConstraintFailure_qosThrottle;
...
/**
* Block-internal reference to a parent Contour analysis shape.
*/
export type ContourAnalysisReference = BlockInternalId;
export type ContourAnalysisRid = string;
export interface ContourAnalysisShape {
	about: LocalizedTitleAndDescription;
	refs: Array<ContourRefReference>;
}
export interface ContourCreateBlockRequest {
	analysisRid: string;
}
/**
* Determines which integration service handles contour resources during packaging and installation.
* This field is during the migration phase from legacy Templates to new Contour Dispatch implementation.
*/
export type ContourIntegrationSource = "TEMPLATES" | "CONTOUR_DISPATCH";
export interface ContourOutputSpecConfig {
	integrationSource?: ContourIntegrationSource | null | undefined;
}
export interface ContourRefEntityIdentifier {
	analysisRid: ContourAnalysisRid;
	rid: ContourRefRid;
}
/**
* Block-internal reference to a child Contour ref shape.
*/
export type ContourRefReference = BlockInternalId;
export type ContourRefRid = string;
/**
* Represents a path (ref) within a Contour analysis. This is a child shape
* of ContourAnalysisShape, used to track RefRid mappings across stacks.
*/
export interface ContourRefShape {
	about: LocalizedTitleAndDescription;
	analysis: ContourAnalysisReference;
}
export interface ContractExpressionIdentifier_and {
	type: "and";
	and: AndExpressionIdentifier;
}
export interface ContractExpressionIdentifier_or {
	type: "or";
	or: OrExpressionIdentifier;
}
export interface ContractExpressionIdentifier_contract {
	type: "contract";
	contract: FunctionContractIdentifier;
}
/**
* A boolean expression tree for specifying contract requirements. Parallel to ContractExpression,
* but uses FunctionContractIdentifier for leaf nodes instead of FunctionContractReference (BlockInternalId).
*/
export type ContractExpressionIdentifier = ContractExpressionIdentifier_and | ContractExpressionIdentifier_or | ContractExpressionIdentifier_contract;
...
export interface CreateBlockSetVersionRequest {
	draftGroupRid?: DraftGroupRid | null | undefined;
	isHotfix?: boolean | null | undefined;
...
export type CreateBlockVersionErrorUnion = CreateBlockVersionErrorUnion_serializable | CreateBlockVersionErrorUnion_genericV2 | CreateBlockVersionErrorUnion_generic;
/**
...
/**
* Request to create a new installation job draft.
*/
export interface CreateJobDraftRequest {
	installations: Array<TargetInstallationSpec>;
}
export interface CreateJobDraftResponse {
	draft: UnresolvedJobDraft;
	metadata: JobDraftMetadata;
}
...
export interface CreatePlaceholdersRequest {
	inputShapesToCreatePlaceholdersFor: Record<InputBlockSetShapeId, BlockSetInputShape>;
...
export interface CreateProductGroupRequest {
	about: LocalizedTitleAndDescription;
	initialMembers: Array<ProductGroupMemberSpec>;
	parentRid: CompassFolderRid;
	validationSettings?: ProductGroupValidationSettings | null | undefined;
}
...
/**
* Request to create a snapshot manually.
*/
export interface CreateSnapshotRequest {
	description?: LocalizedDescription | null | undefined;
}
/**
* Response containing the newly created manual snapshot.
*/
export interface CreateSnapshotResponse {
	productGroupRid: ProductGroupRid;
	snapshotRid: ProductGroupSnapshotRid;
}
...
export type CryptographicKeyStrategy = CryptographicKeyStrategy_keepSameKey | CryptographicKeyStrategy_autoGenerateNewKey;
/**
* A single directed dependency edge between two members of a strongly-connected component,
* showing which outputs of the upstream member fulfill which inputs of the downstream member.
* Edges are aggregated from two sources: shape-merge-key matches (an output's merge key matches
* an input's merge key) and external recommendations (a downstream member declares its input is
* fulfilled by a specific upstream output). Both contribute pairs to `fulfillments`.
*/
export interface CycleDependencyEdge {
	downstream: ProductGroupMemberRid;
	fulfillments: Record<InputBlockSetShapeId, OutputBlockSetShapeId>;
...
/**
* Data constraints on a property (or interface property) describing what values the property accepts.
* Mirrors the OMS `DataConstraints` type.
*/
...
/**
* Mirrors the OMS `DataNullabilityV2` type. Each field is optional for backwards compatibility.
*/
...
export interface DatasourceLocator_directSource {
	type: "directSource";
	directSource: DirectSourceLocator;
}
export type DatasourceLocator = DatasourceLocator_stream | DatasourceLocator_dataset | DatasourceLocator_restrictedView | DatasourceLocator_virtualTable | DatasourceLocator_directSource;
...
export interface DatasourceLocatorIdentifier_directSource {
	type: "directSource";
	directSource: DirectSourceLocatorIdentifier;
}
export type DatasourceLocatorIdentifier = DatasourceLocatorIdentifier_stream | DatasourceLocatorIdentifier_dataset | DatasourceLocatorIdentifier_restrictedView | DatasourceLocatorIdentifier_virtualTable | DatasourceLocatorIdentifier_directSource;
/**
...
export type DataValue = DataValue_booleanValue | DataValue_stringValue | DataValue_integerValue | DataValue_cronWithTimeZoneValue;
/**
...
/**
* This configuration indicates that on functions block installation...
* (1) The function version that is pre-allocated is determined by incrementing the minor version of the existing
* function's latest version (for initial installs, "0.1.0" is used).
*
* For example, if the existing function has latest version "1.2.3", pre-allocation will return version "1.3.0".
*
* (2) The API name that is pre-allocated is deduplicated if a conflict exists, which currently entails adding an
* incrementing integer suffix.
*
* For example, if the function has API name "myFunction", pre-allocation will use "myFunction1" if a
* conflict exists in the target location.
*
...
export type DefaultBlockSpecificConfiguration = DefaultBlockSpecificConfiguration_v0;
/**
...
export type DeleteBlockSetInstallationAllowance = DeleteBlockSetInstallationAllowance_allowed | DeleteBlockSetInstallationAllowance_disallowed;
...
export type DescriptionOverrideRequest = DescriptionOverrideRequest_set | DescriptionOverrideRequest_remove;
export type DiagramRid = string;
export interface DicomSchema {}
/**
* The granularity at which to return a diff.
*
* FULL: Returns the full diff, including all shapes.
* MINIFIED: Returns a minified diff, which does not include child shapes or Compass install location inputs.
*/
export type DiffGranularity = "FULL" | "MINIFIED";
export interface DirectDatasourceCreateBlockRequest {
	directSourceRid: string;
	ontologyVersion?: string | null | undefined;
}
export interface DirectSourceLocator {
	rid: string;
}
export interface DirectSourceLocatorIdentifier {
	rid: string;
}
/**
...
export interface DiscoveryConfig {
	...
	objectViews?: IncludeObjectViewsConfig | null | undefined;
...
export interface DocumentDecodeFormat_doc {
	type: "doc";
	doc: DocFormat;
}
...
export interface DocumentDecodeFormat_rtf {
	type: "rtf";
	rtf: RtfFormat;
}
...
export type DocumentDecodeFormat = DocumentDecodeFormat_pdf | DocumentDecodeFormat_doc | DocumentDecodeFormat_docx | DocumentDecodeFormat_rtf | DocumentDecodeFormat_txt | DocumentDecodeFormat_pptx;
...
export interface DraftGroupFinalizingStatus {
	finalized: Array<BlockSetVersionId>;
	finalizing: Array<BlockSetVersionId>;
	isCancelled: boolean;
...
*/
export type DraftGroupRid = string;
export interface DraftGroupStatus_idle {
	type: "idle";
	idle: DraftGroupIdleStatus;
}
export interface DraftGroupStatus_processing {
	type: "processing";
	processing: DraftGroupProcessingStatus;
}
export interface DraftGroupStatus_generatingRecommendations {
	type: "generatingRecommendations";
	generatingRecommendations: DraftGroupGeneratingRecommendationsStatus;
}
export interface DraftGroupStatus_error {
	type: "error";
	error: DraftGroupErrorStatus;
}
export interface DraftGroupStatus_finalizing {
	type: "finalizing";
	finalizing: DraftGroupFinalizingStatus;
}
export interface DraftGroupStatus_finalized {
	type: "finalized";
	finalized: DraftGroupFinalizedStatus;
}
export type DraftGroupStatus = DraftGroupStatus_idle | DraftGroupStatus_processing | DraftGroupStatus_generatingRecommendations | DraftGroupStatus_error | DraftGroupStatus_finalizing | DraftGroupStatus_finalized;
/**
...
/**
* Two or more top-level outputs across the product group's members resolve to the same underlying resource. One
* finding is emitted per duplicated merge key; the merge key itself is not included in the payload — clients
* infer the relationship from the listed outputs. When downstream members have conflicting recommendations
* due to the duplicated outputs, the finding severity is escalated to `ERROR`; otherwise `WARN`.
*/
export interface DuplicateOutputs {
	downstreamOverlappingRecommendations: Record<ProductGroupMemberRid, InputBlockSetShapeId>;
	outputsByMember: Record<ProductGroupMemberRid, Array<OutputBlockSetShapeId>>;
}
/**
...
export type EddieReplayOptionType = "RESET_AND_REPLAY_FROM_OFFSET" | "RESET" | "ACKNOWLEDGE_STATE_BREAKS";
/**
...
/**
* Configuration key for untyped Magritte config objects
*/
export type EdgeMagritteConfigKey = string;
/**
* Configuration value for untyped Magritte config objects
*/
export type EdgeMagritteConfigValue = any;
/**
...
*/
export type EdgeMagritteSourceConfig = Record<EdgeMagritteConfigKey, EdgeMagritteConfigValue>;
/**
* Untyped Magritte task config object
*/
export type EdgeMagritteTaskConfig = Record<EdgeMagritteConfigKey, EdgeMagritteConfigValue>;
/**
...
export type EditBlockSetInstallationAllowance = EditBlockSetInstallationAllowance_allowed | EditBlockSetInstallationAllowance_disallowed;
...
export type EditBlockSetInstallationSettingsAllowance = EditBlockSetInstallationSettingsAllowance_allowed | EditBlockSetInstallationSettingsAllowance_disallowed;
...
/**
* Request to edit an existing product group.
*/
export interface EditProductGroupRequest {
	latestProductGroupVersionRid: ProductGroupVersionRid;
	members: Array<UnresolvedProductGroupMember>;
	validationSettings?: ProductGroupValidationSettings | null | undefined;
}
export interface EditProductGroupResponse {
	productGroup: ProductGroup;
}
/**
...
export interface EmailDecodeFormat_eml {
	type: "eml";
	eml: EmlFormat;
}
export type EmailDecodeFormat = EmailDecodeFormat_eml;
...
*/
export type EquivalentInputActionTypeParameterShapeReferences = Array<BlockSetInputActionTypeParameterReference>;
...
export type EquivalentInputReferences = EquivalentInputReferences_equivalentInputShapeReferences | EquivalentInputReferences_equivalentInputActionTypeParameterShapeReferences;
/**
* Every reference in this set mapped to the same resource at packaging time
*/
export type EquivalentInputShapeReferences = Array<BlockSetInputBlockShapeReference>;
...
export interface EvaluationSuiteCreateBlockRequest {
	...
	evaluationSuiteVersion?: string | null | undefined;
}
...
export interface ExpectedDefaultNotEqualToActualDefaultV2 {
	actual?: ResolvedBlockSetInputShape | null | undefined;
	expected: ResolvedBlockSetInputShape;
}
/**
...
export type ExpirationStrategy = ExpirationStrategy_fixedDate | ExpirationStrategy_relativeDate;
...
*/
export type ExportPermissionDeniedReason = "MARKETPLACE_READ_LOCAL_MARKETPLACE_MISSING_OPERATION" | "MARKETPLACE_EXPORT_BLOCK_SET_MISSING_OPERATION" | "EXPORT_DISABLED_QUOTA";
/**
...
*/
export type ExternalRecommendationInstallationVisibility = ExternalRecommendationInstallationVisibility_enabled | ExternalRecommendationInstallationVisibility_disabled | ExternalRecommendationInstallationVisibility_featured;
export interface ExternalRecommendationMavenDependencyRequirement_required {
	type: "required";
	required: Void;
}
export interface ExternalRecommendationMavenDependencyRequirement_optional {
	type: "optional";
	optional: Void;
}
export interface ExternalRecommendationMavenDependencyRequirement_ignored {
	type: "ignored";
	ignored: Void;
}
/**
* Controls the maven dependency requirements for an external recommendation of an upstream marketplace product.
* The requirement is applied to upstream products associated with a maven id when the downstream product is
* packaged.
*/
export type ExternalRecommendationMavenDependencyRequirement = ExternalRecommendationMavenDependencyRequirement_required | ExternalRecommendationMavenDependencyRequirement_optional | ExternalRecommendationMavenDependencyRequirement_ignored;
export interface ExternalRecommendationSource_owned {
	type: "owned";
	owned: Void;
}
export interface ExternalRecommendationSource_ownedPending {
	type: "ownedPending";
	ownedPending: OwnedPendingRecommendationSource;
}
export interface ExternalRecommendationSource_otherStoreLocal {
	type: "otherStoreLocal";
	otherStoreLocal: OtherStoreLocalRecommendationSource;
}
export interface ExternalRecommendationSource_otherStoreRemote {
	type: "otherStoreRemote";
	otherStoreRemote: Void;
}
...
/**
* Information about the "source" of an external recommendation, i.e. how it was generated.
*/
export type ExternalRecommendationSource = ExternalRecommendationSource_owned | ExternalRecommendationSource_ownedPending | ExternalRecommendationSource_otherStoreLocal | ExternalRecommendationSource_otherStoreRemote | ExternalRecommendationSource_upstreamInstallationLocal | ExternalRecommendationSource_upstreamInstallationRemote;
...
export interface ExternalRecommendationV2 {
	...
	mavenProductDependencyRequirement?: ExternalRecommendationMavenDependencyRequirement | null | undefined;
	source: ExternalRecommendationSource;
	targetBlockSet?: BlockSetId | null | undefined;
	targetBlockSetVersion: BlockSetVersionId;
	targetMarketplaceRid?: MarketplaceRid | null | undefined;
	upstreamBlockSet: BlockSetId;
...
*/
export interface FoundryPeerProducerProfileCreateBlockRequest {
	peerProducerProfileRid: string;
}
...
/**
* An input that was resolved from the default value declared on the shape during packaging.
*/
...
export interface FunctionApiName_global {
	type: "global";
	global: GlobalFunctionApiName;
}
export type FunctionApiName = FunctionApiName_ontologyBound | FunctionApiName_global;
...
*/
export type FunctionContractIdentifier = FunctionContractIdentifier_rid | FunctionContractIdentifier_apiName;
/**
...
export interface FunctionContractsIdentifier_expression {
	type: "expression";
	expression: ContractExpressionIdentifier;
}
...
*/
export type FunctionContractsIdentifier = FunctionContractsIdentifier_all | FunctionContractsIdentifier_subset | FunctionContractsIdentifier_expression | FunctionContractsIdentifier_none;
/**
...
/**
* The function does not satisfy the ContractExpression requirement specified in the function input shape.
* This validation ensures that functions implement the necessary contracts (single, AND, or OR expressions).
*/
export interface FunctionDoesNotSatisfyContractExpression {
	expression: _api_function_contracts_ContractExpression;
	implementedContracts: Array<FunctionContractRid>;
}
/**
...
export interface FunctionInputIdentifier_rid {
	type: "rid";
	rid: FunctionRidIdentifier;
}
export interface FunctionInputIdentifier_ridAndVersion {
	type: "ridAndVersion";
	ridAndVersion: FunctionRidAndVersionRangeIdentifier;
}
export interface FunctionInputIdentifier_languageModelRid {
	type: "languageModelRid";
	languageModelRid: FunctionLanguageModelRidIdentifier;
}
export interface FunctionInputIdentifier_staticInput {
	type: "staticInput";
	staticInput: FunctionStaticInputIdentifier;
}
export type FunctionInputIdentifier = FunctionInputIdentifier_rid | FunctionInputIdentifier_ridAndVersion | FunctionInputIdentifier_languageModelRid | FunctionInputIdentifier_staticInput;
...
export interface FunctionInputShape {
	about: LocalizedTitleAndDescription;
	contractRequirement?: _api_function_contracts_ContractExpression | null | undefined;
	...
	stableId?: FunctionShapeStableId | null | undefined;
}
...
/**
* Identifier for generating an input shape for a function that wraps an LMS model. All contracts from the
* underlying function will be included on the shape.
*/
...
export interface FunctionOutputIdentifier_rid {
	type: "rid";
	rid: FunctionRidOutputIdentifier;
}
export interface FunctionOutputIdentifier_ridAndVersion {
	type: "ridAndVersion";
	ridAndVersion: FunctionRidAndVersionIdentifier;
}
export type FunctionOutputIdentifier = FunctionOutputIdentifier_rid | FunctionOutputIdentifier_ridAndVersion;
export interface FunctionOutputShape {
	about: LocalizedTitleAndDescription;
	contracts: Array<FunctionContractReference>;
	customTypes: Record<_api_functions_CustomTypeId, _api_functions_CustomType>;
	inputs: Array<FunctionInputType>;
...
export interface FunctionOutputType_voidOutputType {
	type: "voidOutputType";
	voidOutputType: VoidOutputType;
}
export type FunctionOutputType = FunctionOutputType_singleOutputType | FunctionOutputType_voidOutputType;
export interface FunctionOutputTypeDisplayMetadata_singleOutputType {
	type: "singleOutputType";
	singleOutputType: SingleOutputTypeDisplayMetadata;
}
export type FunctionOutputTypeDisplayMetadata = FunctionOutputTypeDisplayMetadata_singleOutputType;
/**
* The function output type for the specified function does not match the expected type. This error occurs
* if a void type was expected but a single output type was provided, or vice versa.
*/
export interface FunctionOutputTypeMismatch {
	actual: FunctionOutputType;
...
export interface FunctionPackageCandidateIdentifier {
	functionRid: FunctionRid;
	functionVersion: FunctionVersion;
}
/**
* This block packages deployment configurations for container-backed functions. These configurations are set at the package level.
* The configuration controls how the function's containerized deployment is started, upgraded, and managed. This includes the deployment
* mode (e.g., deployed vs serverless), resource configurations (CPU, memory), and specifying what container images should be run.
*
* At reconcile time, the package configuration block needs to start up/upgrade a deployment for functions (if the functions are configured to be in deployed mode).
* To do that, it needs to know what container images should be run in said deployment and what other (non-user-facing) configurations should set on the containerized
* application. This information requires loading at least one of the function specs that will be backed by the deployment.
*
* Because of this, we have to declare a function input (with reconcile access requirement) on the package configuration block. This allows us to load the function
* spec at reconcile time and extract the information needed to start/upgrade the deployment. Hence, the create-block request must provide at least one function
* RID/version that is backed by the deployment whose package configurations are being packaged.
*/
export interface FunctionPackageCandidateLocator {
	functionRid: FunctionRid;
	version: string;
}
export interface FunctionPackageConfigurationCreateBlockRequest {
	packageLocator: FunctionPackageLocator;
}
export interface FunctionPackageConfigurationIdentifier_candidateFunction {
	type: "candidateFunction";
	candidateFunction: FunctionPackageCandidateIdentifier;
}
export type FunctionPackageConfigurationIdentifier = FunctionPackageConfigurationIdentifier_candidateFunction;
/**
* A synthetic RID derived from a function that is backed by the relevant deployment.
*/
export type FunctionPackageConfigurationRid = string;
export interface FunctionPackageConfigurationShape {
	about: LocalizedTitleAndDescription;
	packageReference: FunctionPackageShapeReference;
}
export interface FunctionPackageLocator_candidateFunction {
	type: "candidateFunction";
	candidateFunction: FunctionPackageCandidateLocator;
}
export type FunctionPackageLocator = FunctionPackageLocator_candidateFunction;
export interface FunctionPackageShapeReference_repository {
	type: "repository";
	repository: AuthoringRepositoryReference;
}
export type FunctionPackageShapeReference = FunctionPackageShapeReference_repository;
export type FunctionReference = BlockInternalId;
export type FunctionRid = string;
/**
* Identifier for generating an output shape for a function at a version.
*/
...
/**
* Identifier for generating an input shape for a function at a semantic version range.
*/
export interface FunctionRidAndVersionRangeIdentifier {
	contracts?: FunctionContractsIdentifier | null | undefined;
	rid: FunctionRid;
	version: FunctionVersionRange;
}
/**
* Identifier for generating an input shape for the latest version of a function.
*/
...
/**
* Identifier for generating an output shape for the latest version of a function.
*/
export interface FunctionRidOutputIdentifier {
	rid: FunctionRid;
}
export interface FunctionsApiStabilityConfiguration_deduplicate {
	type: "deduplicate";
	deduplicate: DeduplicateFunctionsApiStabilityConfiguration;
}
export interface FunctionsApiStabilityConfiguration_stable {
	type: "stable";
	stable: StableFunctionsApiStabilityConfiguration;
}
export type FunctionsApiStabilityConfiguration = FunctionsApiStabilityConfiguration_deduplicate | FunctionsApiStabilityConfiguration_stable;
/**
* There is only a single instance of this input per block set, which means that ALL function blocks in a block
...
*/
export interface FunctionsApiStabilityConfigurationInputShape {
	about: LocalizedTitleAndDescription;
}
/**
...
export type FunctionShapeConversionFailedReason = FunctionShapeConversionFailedReason_inputDataTypeConversion | FunctionShapeConversionFailedReason_outputDataTypeConversion | FunctionShapeConversionFailedReason_customTypeDataTypeConversion;
/**
...
export interface FunctionShapeStableId_staticInput {
	type: "staticInput";
	staticInput: FunctionStaticInputStableId;
}
export type FunctionShapeStableId = FunctionShapeStableId_staticInput;
/**
...
/**
* Identifier for generating an input shape for a function static input.
*/
export interface FunctionStaticInputIdentifier {
	functionRid: FunctionRid;
	functionVersion: FunctionVersion;
	inputName: FunctionInputName;
}
/**
* Static inputs are uniquely identified by the function the input is on and the name of the input.
*/
export interface FunctionStaticInputStableId {
	functionRid: FunctionRid;
	functionVersion: FunctionVersion;
	inputName: FunctionInputName;
}
...
export interface FunctionVersionsConfiguration_incrementMinor {
	type: "incrementMinor";
	incrementMinor: IncrementMinorFunctionVersionsConfiguration;
}
export interface FunctionVersionsConfiguration_preserve {
	type: "preserve";
	preserve: PreserveFunctionVersionsConfiguration;
}
/**
* Deprecated: Use FunctionsApiStabilityConfiguration instead.
*/
export type FunctionVersionsConfiguration = FunctionVersionsConfiguration_incrementMinor | FunctionVersionsConfiguration_preserve;
/**
...
*
* See ResolvedFunctionVersionsConfigurationInputShape for details.
*/
export interface FunctionVersionsConfigurationInputShape {
	about: LocalizedTitleAndDescription;
}
/**
...
export type GenerateCompassLocationInputShapesResponseV2 = GenerateCompassLocationInputShapesResponseV2_success | GenerateCompassLocationInputShapesResponseV2_failure;
...
export interface GenerateShapesError_interfaceActionTypeConstraintNotFound {
	type: "interfaceActionTypeConstraintNotFound";
	interfaceActionTypeConstraintNotFound: InterfaceActionTypeConstraintNotFound;
}
...
/**
* Represents an error encountered during shape generation.
*
* Integrations should not add new members to this union. Instead, use the `serializable` variant with a
* `MarketplaceSerializableError`. By reusing error factories from `MarketplaceErrors` (e.g.
* `MarketplaceErrors.resourceNotFound`), integrations get rich frontend error rendering for free.
*
* Example usage for a resource-not-found error:
* ```
* .error(GenerateShapesError.serializable(
* Exceptions.toSerializableError(MarketplaceErrors.resourceNotFound(rid))))
* ```
*
* Any Conjure error can be wrapped via `Exceptions.toSerializableError`. If you add a new exception,
* make sure you add a FE renderer in DevOps packaging errors framework.
*/
...
export type GenerateShapesResponse = GenerateShapesResponse_success | GenerateShapesResponse_failure;
...
export interface GetBlockSetVersionStatusResponseV3 {
	status: BlockSetVersionStatusV3;
}
...
export interface GetDraftGroupStatusResponse {
	errors: Array<_api_errors_MarketplaceSerializableError>;
...
export interface GetJobDraftMetadataResponse {
	metadata: JobDraftMetadata;
}
export interface GetJobDraftStatusResponse {
...
export interface GetPendingRecommendationsResponse {
	...
	updateId?: UpdateExternalRecsRequestId | null | undefined;
}
export interface GetProductGroupResponse {
	productGroup: ProductGroup;
}
/**
* Response containing the full details of a product group snapshot.
*/
export interface GetProductGroupSnapshotResponse {
	snapshot: ProductGroupSnapshot;
}
/**
* Response containing a specific historical version of a product group. The included definition's
* members are resolved against the current state of the marketplace — the returned block set
* versions reflect what the member policies resolve to now, not what they resolved to when this
* version was authored. For point-in-time resolved state, use snapshots instead.
*/
export interface GetProductGroupVersionResponse {
	definition: VersionedProductGroupDefinition;
}
...
*/
export type GetRecommendationsResponseV2 = GetRecommendationsResponseV2_pending | GetRecommendationsResponseV2_success;
export interface GetResolvedJobDraftResponse {
	draft: ResolvedJobDraft;
}
export interface GetSigningKeyResponse {
	publicKey: SigningPublicKey;
	publicKeyId: SigningKeyId;
}
export interface GetUnresolvedJobDraftResponse {
	draft: UnresolvedJobDraft;
	metadata: JobDraftMetadata;
}
...
export type GlobalFunctionApiName = string;
/**
* The sum of the input shapes of all blocks in the block set.
*/
...
*/
export type GranularErrorStatus = GranularErrorStatus_inProgressError | GranularErrorStatus_inProgressCancelled | GranularErrorStatus_buildErrored | GranularErrorStatus_buildCancelled | GranularErrorStatus_buildTimedOut;
...
*/
export type GranularInstallPendingStatus = GranularInstallPendingStatus_notStarted | GranularInstallPendingStatus_preallocating | GranularInstallPendingStatus_reconciling | GranularInstallPendingStatus_pendingBuild | GranularInstallPendingStatus_building | GranularInstallPendingStatus_finished;
...
export type GranularOutputSpecResult = GranularOutputSpecResult_materializing | GranularOutputSpecResult_dataUploading | GranularOutputSpecResult_success | GranularOutputSpecResult_error | GranularOutputSpecResult_unsupported | GranularOutputSpecResult_ignored;
export interface GroupAlreadyUsedFailure {
	conflictingMarketplaceRid: MarketplaceRid;
}
/**
* Filters pending block set versions by their draft group membership status.
*/
...
export interface IdleBlockSetVersionStatus {
	...
	latestProcessedUpdateId?: UpdatePendingBlockSetVersionSpecsRequestId | null | undefined;
...
export interface IncludeObjectViewsConfig {
	fromObjectTypes: boolean;
}
...
/**
* A downstream product's external recommendation to an upstream product specifies a
* version compatibility range, but the upstream product's resolved version falls
* outside that range. The downstream product needs repackaging against the upstream's
* current version.
*/
export interface IncompatibleExternalRecommendationVersionRange {
	compatibleVersionRange: BlockSetVersionRange;
	downstream: ProductGroupMemberRid;
	upstream: ProductGroupMemberRid;
	upstreamResolvedVersion: SemverVersion;
}
export interface IncompatibleLinkedProduct {
	compatibleVersionRange: BlockSetVersionRange;
	upstreamBlockSet: BlockSetId;
	upstreamBlockSetInstallation: BlockSetReference;
	upstreamBlockSetVersion: SemverVersion;
}
...
/**
* Deprecated: Use DeduplicateFunctionsApiStabilityConfiguration instead.
*
* This configuration indicates that on installation or upgrade of a Marketplace package, the version of a
* function that is chosen during block pre-allocation is determined by incrementing the minor version of the
* existing function's latest version.
*
* For example, if the existing function has latest version "1.2.3", pre-allocation will return version "1.3.0".
*
...
*/
export type InferredFolderStructureSettings = InferredFolderStructureSettings_enabled | InferredFolderStructureSettings_disabled;
...
export interface InputEntityIdentifier_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: AutopilotWorkbenchIdentifier;
}
...
export interface InputEntityIdentifier_contourRef {
	type: "contourRef";
	contourRef: ContourRefEntityIdentifier;
}
...
export interface InputEntityIdentifier_function {
	type: "function";
	function: FunctionInputIdentifier;
}
export interface InputEntityIdentifier_functionContract {
	type: "functionContract";
	functionContract: FunctionContractIdentifier;
}
export interface InputEntityIdentifier_functionVersionsConfiguration {
	type: "functionVersionsConfiguration";
	functionVersionsConfiguration: FunctionVersionsConfigurationInputIdentifier;
}
...
export interface InputEntityIdentifier_interfaceActionTypeConstraint {
	type: "interfaceActionTypeConstraint";
	interfaceActionTypeConstraint: InterfaceActionTypeConstraintIdentifier;
}
export interface InputEntityIdentifier_interfaceParameterConstraint {
	type: "interfaceParameterConstraint";
	interfaceParameterConstraint: InterfaceParameterConstraintIdentifier;
}
...
export interface InputEntityIdentifier_modelStudio {
	type: "modelStudio";
	modelStudio: ModelStudioIdentifier;
}
...
export interface InputEntityIdentifier_peerProducerProfile {
	type: "peerProducerProfile";
	peerProducerProfile: PeerProducerProfileIdentifier;
}
export interface InputEntityIdentifier_peerProfile {
	type: "peerProfile";
	peerProfile: PeerProfileIdentifier;
}
export interface InputEntityIdentifier_peerProfileRemoteStrategy {
	type: "peerProfileRemoteStrategy";
	peerProfileRemoteStrategy: PeerProfileRemoteStrategyIdentifier;
}
...
export interface InputEntityIdentifier_storedProcedure {
	type: "storedProcedure";
	storedProcedure: StoredProcedureEntityIdentifier;
}
...
export interface InputEntityIdentifier_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: VersionedObjectSetEntityIdentifier;
}
...
export interface InputEntityIdentifier_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: WorkbenchTemplateIdentifier;
}
export interface InputEntityIdentifier_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: WorkflowBuilderGraphIdentifier;
}
export interface InputEntityIdentifier_workflowGraph {
	type: "workflowGraph";
	workflowGraph: WorkflowGraphIdentifier;
}
export interface InputEntityIdentifier_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: SqlWorksheetEntityIdentifier;
}
...
export type InputGroupValidationErrors = InputGroupValidationErrors_inputGroupDoesNotExistInBlock;
...
export interface InputPresetResolutionResult {
	defaultResolutionResult?: ResolvedShapeResolutionResultUnion | null | undefined;
...
export interface InputShape_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: AutopilotWorkbenchShape;
}
...
export interface InputShape_contourRef {
	type: "contourRef";
	contourRef: ContourRefShape;
}
...
export interface InputShape_function {
	type: "function";
	function: FunctionInputShape;
}
export interface InputShape_functionContract {
	type: "functionContract";
	functionContract: FunctionContractShape;
}
export interface InputShape_functionVersionsConfiguration {
	type: "functionVersionsConfiguration";
	functionVersionsConfiguration: FunctionVersionsConfigurationInputShape;
}
...
export interface InputShape_interfaceActionTypeConstraint {
	type: "interfaceActionTypeConstraint";
	interfaceActionTypeConstraint: InterfaceActionTypeConstraintShape;
}
export interface InputShape_interfaceParameterConstraint {
	type: "interfaceParameterConstraint";
...
export interface InputShape_modelStudio {
	type: "modelStudio";
	modelStudio: ModelStudioInputShape;
}
...
export interface InputShape_peerProducerProfile {
	type: "peerProducerProfile";
	peerProducerProfile: PeerProducerProfileShape;
}
export interface InputShape_peerProfile {
	type: "peerProfile";
	peerProfile: PeerProfileShape;
}
export interface InputShape_peerProfileRemoteStrategy {
	type: "peerProfileRemoteStrategy";
	peerProfileRemoteStrategy: PeerProfileRemoteStrategyShape;
}
...
export interface InputShape_storedProcedure {
	type: "storedProcedure";
	storedProcedure: StoredProcedureShape;
}
...
export interface InputShape_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: VersionedObjectSetShape;
}
...
export interface InputShape_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: WorkbenchTemplateShape;
}
export interface InputShape_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: WorkflowBuilderGraphShape;
}
export interface InputShape_workflowGraph {
	type: "workflowGraph";
	workflowGraph: WorkflowGraphShape;
}
export interface InputShape_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: SqlWorksheetShape;
}
...
export interface InputShapeResolver_valueTypePresetResolver {
	type: "valueTypePresetResolver";
	valueTypePresetResolver: ValueTypePresetResolver;
}
/**
* Used to generate a resolved block set input shape.
*/
export type InputShapeResolver = InputShapeResolver_apiNameResolver | InputShapeResolver_resolvedShapeResolver | InputShapeResolver_linkTypeIdResolver | InputShapeResolver_multipassGroupResolver | InputShapeResolver_markingsResolver | InputShapeResolver_valueTypePresetResolver;
export interface InputShapeResult {
	blockShapeId: BlockShapeId;
	internalShapeId: InternalShapeId;
	metadata: InputShapeMetadata;
	resolvedShape?: ResolvedInputShape | null | undefined;
	shape: InputShape;
}
/**
...
export type InstallableBlockSetInputGroups = Record<BlockSetInputGroupId, BlockSetInputGroup>;
export interface InstallableBlockSetInputShape {
	isOptional: boolean;
	metadata?: InstallableInputBlockSetShapeMetadata | null | undefined;
	shape: BlockSetInputShape;
}
export type InstallableBlockSetInputShapes = Record<InputBlockSetShapeId, InstallableBlockSetInputShape>;
export interface InstallableBlockSetOutputShape {
	producedByBlockType: BlockType;
	shape: BlockSetOutputShape;
}
export type InstallableBlockSetOutputShapes = Record<OutputBlockSetShapeId, InstallableBlockSetOutputShape>;
/**
* Installable version of BlockSetShapeDependencies, which doesn't include the block metadata.
*/
export interface InstallableBlockSetShapeDependencies {
	dependencies: OutputShapeDependencies;
	outputs: Array<OutputBlockSetShapeId>;
}
...
export interface InstallableBlockSetVersionMetadata {
	about: LocalizedTitleAndDescription;
	asCodeBlockSetMetadata?: AsCodeBlockSetMetadata | null | undefined;
	createdByUser?: MultipassUserId | null | undefined;
...
export interface InstallableBlockSetVersionShapes {
	...
	shapeDependencies: Array<InstallableBlockSetShapeDependencies>;
}
...
export type InstallablePresetValue = InstallablePresetValue_fromSource | InstallablePresetValue_resolvedShapeOverrides;
...
export interface InstallableTransportBlockSet {
	...
	installHints?: BlockSetInstallationHints | null | undefined;
	lastKnownVersionBeforeBreak?: BlockSetVersion | null | undefined;
	marketplaceMetadata?: TransportVersionedMarketplaceMetadata | null | undefined;
	mavenCoordinateDependencies: Array<MavenCoordinateDependency>;
	mavenProductId?: MavenProductId | null | undefined;
	packagingMetadata?: TransportPackagingMetadata | null | undefined;
...
export type InstallationInstruction = InstallationInstruction_installNewBlock | InstallationInstruction_installExistingBlock;
...
export type InstallationJobBuildOption = InstallationJobBuildOption_all | InstallationJobBuildOption_required;
...
*/
export type InstallationOutputKey = InstallationOutputKey_rid | InstallationOutputKey_objectViewTab | InstallationOutputKey_rosettaDocsBundle | InstallationOutputKey_ontologySdk | InstallationOutputKey_logicFunction;
...
/**
* A member sourced from an installation.
*/
export interface InstallationProductGroupMember {
	blockSetInstallationRid: BlockSetInstallationRid;
}
/**
...
*/
export type InstallationProjectRoleContext = "MARKETPLACE_INSTALLATION" | "PROJECT";
...
export type InstallationResolvedInputShapeValue = InstallationResolvedInputShapeValue_manuallyProvided | InstallationResolvedInputShapeValue_fromDefault;
...
export interface InstallBlockSetsRequest {
	createNewInstallations: Record<NewBlockSetInstallationId, CreateNewBlockSetInstallation>;
	createProjects: Record<NewProjectId, CreateProjectRequest>;
	jobSettings?: JobSettings | null | undefined;
	modifyExistingInstallations: Record<BlockSetInstallationRid, ModifyExistingBlockSetInstallation>;
...
export type InstallBlockSetsResult = InstallBlockSetsResult_jobSubmitted | InstallBlockSetsResult_failedToSubmitJob | InstallBlockSetsResult_invalidRequest;
...
export type InstallBlocksResponseV2 = InstallBlocksResponseV2_inProgress | InstallBlocksResponseV2_invalidRequest | InstallBlocksResponseV2_failed;
...
export type InstallBlocksStatus = InstallBlocksStatus_pending | InstallBlocksStatus_building | InstallBlocksStatus_success | InstallBlocksStatus_error;
/**
...
export interface InstallBlocksStatusBuilding {
	...
	newBlockSetInstallationRids: Record<NewBlockSetInstallationId, BlockSetInstallationRid>;
}
/**
...
export interface InstallBlocksStatusSuccess {
	...
	newBlockInstallationRids: Record<InstallNewBlockInstructionId, BlockInstallationRid>;
	newBlockSetInstallationRids: Record<NewBlockSetInstallationId, BlockSetInstallationRid>;
...
/**
* Configuration for ontology entity descriptor prefixing. DISPLAY_NAME_ONLY will only apply the configured
* prefix to ontology entity display names. DISPLAY_NAME_AND_API_NAME will apply the configured prefix to both
* the ontology entity display name and the API name. Note that entity IDs are not affected by the installPrefix.
*/
export type InstallPrefixConfigurationEnum = "DISPLAY_NAME_ONLY" | "DISPLAY_NAME_AND_API_NAME";
/**
...
export interface InstallShapeValidationError_actionParameterShapeErrors {
	...
	actionParameterShapeErrors: Record<ActionParameterShapeId, BlockInstallActionParameterTypeShapeError>;
}
...
export interface InstallShapeValidationError_filesDatasourceTypeNotSupported {
	...
	filesDatasourceTypeNotSupported: FilesDatasourceTypeNotSupported;
}
...
export interface InstallShapeValidationError_peerProfileRemoteStrategyMismatch {
	type: "peerProfileRemoteStrategyMismatch";
	peerProfileRemoteStrategyMismatch: PeerProfileRemoteStrategyMismatch;
}
...
export interface InstallShapeValidationError_sparkProfileFamilyMismatch {
	type: "sparkProfileFamilyMismatch";
	sparkProfileFamilyMismatch: SparkProfileFamilyMismatch;
}
...
export interface InstallShapeValidationError_markingTypeNotValidV3 {
	type: "markingTypeNotValidV3";
	markingTypeNotValidV3: MarkingTypeNotValidV3;
}
...
export interface InstallShapeValidationError_serializable {
	type: "serializable";
	serializable: _api_errors_MarketplaceSerializableError;
}
...
/**
* Similar to InstallShapeValidationErrorV2 but applies to a set of block set shape IDs rather than a single
* one, grouping errors that share the same block set reference, error, and severity.
*/
export interface InstallShapeValidationErrorV3 {
	blockSetReference: BlockSetReference;
	blockSetShapeIds: Array<BlockSetShapeId>;
	error: InstallBlockSetShapeValidationError;
	severity: ErrorSeverity;
}
...
export interface InstallValidationErrorDetail_serializable {
	type: "serializable";
	serializable: _api_errors_MarketplaceSerializableError;
}
...
* types yet.
*/
export type IntegrationCreateBlockVersionError = IntegrationCreateBlockVersionError_unknownError;
export type InterfaceActionTypeConstraintApiName = string;
export interface InterfaceActionTypeConstraintIdentifier_rid {
	type: "rid";
	rid: InterfaceActionTypeConstraintRidIdentifier;
}
export type InterfaceActionTypeConstraintIdentifier = InterfaceActionTypeConstraintIdentifier_rid;
export interface InterfaceActionTypeConstraintNotFound {
	interfaceActionTypeConstraintRid?: InterfaceActionTypeConstraintRid | null | undefined;
}
export type InterfaceActionTypeConstraintReference = BlockInternalId;
export interface InterfaceActionTypeConstraintReferenceUnresolvable {
	actual: InterfaceActionTypeConstraintRid;
	expected: InterfaceActionTypeConstraintReference;
	interfaceTypeRid: InterfaceTypeRid;
}
export interface InterfaceActionTypeConstraintRequiredMismatch {
	actual: boolean;
	expected: boolean;
	interfaceActionTypeConstraintRid: InterfaceActionTypeConstraintRid;
	interfaceTypeRid: InterfaceTypeRid;
...
export interface InterfaceActionTypeConstraintRidIdentifier {
	interfaceTypeRid: InterfaceTypeRid;
	rid: InterfaceActionTypeConstraintRid;
}
export interface InterfaceActionTypeConstraintShape {
	about: LocalizedTitleAndDescription;
	interfaceType: InterfaceTypeReference;
	parameterConstraints: Array<InterfaceParameterConstraintReference>;
...
export interface InterfaceParameterConstraintIdentifier_rid {
	type: "rid";
	rid: InterfaceParameterConstraintRidIdentifier;
}
export type InterfaceParameterConstraintIdentifier = InterfaceParameterConstraintIdentifier_rid;
export type InterfaceParameterConstraintReference = BlockInternalId;
export interface InterfaceParameterConstraintRequiredMismatch {
	actual: boolean;
	expected: boolean;
	interfaceActionTypeConstraintRid: InterfaceActionTypeConstraintRid;
	interfaceParameterConstraintRid: InterfaceParameterConstraintRid;
...
export interface InterfaceParameterConstraintRidIdentifier {
	actionTypeConstraintRid: InterfaceActionTypeConstraintRid;
	interfaceTypeRid: InterfaceTypeRid;
...
/**
* The parameter constraint type doesn't match the type in the ontology definition.
*/
export interface InterfaceParameterConstraintTypeMismatch {
	actual: string;
	expected: string;
	interfaceActionTypeConstraintRid: InterfaceActionTypeConstraintRid;
	interfaceParameterConstraintRid: InterfaceParameterConstraintRid;
...
export interface InterfacePropertySharedPropertyTypeReferenceMismatch {
	expectedSharedPropertyTypeReference?: SharedPropertyTypeReference | null | undefined;
	expectedSharedPropertyTypeRid?: SharedPropertyTypeRid | null | undefined;
	inputSharedPropertyTypeReference?: SharedPropertyTypeReference | null | undefined;
...
export interface InterfaceTypeInputShape {
	about: LocalizedTitleAndDescription;
	actionTypeConstraints: Array<InterfaceActionTypeConstraintReference>;
...
export type IntermediaryLinkObjectTypeSide = "SIDE_A" | "SIDE_B" | "INTERMEDIARY";
...
export type InvalidInstallationProjectReason = "CANNOT_SEE_CONTENTS" | "DOES_NOT_EXIST" | "HAS_AUTOSAVE_RESOURCES" | "HAS_TRASHED_RESOURCES" | "IS_NOT_EMPTY" | "IS_SERVICE_PROJECT" | "IS_TRASHED" | "IS_USER_FOLDER" | "NOT_IN_EXPECTED_NAMESPACE" | "USED_FOR_MULTIPLE_INSTALLATIONS";
/**
...
export interface InvalidLinkedProduct {
	upstreamBlockSet: BlockSetId;
	upstreamBlockSetInstallation: BlockSetReference;
}
...
/**
* Lightweight metadata for the job draft.
*/
export interface JobDraftMetadata {
	createdAt: CreationTimestamp;
	createdByUser: MultipassUserId;
	lastUpdatedAt: LastUpdatedTimestamp;
	rid: BlockSetInstallationJobRid;
	targetInstallations: Array<TargetInstallationSummary>;
}
export interface JobDraftOwnerValidationErrors_validationErrors {
	type: "validationErrors";
	validationErrors: JobDraftValidationErrorsV2;
}
export interface JobDraftOwnerValidationErrors_validationSummary {
	type: "validationSummary";
	validationSummary: JobDraftValidationErrorSummary;
}
export interface JobDraftOwnerValidationErrors_validations {
	type: "validations";
	validations: JobDraftValidationErrors;
}
export type JobDraftOwnerValidationErrors = JobDraftOwnerValidationErrors_validationErrors | JobDraftOwnerValidationErrors_validationSummary | JobDraftOwnerValidationErrors_validations;
export interface JobDraftStatus_resolving {
	type: "resolving";
	resolving: Void;
}
export interface JobDraftStatus_validating {
	type: "validating";
	validating: Void;
}
export interface JobDraftStatus_idle {
	type: "idle";
	idle: Void;
}
export interface JobDraftStatus_submittingJob {
	type: "submittingJob";
	submittingJob: Void;
}
export interface JobDraftStatus_submitted {
	type: "submitted";
	submitted: Void;
}
/**
* The current status of an installation job draft. Poll `getJobDraftStatus` to track progress.
*/
export type JobDraftStatus = JobDraftStatus_resolving | JobDraftStatus_validating | JobDraftStatus_idle | JobDraftStatus_submittingJob | JobDraftStatus_submitted;
export interface JobDraftValidationErrors {
	blockSetValidationErrors: Array<BlockSetInstallValidationErrorV2>;
	jobValidationErrors: Array<InstallationJobValidationErrorV2>;
	shapeValidationErrors: Array<InstallShapeValidationErrorV2>;
}
export interface JobDraftValidationErrorSummary {
	totalBlockingErrors: number;
}
export interface JobDraftValidationErrorsV2 {
	blockSet: Array<BlockSetInstallValidationErrorV2>;
	job: Array<InstallationJobValidationErrorV2>;
	shapes: Array<InstallShapeValidationErrorV3>;
}
...
*/
export type KnownIdentifier = string;
...
*/
export type LibraryLocatorEnvironmentIdentificationMethod = LibraryLocatorEnvironmentIdentificationMethod_condaLocator | LibraryLocatorEnvironmentIdentificationMethod_condaLocatorV2;
/**
...
export type LinkTypeApiNames = LinkTypeApiNames_oneToMany | LinkTypeApiNames_manyToMany | LinkTypeApiNames_intermediary;
...
export type LinkTypeShapeDisplayMetadata = LinkTypeShapeDisplayMetadata_oneToMany | LinkTypeShapeDisplayMetadata_manyToMany | LinkTypeShapeDisplayMetadata_intermediary;
...
export type ListDraftGroupsPageToken = string;
export interface ListDraftGroupsResponse {
	groups: Array<DraftGroup>;
	nextPageToken?: ListDraftGroupsPageToken | null | undefined;
}
...
export interface ListJobDraftsForUserResponse {
	drafts: Array<ListJobDraftsForUserResponseEntry>;
	nextPageToken?: ListJobDraftsPageToken | null | undefined;
}
/**
* Summary of an installation job draft and its installations.
*/
export interface ListJobDraftsForUserResponseEntry {
	jobRid: BlockSetInstallationJobRid;
	lastUpdatedAt: LastUpdatedTimestamp;
	targetInstallations: Array<TargetInstallationSummary>;
}
export type ListJobDraftsPageToken = string;
...
export type ListSnapshotsForProductGroupPageToken = string;
/**
* Request to list snapshots for a given product group.
*/
export interface ListSnapshotsForProductGroupRequest {
	limit?: number | null | undefined;
	pageToken?: ListSnapshotsForProductGroupPageToken | null | undefined;
}
/**
* Response containing snapshot summaries for a given product group.
*/
export interface ListSnapshotsForProductGroupResponse {
	nextPageToken?: ListSnapshotsForProductGroupPageToken | null | undefined;
	productGroupRid: ProductGroupRid;
	snapshotSummaries: Array<ProductGroupSnapshot>;
}
/**
...
export interface MagritteConnectorCreateBlockRequest {
	...
	extractsV2: Array<MagritteExtractRidAndVersion>;
...
export interface MagritteExtractRidAndVersion {
	extractRid: MagritteExtractRid;
	extractVersionNumber: MagritteExtractVersionNumber;
}
export type MagritteExtractVersionNumber = number;
export interface MagritteRequiredApiName_requireOriginalApiName {
	type: "requireOriginalApiName";
	requireOriginalApiName: Void;
}
export type MagritteRequiredApiName = MagritteRequiredApiName_requireOriginalApiName;
...
export type MagritteRequiredSecrets = MagritteRequiredSecrets_requiredSecrets | MagritteRequiredSecrets_allSecrets;
...
*/
export type ManagedStoreAccessLevel = "INSTALL_EVERYTHING" | "VIEW_EVERYTHING" | "NONE";
...
export type ManagedStoreAccessPrincipal = ManagedStoreAccessPrincipal_organization | ManagedStoreAccessPrincipal_enrollment;
/**
...
export interface ManagedStoreConfiguredSettingsEntry {
	isEnabled: boolean;
	managedStoreGroupConfiguration?: ManagedStoreGroupConfiguration | null | undefined;
}
...
/**
* A snapshot that was manually triggered.
*/
export interface ManualProductGroupSnapshotTrigger {
	createdBy: MultipassUserId;
	description?: LocalizedDescription | null | undefined;
}
...
export type MapRendererSetLocator = MapRendererSetLocator_objectTypeRid | MapRendererSetLocator_interfaceTypeRid;
...
export type MapRenderingServiceLocator = MapRenderingServiceLocator_objectTypeRid | MapRenderingServiceLocator_interfaceTypeRid;
...
export interface MarkingsIdentifier {
	...
	supportedMarkingsTypesV2?: Array<SupportedMarkingsTypeV2> | null | undefined;
}
...
/**
* The MarkingType of the markings referenced by the resolved shape did not match any of the specified
* supported markings types.
*/
export interface MarkingTypeNotValidV3 {
	invalidMarkings: Record<MarkingId, MarkingsType>;
	supportedMarkingsTypes: Array<SupportedMarkingsTypeV2>;
}
export type MaterializationBehavior = "INCLUDED" | "EXCLUDED";
export interface MaterializingBlockSetVersionStatus {
	currentUpdateId?: UpdatePendingBlockSetVersionSpecsRequestId | null | undefined;
	outputSpecResults: Array<OutputSpecResult>;
...
* deprecated
*/
export type MediaSchemaType = "ANY" | "IMAGERY" | "AUDIO" | "VIDEO" | "DOCUMENT" | "DICOM" | "EMAIL" | "SPREADSHEET" | "MULTIMODAL" | "MODEL_3D" | "STREAMING_VIDEO";
...
export interface MediaSchemaTypeV2_email {
	type: "email";
	email: EmailSchema;
}
...
export interface MediaSchemaTypeV2_model3d {
	type: "model3d";
	model3d: Model3dSchema;
}
export interface MediaSchemaTypeV2_streamingVideo {
	type: "streamingVideo";
	streamingVideo: StreamingVideoSchema;
}
/**
* updated media schema copied from mio-api without additional constraints
*/
export type MediaSchemaTypeV2 = MediaSchemaTypeV2_any | MediaSchemaTypeV2_imagery | MediaSchemaTypeV2_audio | MediaSchemaTypeV2_document | MediaSchemaTypeV2_dicom | MediaSchemaTypeV2_email | MediaSchemaTypeV2_spreadsheet | MediaSchemaTypeV2_video | MediaSchemaTypeV2_multiModal | MediaSchemaTypeV2_model3d | MediaSchemaTypeV2_streamingVideo;
export interface MediaSetCreateBlockRequest {
	branch: string;
	includeMediaSetItems: boolean;
	pinnedMediaSetView?: PinnedMediaSetView | null | undefined;
	rid: string;
}
...
/**
* A group of product group members that are strongly connected in the dependency graph. Members
* in this group have mutual input-output dependencies, making them uninstallable as a unit because
* no consistent topological ordering exists.
*
* One finding is emitted per non-trivial strongly-connected component (size at least 2), carrying
* the full member set and every directed edge between them. This rolls up what would otherwise be
* an explosion of redundant simple-cycle findings covering the same underlying connectivity
* problem.
*
* Only top-level (parent) shapes participate in cycle detection. A dependency that exists solely
* through child shapes — via merge-key matches or recommendation mappings on child shape IDs — is
* not considered when computing strongly-connected components.
*/
export interface MemberDependencyCycle {
	dependencyEdges: Array<CycleDependencyEdge>;
	members: Array<ProductGroupMemberRid>;
}
export type MeshId = string;
/**
* This specifies that the installed profile will govern data peered to all members
* of the identified Mesh Manager mesh.
*/
export interface MeshIdRemoteStrategy {
	meshId: MeshId;
}
export type MeshNodeLabel = string;
/**
* This specifies that the installed profile will govern data peered to members
* of the identified Mesh Manager mesh with the given label(s).
*/
export interface MeshNodeLabelRemoteStrategy {
	meshId: MeshId;
	meshNodeLabels: Array<MeshNodeLabel>;
}
/**
...
*/
export interface MissingInternalRecommendationError {
...
/**
* One or more input shapes on a downstream member have no valid fulfilling recommendation,
* but another member in the group produces a matching output. Aggregated per member,
* grouped by rollup parent shape. Always WARN level.
*
* A recommendation is considered invalid (and therefore non-fulfilling) when it points at
* an upstream output that no longer exists on the upstream's resolved version. Such inputs
* are surfaced via `staleRecommendations` on each shape entry — the suggested remediation
* for those is "regenerate the recommendation" rather than "create one".
*/
export interface MissingRecommendation {
	downstream: ProductGroupMemberRid;
	missingShapes: Array<MissingRecommendationShape>;
}
/**
* Missing-recommendation inputs grouped by parent shape, mirroring UnfulfilledInputShape.
* Providers are merged across all inputs in the group — deduplicated by upstream member with
* `matchingOutputShapeIds` unioned.
*
* When the parent shape is missing a recommendation, `missingChildShapeIds` is empty — the
* parent-level entry covers any children missing a recommendation.
*/
export interface MissingRecommendationShape {
	missingChildShapeIds: Array<InputBlockSetShapeId>;
	parentShapeId: InputBlockSetShapeId;
...
export interface Model3dDecodeFormat_ply {
	type: "ply";
	ply: PlyFormat;
}
export interface Model3dDecodeFormat_obj {
	type: "obj";
	obj: ObjFormat;
}
export type Model3dDecodeFormat = Model3dDecodeFormat_las | Model3dDecodeFormat_ply | Model3dDecodeFormat_obj;
export interface Model3dSchema {
	format: Model3dDecodeFormat;
	modelType?: Model3dType | null | undefined;
}
/**
...
/**
* A Model Studio config.
*/
export interface ModelStudioConfig {
	modelStudioConfigRid: string;
	modelStudioConfigVersionId?: number | null | undefined;
}
export interface ModelStudioConfigIdentifier {
	modelStudioConfigRid: ModelStudioConfigRid;
	modelStudioRid: ModelStudioRid;
}
export type ModelStudioConfigReference = BlockInternalId;
export type ModelStudioConfigRid = string;
/**
* Selects a specific Model Studio config version to package.
*/
export interface ModelStudioConfigSelector {
	modelStudioConfigRid: string;
	modelStudioConfigVersionId: number;
}
export interface ModelStudioConfigShape {
	about: LocalizedTitleAndDescription;
	modelStudio: ModelStudioReference;
}
/**
* Creates a Model Studio block.
*/
export interface ModelStudioCreateBlockRequest {
	modelStudioConfigs: Array<ModelStudioConfigSelector>;
	modelStudioRid: string;
}
export interface ModelStudioIdentifier {
	rid: ModelStudioRid;
}
export interface ModelStudioInputShape {
	about: LocalizedTitleAndDescription;
}
export interface ModelStudioOutputShape {
	about: LocalizedTitleAndDescription;
	configs: Array<ModelStudioConfigReference>;
}
export interface ModelStudioOutputSpecConfig {
	modelStudioConfigs: Array<ModelStudioConfig>;
}
export type ModelStudioReference = BlockInternalId;
export type ModelStudioRid = string;
...
/**
* Request to add and/or remove installations from an existing draft. Added installations will have their
* input mappings copied from the previous version synchronously. We will asynchronously resolve the remaining
* input mappings using presets, automapping, and external recommendations.
*/
export interface ModifyJobDraftInstallationsRequest {
	add: Array<TargetInstallationSpec>;
	additionalRecommendationsToConsider: Array<UpstreamRecommendation>;
	remove: Array<BlockSetInstallationRid>;
}
export interface ModifyJobDraftInstallationsResponse {
	draft: UnresolvedJobDraft;
	metadata: JobDraftMetadata;
}
...
export type NewProjectOrExistingFolder = NewProjectOrExistingFolder_newProject | NewProjectOrExistingFolder_existingFolder;
...
export type NewProjectOrExistingFolderV2 = NewProjectOrExistingFolderV2_newProject | NewProjectOrExistingFolderV2_existingFolder;
...
export type NonConstraintFailureNotificationCause = "INSTALLATION_JOB_SUCCESS" | "INSTALLATION_JOB_FAILURE" | "UPGRADE_PLAN_FAILURE" | "BEGINNING_UPGRADE" | "IDLING";
...
export interface NoNewerVersionsOnReleaseChannelConstraintFailure {
	newerVersionsOnOtherChannels: Record<BlockSetVersionId, Array<ReleaseChannel>>;
	skippedRecalledVersions: Array<BlockSetVersionId>;
}
export interface NormalizationMaxClassificationIdentifier {
	rid: NormalizationMaxClassificationRid;
}
export interface NormalizationMaxClassificationOutputShape {
	about: LocalizedTitleAndDescription;
}
...
export interface NotepadCreateBlockRequest {
	notepadContentVersion?: number | null | undefined;
	rid: string;
}
/**
...
export type NotepadTemplateIdentifier = NotepadTemplateIdentifier_rid | NotepadTemplateIdentifier_ridAndVersion;
...
export type NotepadTemplateParameterIdentifier = NotepadTemplateParameterIdentifier_idAndTemplate;
...
export type NotificationCause = NotificationCause_nonConstraintFailureNotificationCause | NotificationCause_constraintFailure;
...
export type NotificationType = "CONSTRAINT_FAILURE_LOUD" | "CONSTRAINT_FAILURE_QUIET" | "INSTALL_JOB_SUCCESS" | "INSTALL_JOB_FAILURE" | "OTHER_EVENT" | "OTHER_FAILURE";
...
export type ObjectTypeIdentifier = ObjectTypeIdentifier_rid | ObjectTypeIdentifier_id;
...
/**
* Identifies a specific interface link implementation on an ObjectType. An ObjectType may implement the same
* InterfaceLinkType using multiple distinct LinkTypes, so both rids are required to uniquely identify the
* implementation.
*/
export interface ObjectTypeInterfaceLinkImplementation {
	interfaceLinkTypeRid: InterfaceLinkTypeRid;
	linkTypeRid: LinkTypeRid;
}
...
/**
* Per-object-type packaging configurations.
*/
...
export interface ObjectViewCreateBlockRequest {
	editHistoryVersion?: number | null | undefined;
	objectTypeRid: string;
...
export interface OntologyCreateBlockRequest {
	...
	interfaceImplementationsToExclude: Record<ObjectTypeRid, Array<InterfaceTypeRid>>;
	interfaceLinkImplementationsToExclude: Record<ObjectTypeRid, Array<ObjectTypeInterfaceLinkImplementation>>;
...
export type OntologyProjectAssociation = OntologyProjectAssociation_useProject | OntologyProjectAssociation_useOntologyPackage;
...
*/
export interface OrExpressionIdentifier {
	expressions: Array<ContractExpressionIdentifier>;
}
export type OrganizationRid = string;
export interface OtherStoreLocalRecommendationSource {
	marketplaceRid: MarketplaceRid;
}
...
export interface OutputEntityIdentifier_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: AutopilotWorkbenchIdentifier;
}
...
export interface OutputEntityIdentifier_contourRef {
	type: "contourRef";
	contourRef: ContourRefEntityIdentifier;
}
...
export interface OutputEntityIdentifier_function {
	type: "function";
	function: FunctionOutputIdentifier;
}
export interface OutputEntityIdentifier_functionConfiguration {
	type: "functionConfiguration";
	functionConfiguration: FunctionConfigurationIdentifier;
}
export interface OutputEntityIdentifier_functionPackageConfiguration {
	type: "functionPackageConfiguration";
	functionPackageConfiguration: FunctionPackageConfigurationIdentifier;
}
...
export interface OutputEntityIdentifier_interfaceActionTypeConstraint {
	type: "interfaceActionTypeConstraint";
	interfaceActionTypeConstraint: InterfaceActionTypeConstraintIdentifier;
}
export interface OutputEntityIdentifier_interfaceParameterConstraint {
	type: "interfaceParameterConstraint";
	interfaceParameterConstraint: InterfaceParameterConstraintIdentifier;
}
...
export interface OutputEntityIdentifier_modelStudio {
	type: "modelStudio";
	modelStudio: ModelStudioIdentifier;
}
export interface OutputEntityIdentifier_modelStudioConfig {
	type: "modelStudioConfig";
	modelStudioConfig: ModelStudioConfigIdentifier;
}
...
export interface OutputEntityIdentifier_normalizationMaxClassification {
...
export interface OutputEntityIdentifier_peerProducerProfile {
	type: "peerProducerProfile";
	peerProducerProfile: PeerProducerProfileIdentifier;
}
export interface OutputEntityIdentifier_peerProfile {
	type: "peerProfile";
	peerProfile: PeerProfileIdentifier;
}
...
export interface OutputEntityIdentifier_savedSearchAroundV2 {
	type: "savedSearchAroundV2";
	savedSearchAroundV2: SavedSearchAroundV2OutputIdentifier;
}
...
export interface OutputEntityIdentifier_storedProcedure {
	type: "storedProcedure";
	storedProcedure: StoredProcedureEntityIdentifier;
}
...
export interface OutputEntityIdentifier_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: VersionedObjectSetEntityIdentifier;
}
...
export interface OutputEntityIdentifier_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: WorkbenchTemplateIdentifier;
}
export interface OutputEntityIdentifier_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: WorkflowBuilderGraphIdentifier;
}
...
export interface OutputEntityIdentifier_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: SqlWorksheetEntityIdentifier;
}
...
export interface OutputShape_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: AutopilotWorkbenchShape;
}
...
export interface OutputShape_contourRef {
	type: "contourRef";
	contourRef: ContourRefShape;
}
...
export interface OutputShape_function {
	type: "function";
	function: FunctionOutputShape;
}
export interface OutputShape_functionConfiguration {
	type: "functionConfiguration";
	functionConfiguration: FunctionConfigurationShape;
}
export interface OutputShape_functionPackageConfiguration {
	type: "functionPackageConfiguration";
	functionPackageConfiguration: FunctionPackageConfigurationShape;
}
...
export interface OutputShape_interfaceActionTypeConstraint {
	type: "interfaceActionTypeConstraint";
	interfaceActionTypeConstraint: InterfaceActionTypeConstraintShape;
}
export interface OutputShape_interfaceParameterConstraint {
	type: "interfaceParameterConstraint";
	interfaceParameterConstraint: InterfaceParameterConstraintShape;
}
...
export interface OutputShape_modelStudio {
	type: "modelStudio";
	modelStudio: ModelStudioOutputShape;
}
export interface OutputShape_modelStudioConfig {
	type: "modelStudioConfig";
	modelStudioConfig: ModelStudioConfigShape;
}
...
export interface OutputShape_normalizationMaxClassification {
	type: "normalizationMaxClassification";
	normalizationMaxClassification: NormalizationMaxClassificationOutputShape;
}
...
export interface OutputShape_peerProducerProfile {
	type: "peerProducerProfile";
	peerProducerProfile: PeerProducerProfileShape;
}
export interface OutputShape_peerProfile {
	type: "peerProfile";
	peerProfile: PeerProfileShape;
}
...
export interface OutputShape_savedSearchAroundV2 {
	type: "savedSearchAroundV2";
	savedSearchAroundV2: SavedSearchAroundV2OutputShape;
}
...
export interface OutputShape_storedProcedure {
	type: "storedProcedure";
	storedProcedure: StoredProcedureShape;
}
...
export interface OutputShape_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: VersionedObjectSetShape;
}
...
export interface OutputShape_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: WorkbenchTemplateShape;
}
export interface OutputShape_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: WorkflowBuilderGraphShape;
}
...
export interface OutputShape_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: SqlWorksheetShape;
}
...
export interface OutputSpecConfig_appConfigConfig {
	type: "appConfigConfig";
	appConfigConfig: AppConfigOutputSpecConfig;
}
...
export interface OutputSpecConfig_contourConfig {
	type: "contourConfig";
	contourConfig: ContourOutputSpecConfig;
}
...
export interface OutputSpecConfig_modelStudioConfig {
	type: "modelStudioConfig";
	modelStudioConfig: ModelStudioOutputSpecConfig;
}
...
export interface OutputSpecConfig_objectTypeConfig {
	type: "objectTypeConfig";
	objectTypeConfig: ObjectTypeOutputSpecConfig;
}
/**
...
*/
export type OutputSpecConfig = OutputSpecConfig_appConfigConfig | OutputSpecConfig_authoringRepositoryConfig | OutputSpecConfig_automationConfig | OutputSpecConfig_cipherChannelConfig | OutputSpecConfig_cipherLicenseConfig | OutputSpecConfig_contourConfig | OutputSpecConfig_datasetConfig | OutputSpecConfig_eddiePipelineConfig | OutputSpecConfig_mediaSetConfig | OutputSpecConfig_modelConfig | OutputSpecConfig_modelStudioConfig | OutputSpecConfig_computeModuleConfig | OutputSpecConfig_objectViewConfig | OutputSpecConfig_objectTypeConfig;
/**
* Corresponds 1:1 with the member types of the OutputSpecConfig union.
*/
export type OutputSpecConfigType = "APP_CONFIG" | "AUTHORING" | "AUTOMATION" | "CIPHER_CHANNEL" | "CIPHER_LICENSE" | "CONTOUR" | "DATASET" | "EDDIE_PIPELINE" | "MEDIA_SET" | "MODEL" | "MODEL_STUDIO" | "COMPUTE_MODULE" | "OBJECT_VIEW" | "OBJECT_TYPE";
...
export type OutputSpecErrors = OutputSpecErrors_errors | OutputSpecErrors_insufficientPermissions;
...
*/
export type OutputSpecProvenance = OutputSpecProvenance_explicit | OutputSpecProvenance_dependency | OutputSpecProvenance_discovered | OutputSpecProvenance_inferredFolderStructure;
...
/**
* DEPRECATED alongside `OverlappingRecommendations`.
*
* One conflicting fulfillment contributing to an OverlappingRecommendations entry — the upstream member
* providing the recommendation, the upstream output it maps to, and the downstream input shape the
* recommendation fulfills.
*/
export interface OverlappingRecommendation {
	downstreamInputShapeId: InputBlockSetShapeId;
	upstream: ProductGroupMemberRid;
	upstreamOutputShapeId: OutputBlockSetShapeId;
}
/**
* DEPRECATED: replaced by `DuplicateOutputs.downstreamOverlappingRecommendations`. New validation
* runs no longer emit this variant; historical snapshots may still contain it.
*
* Two or more recommendations on a downstream member fulfill the same input shape — each
* from a different in-group upstream member, or the same upstream via mappings to distinct
* outputs. Install-blocking: at install time this surfaces as the
* OverlappingExternalRecommendations error. ERROR level.
*
* Only recommendations whose upstream is itself a member of the group are considered.
* Stale mappings (output absent on the upstream's resolved version) are ignored, mirroring
* install-time behaviour. Findings are rolled up by the downstream input's rollup parent.
*/
export interface OverlappingRecommendations {
	downstream: ProductGroupMemberRid;
	overlaps: Record<InputBlockSetShapeId, Array<OverlappingRecommendation>>;
}
/**
...
export interface OwnedPendingRecommendationSource {
	hasPlaceholderCompatibilityRange?: boolean | null | undefined;
	upstreamUpdateId: UpdatePendingBlockSetVersionSpecsRequestId;
	upstreamVersionId: BlockSetVersionId;
}
...
export type PeerProducerProfileRid = string;
export interface PeerProducerProfileShape {
	about: LocalizedTitleAndDescription;
}
/**
* Creates a peering orchestration block for the given peer profile rid
*/
export interface PeerProfileCreateBlockRequest {
	peerProfileRid: string;
}
export interface PeerProfileIdentifier {
	rid: PeerProfileRid;
}
/**
* This is essentially a copy of the unresolved shape. This is will allow us to build the unresolved
* shape off of the identifier. We are not expecting to build the resolved shape off of the identifier
* since this will be unknown on the packaging stack.
*/
export interface PeerProfileRemoteStrategyIdentifier {
	about: LocalizedTitleAndDescription;
	allowedRemoteStrategyTypes: Array<PeerProfileRemoteStrategyType>;
	stableIdentifier: StableShapeIdentifier;
}
export interface PeerProfileRemoteStrategyMismatch {
	actual: PeerProfileRemoteStrategyType;
	expected: Array<PeerProfileRemoteStrategyType>;
}
export interface PeerProfileRemoteStrategyShape {
	about: LocalizedTitleAndDescription;
	allowedRemoteStrategyTypes: Array<PeerProfileRemoteStrategyType>;
	stableIdentifier: StableShapeIdentifier;
}
export type PeerProfileRemoteStrategyType = "SPECIFIC_REMOTE" | "MESH_ID" | "MESH_NODE_LABEL";
export type PeerProfileRid = string;
export interface PeerProfileShape {
	about: LocalizedTitleAndDescription;
}
export type PendingBlockSetInputShapes = Record<InputBlockSetShapeId, PendingInputBlockSetMappingInfo>;
/**
* Output block set shape IDs uniquely map to a set of backing output shapes that share a single merge key.
*/
export type PendingBlockSetOutputShapes = Record<OutputBlockSetShapeId, PendingOutputBlockSetMappingInfo>;
/**
...
export type PendingRecommendationStatus = PendingRecommendationStatus_processing | PendingRecommendationStatus_complete;
export interface PermanentlyDeleteUninstallOptions {
	forceDelete?: boolean | null | undefined;
}
export interface PinnedMediaSetView {
	endExclusiveTimestamp: number;
	mediaSetViewRid: string;
}
export interface PinnedVersionPolicy {
	blockSetVersionId: BlockSetVersionId;
}
...
/**
* An upstream member whose outputs match a downstream input's merge keys.
*/
export interface PotentialInputProvider {
...
*
* Any input shape transitively referenced by a shape with this requirement is also treated
* as requiring preallocation, so that shape dereferencing always has access to the inputs
* it depends on.
*/
...
*
* This configuration indicates that on installation or upgrade of a Marketplace package, the version of a
* function that is chosen during block pre-allocation is determined by just using the source function's
* version.
*
* For example, if a function at version "1.2.3" is packaged, pre-allocation will return version "1.2.3".
*
* If there is a version conflict (e.g., from releases after unlocking an installation, reconfiguring an
* installation, etc.), then pre-allocation will fail.
*
...
export type PresetValue = PresetValue_fromSource | PresetValue_resolvedShapeOverrides;
export interface PreviewCleanupUnusedShapesResponse {
	outputShapePreviews: Array<OutputShapeCleanupPreview>;
}
export interface PreviewDiscoveryRequest {
	discoverySpecs: Array<DiscoverySpec>;
	settings?: DiscoverySettings | null | undefined;
}
export interface PreviewDiscoveryResponse {
	results: Array<PreviewDiscoveryResult>;
}
/**
* The result of discovery specs. Stored and re-used for caching in future iterations.
*/
export interface PreviewDiscoveryResult {
	ignoredSpecs: Array<OutputSpec>;
	includedSpecs: Array<OutputSpec>;
	rootDiscoverySpec: DiscoverySpec;
}
export interface PreviewUninstallResponse {
	outputShapePreviews: Record<OutputBlockSetShapeId, OutputShapeUninstallPreview>;
}
...
* both funnel and object-set peering producers. This URI makes sure producer profile
* inputs/outputs line up on this dimension.
*/
export type ProducerUri = string;
export type ProductDisplayVersion = string;
/**
* A product group contains a set of Marketplace products (block sets) that are co-deployed,
* with configurable version policies and validation checks.
*/
export interface ProductGroup {
	currentDefinition: VersionedProductGroupDefinition;
	productGroupRid: ProductGroupRid;
}
/**
* Unique identifier for a given member of a product group.
*/
export type ProductGroupMemberRid = string;
export interface ProductGroupMemberSpec_installation {
	type: "installation";
	installation: InstallationProductGroupMember;
}
export interface ProductGroupMemberSpec_blockSet {
	type: "blockSet";
	blockSet: BlockSetProductGroupMember;
}
/**
* The source of a product group member. Determines how the block set is referenced.
*/
export type ProductGroupMemberSpec = ProductGroupMemberSpec_installation | ProductGroupMemberSpec_blockSet;
/**
* Unique identifier for a product group. Used as a Compass resource RID.
*/
export type ProductGroupRid = string;
/**
* An instance of a product group. The snapshot contains the set of resolved product versions at the time
* in which the snapshot was computed along with any validation findings based on the product group's
* definition.
*/
export interface ProductGroupSnapshot {
	creationTimestamp: CreationTimestamp;
	details?: ProductGroupSnapshotDetails | null | undefined;
	productGroupRid: ProductGroupRid;
	productGroupVersionRid: ProductGroupVersionRid;
	snapshotRid: ProductGroupSnapshotRid;
}
/**
* Additional details of a product group snapshot, gated by the requestor's access to the resolved members.
*/
export interface ProductGroupSnapshotDetails {
	snapshotMemberVersions: Array<SnapshotMemberVersion>;
	trigger: ProductGroupSnapshotTrigger;
	validationFindings: Array<ProductGroupValidationFinding>;
	validationStatus: ProductGroupValidationStatus;
}
/**
* Unique identifier for a product group snapshot.
*/
export type ProductGroupSnapshotRid = string;
export interface ProductGroupSnapshotTrigger_manual {
	type: "manual";
	manual: ManualProductGroupSnapshotTrigger;
}
/**
* The reason a snapshot was triggered.
*/
export type ProductGroupSnapshotTrigger = ProductGroupSnapshotTrigger_manual;
/**
* A single validation finding for a product group.
*/
export interface ProductGroupValidationFinding {
	detail: ProductGroupValidationFindingDetail;
	findingLevel: ProductGroupValidationFindingLevel;
	findingRid: ProductGroupValidationFindingRid;
}
export interface ProductGroupValidationFindingDetail_duplicateOutputs {
	type: "duplicateOutputs";
...
export interface ProductGroupValidationFindingDetail_memberDependencyCycle {
	type: "memberDependencyCycle";
	memberDependencyCycle: MemberDependencyCycle;
}
export interface ProductGroupValidationFindingDetail_missingRecommendation {
	type: "missingRecommendation";
	missingRecommendation: MissingRecommendation;
}
export interface ProductGroupValidationFindingDetail_overlappingRecommendations {
	type: "overlappingRecommendations";
	overlappingRecommendations: OverlappingRecommendations;
}
export interface ProductGroupValidationFindingDetail_unfulfilledInput {
	type: "unfulfilledInput";
	unfulfilledInput: UnfulfilledInput;
}
/**
* Detailed information about a specific validation finding.
*/
export type ProductGroupValidationFindingDetail = ProductGroupValidationFindingDetail_duplicateOutputs | ProductGroupValidationFindingDetail_incompatibleExternalRecommendationVersionRange | ProductGroupValidationFindingDetail_memberDependencyCycle | ProductGroupValidationFindingDetail_missingRecommendation | ProductGroupValidationFindingDetail_overlappingRecommendations | ProductGroupValidationFindingDetail_unfulfilledInput;
/**
* The severity level of a validation finding.
*/
export type ProductGroupValidationFindingLevel = "INFO" | "WARN" | "ERROR";
/**
* Identifier for a single product group validation finding. Generated freshly each time
* a validation runs, so it is stable within the findings produced by one run (whether
* surfaced through validateProducts or persisted into a snapshot) but not across runs.
*/
export type ProductGroupValidationFindingRid = string;
/**
...
export interface ProductGroupValidationStatus_warn {
	type: "warn";
	warn: WarnProductGroupValidationStatus;
}
export interface ProductGroupValidationStatus_error {
	type: "error";
	error: ErrorProductGroupValidationStatus;
}
/**
* The overall validation status, derived from the highest severity finding.
* VALID indicates no findings or only INFO-level findings. WARN and ERROR
* correspond to the highest finding level present.
*/
export type ProductGroupValidationStatus = ProductGroupValidationStatus_valid | ProductGroupValidationStatus_warn | ProductGroupValidationStatus_error;
/**
* Unique identifier for a particular version of a product group.
*/
export type ProductGroupVersionRid = string;
...
*/
export type ProductInstallationMode = "PRODUCTION" | "BOOTSTRAPPER" | "SINGLETON";
/**
...
* Defaults to NONE.
*/
export type ProductType = "NONE" | "DATA_CONNNECTION" | "MODELING" | "ONTOLOGY" | "PIPELINE" | "USE_CASE";
...
/**
* Profile must belong to the specified family
*/
export interface ProfileFamilyConstraint {
	familyName: SparkProfileFamilyName;
}
export type ProjectContext = string;
/**
* Capabilities for changing project mutability.
*/
export interface ProjectMutabilityCapabilities {
	canSetProjectMutability: SetProjectMutabilityAllowance;
}
...
export type PropertyTypeRidOrId = PropertyTypeRidOrId_rid | PropertyTypeRidOrId_id;
/**
...
export interface PutMarketplaceMetadataRequest {
	...
	linkedStores?: Array<MarketplaceRid> | null | undefined;
...
export type RecommendationEntryBody = RecommendationEntryBody_simple | RecommendationEntryBody_actionType;
/**
...
*/
export type RefreshSpecsConfig = RefreshSpecsConfig_refreshAll | RefreshSpecsConfig_refreshDiscovery | RefreshSpecsConfig_refreshMaterialization | RefreshSpecsConfig_refreshNone | RefreshSpecsConfig_refreshSubset;
/**
* Request to register a versionless installation. Creates installation metadata without running a job
* and without specifying a version. The installation can later be upgraded via `installBlockSets` with
* `modifyExistingInstallations`.
*/
export interface RegisterInstallationRequest {
	blockSetId: BlockSetId;
	installationSuffix?: string | null | undefined;
	installLocation: TargetRegistrationLocation;
	marketplaceRid: MarketplaceRid;
	targetVersionHint?: BlockSetVersionId | null | undefined;
}
export interface RegisterInstallationResponse {
	installationRid: BlockSetInstallationRid;
}
/**
...
/**
* Resolves to the latest block set version that belongs to any of the specified release channels.
*/
export interface ReleaseChannelVersionPolicy {
	releaseChannels: Array<ReleaseChannel>;
}
export type ReleaseRid = string;
export interface RemoveFromDraftGroupRequest {
	versionIds: Array<BlockSetVersionId>;
}
/**
...
export type RepositorySourceCodePackagingType = "OMIT_SOURCE_CODE" | "SHALLOW_CLONE" | "DEEP_CLONE";
...
export interface ResolvedBlockSetInputOrRef_automapped {
	type: "automapped";
	automapped: AutomappedInput;
}
export type ResolvedBlockSetInputOrRef = ResolvedBlockSetInputOrRef_resolvedInputShape | ResolvedBlockSetInputOrRef_referenceOtherOutput | ResolvedBlockSetInputOrRef_referenceExistingOutputInStore | ResolvedBlockSetInputOrRef_fromDefault | ResolvedBlockSetInputOrRef_automapped;
...
/**
* Contour Analysis resolved shape. Uniquely identifies an analysis resource by its RID.
* The detailed analysis export data (refs, nodes, board states) is stored in block data
* in Artifacts at packaging time, not in the Marketplace API.
*/
export interface ResolvedContourAnalysisShape {
	rid: ContourAnalysisRid;
}
/**
* Resolved Contour Ref shape containing both the analysis RID (for security/parent context)
* and the target ref RID (the resolved value).
*/
export interface ResolvedContourRefShape {
	analysisRid: ContourAnalysisRid;
	refRid: ContourRefRid;
}
...
*/
export type ResolvedEddiePrimitiveParameter = ResolvedEddiePrimitiveParameter_literal | ResolvedEddiePrimitiveParameter_regex | ResolvedEddiePrimitiveParameter_enum;
...
export interface ResolvedEddieReplayOption_acknowledgeStateBreaks {
	type: "acknowledgeStateBreaks";
	acknowledgeStateBreaks: EddieAcknowledgeStateBreakOption;
}
export type ResolvedEddieReplayOption = ResolvedEddieReplayOption_resetAndReplayFromOffset | ResolvedEddieReplayOption_reset | ResolvedEddieReplayOption_acknowledgeStateBreaks;
...
export interface ResolvedFunctionInputShape {
	apiName?: FunctionApiName | null | undefined;
	functionRid: FunctionRid;
	functionVersion: FunctionVersion;
}
export interface ResolvedFunctionOutputShape {
	apiName?: FunctionApiName | null | undefined;
	functionRid: FunctionRid;
	functionVersion: FunctionVersion;
}
export interface ResolvedFunctionPackageCandidateLocator {
	functionRid: FunctionRid;
	functionVersion: FunctionVersion;
	repositoryRid: AuthoringRepositoryRid;
}
export interface ResolvedFunctionPackageConfigurationShape {
	packageLocator: ResolvedFunctionPackageLocator;
}
export interface ResolvedFunctionPackageLocator_candidateFunction {
	type: "candidateFunction";
	candidateFunction: ResolvedFunctionPackageCandidateLocator;
}
export type ResolvedFunctionPackageLocator = ResolvedFunctionPackageLocator_candidateFunction;
/**
* This shape represents an install-time configuration that allows a user to specify how function versions and
* API names are resolved during functions block pre-allocation.
*
* See FunctionsApiStabilityConfiguration for more details.
*/
export interface ResolvedFunctionsApiStabilityConfigurationInputShape {
	configuration: FunctionsApiStabilityConfiguration;
}
/**
* Deprecated: Use ResolvedFunctionsApiStabilityConfigurationInputShape instead.
*
* This shape represents an install-time configuration that allows a user to specify how function versions are
* chosen during block pre-allocation when installing or upgrading a Marketplace package.
*
* See PreserveFunctionVersionsConfiguration for more details.
*/
export interface ResolvedFunctionVersionsConfigurationInputShape {
	configuration: FunctionVersionsConfiguration;
}
...
/**
* Block-level resolved input. Counterpart of `ResolvedBlockSetInputOrRef`.
*/
export type ResolvedInputOrRef = ResolvedInputOrRef_resolvedInputShape | ResolvedInputOrRef_referenceOtherOutput | ResolvedInputOrRef_referenceExistingOutputInStore;
...
export interface ResolvedInputShape_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: RidResolvedShape;
}
...
export interface ResolvedInputShape_contourAnalysis {
	type: "contourAnalysis";
	contourAnalysis: ResolvedContourAnalysisShape;
}
export interface ResolvedInputShape_contourRef {
	type: "contourRef";
	contourRef: ResolvedContourRefShape;
}
...
export interface ResolvedInputShape_function {
	type: "function";
	function: ResolvedFunctionInputShape;
}
...
export interface ResolvedInputShape_interfaceActionTypeConstraint {
	type: "interfaceActionTypeConstraint";
	interfaceActionTypeConstraint: ResolvedInterfaceActionTypeConstraintShape;
}
export interface ResolvedInputShape_interfaceParameterConstraint {
	type: "interfaceParameterConstraint";
	interfaceParameterConstraint: ResolvedInterfaceParameterConstraintShape;
}
...
export interface ResolvedInputShape_modelStudio {
	type: "modelStudio";
	modelStudio: RidResolvedShape;
}
...
export interface ResolvedInputShape_peerProducerProfile {
	type: "peerProducerProfile";
	peerProducerProfile: ResolvedPeerProducerProfileShape;
}
export interface ResolvedInputShape_peerProfile {
	type: "peerProfile";
	peerProfile: RidResolvedShape;
}
export interface ResolvedInputShape_peerProfileRemoteStrategy {
	type: "peerProfileRemoteStrategy";
	peerProfileRemoteStrategy: ResolvedPeerProfileRemoteStrategyShape;
}
...
export interface ResolvedInputShape_storedProcedure {
	type: "storedProcedure";
	storedProcedure: ResolvedStoredProcedureShape;
}
...
export interface ResolvedInputShape_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: ResolvedVersionedObjectSetShape;
}
...
export interface ResolvedInputShape_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: RidResolvedShape;
}
export interface ResolvedInputShape_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: RidResolvedShape;
}
export interface ResolvedInputShape_workflowGraph {
	type: "workflowGraph";
	workflowGraph: RidResolvedShape;
}
export interface ResolvedInputShape_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: ResolvedSqlWorksheetShape;
}
...
export interface ResolvedInstallPrefixShape {
	prefix: string;
	prefixConfiguration?: InstallPrefixConfigurationEnum | null | undefined;
}
export interface ResolvedInterfaceActionTypeConstraintReferenceMismatch {
	actual: InterfaceActionTypeConstraintReference;
	expected: InterfaceActionTypeConstraintReference;
	interfaceTypeRid: InterfaceTypeRid;
}
/**
* Resolved version of the InterfaceActionTypeConstraintShape. References the actual
* InterfaceActionTypeConstraint the shape corresponds to.
*/
export interface ResolvedInterfaceActionTypeConstraintShape {
...
/**
* Resolved version of the InterfaceParameterConstraintShape. References the actual
* InterfaceParameterConstraint the shape corresponds to.
*/
export interface ResolvedInterfaceParameterConstraintShape {
	actionTypeConstraint: InterfaceActionTypeConstraintRid;
	interfaceTypeRid: InterfaceTypeRid;
	ontologyRid: OntologyRid;
	rid: InterfaceParameterConstraintRid;
}
...
/**
* An installation draft with the fully resolved state of all target installations and any validation errors.
* This draft object is updated by asynchronous tasks. Always returns the last processed resolved installations
* and errors. If the status is `idle`, we guarantee these are all up-to-date.
*/
export interface ResolvedJobDraft {
	error?: _api_errors_MarketplaceSerializableError | null | undefined;
	installations: Array<ResolvedInstallation>;
	ownerValidationErrors: JobDraftOwnerValidationErrors;
	rid: BlockSetInstallationJobRid;
}
...
*/
export type ResolvedLinkedOntologyTypes = ResolvedLinkedOntologyTypes_oneToMany | ResolvedLinkedOntologyTypes_manyToMany | ResolvedLinkedOntologyTypes_intermediary;
/**
...
export interface ResolvedModelStudioConfigShape {
	modelStudioConfigRid: ModelStudioConfigRid;
	modelStudioRid: ModelStudioRid;
}
...
export interface ResolvedOutputShape_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: RidResolvedShape;
}
...
export interface ResolvedOutputShape_contourRef {
	type: "contourRef";
	contourRef: ResolvedContourRefShape;
}
...
export interface ResolvedOutputShape_function {
	type: "function";
	function: ResolvedFunctionOutputShape;
}
export interface ResolvedOutputShape_functionConfiguration {
	type: "functionConfiguration";
	functionConfiguration: ResolvedFunctionConfigurationShape;
}
export interface ResolvedOutputShape_functionPackageConfiguration {
	type: "functionPackageConfiguration";
	functionPackageConfiguration: ResolvedFunctionPackageConfigurationShape;
}
...
export interface ResolvedOutputShape_interfaceActionTypeConstraint {
	type: "interfaceActionTypeConstraint";
	interfaceActionTypeConstraint: ResolvedInterfaceActionTypeConstraintShape;
}
export interface ResolvedOutputShape_interfaceParameterConstraint {
	type: "interfaceParameterConstraint";
	interfaceParameterConstraint: ResolvedInterfaceParameterConstraintShape;
}
...
export interface ResolvedOutputShape_modelStudio {
	type: "modelStudio";
	modelStudio: RidResolvedShape;
}
export interface ResolvedOutputShape_modelStudioConfig {
	type: "modelStudioConfig";
	modelStudioConfig: ResolvedModelStudioConfigShape;
}
...
export interface ResolvedOutputShape_normalizationMaxClassification {
	type: "normalizationMaxClassification";
	normalizationMaxClassification: RidResolvedShape;
}
...
export interface ResolvedOutputShape_peerProducerProfile {
	type: "peerProducerProfile";
	peerProducerProfile: ResolvedPeerProducerProfileShape;
}
export interface ResolvedOutputShape_peerProfile {
	type: "peerProfile";
	peerProfile: RidResolvedShape;
}
...
export interface ResolvedOutputShape_savedSearchAroundV2 {
	type: "savedSearchAroundV2";
	savedSearchAroundV2: ResolvedSavedSearchAroundV2OutputShape;
}
...
export interface ResolvedOutputShape_storedProcedure {
	type: "storedProcedure";
	storedProcedure: ResolvedStoredProcedureShape;
}
...
export interface ResolvedOutputShape_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: ResolvedVersionedObjectSetShape;
}
...
export interface ResolvedOutputShape_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: RidResolvedShape;
}
export interface ResolvedOutputShape_workflowBuilderGraph {
	type: "workflowBuilderGraph";
	workflowBuilderGraph: RidResolvedShape;
}
...
export interface ResolvedOutputShape_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: ResolvedSqlWorksheetShape;
}
...
export type ResolvedOutputSpecConfig = ResolvedOutputSpecConfig_notConfigurable | ResolvedOutputSpecConfig_config;
...
export type ResolvedOutputSpecVersion = ResolvedOutputSpecVersion_unversioned | ResolvedOutputSpecVersion_version;
/**
...
export interface ResolvedPeerProducerProfileShape {
	peerProducerProfileRid: PeerProducerProfileRid;
	peerProducerUri: ProducerUri;
	peerProfileRid: PeerProfileRid;
}
export interface ResolvedPeerProfileRemoteStrategyShape_specificRemote {
	type: "specificRemote";
	specificRemote: SpecificRemoteStrategy;
}
export interface ResolvedPeerProfileRemoteStrategyShape_meshId {
	type: "meshId";
	meshId: MeshIdRemoteStrategy;
}
export interface ResolvedPeerProfileRemoteStrategyShape_meshNodeLabel {
	type: "meshNodeLabel";
	meshNodeLabel: MeshNodeLabelRemoteStrategy;
}
export type ResolvedPeerProfileRemoteStrategyShape = ResolvedPeerProfileRemoteStrategyShape_specificRemote | ResolvedPeerProfileRemoteStrategyShape_meshId | ResolvedPeerProfileRemoteStrategyShape_meshNodeLabel;
...
export type ResolvedPresetValue = ResolvedPresetValue_fromSource | ResolvedPresetValue_resolvedShapeOverrides;
/**
* The result of resolving a product group member's version policy to a concrete block set version. If the
* requestor does not have access to the member's source, the resolved version will not be provided.
*/
export interface ResolvedProductGroupMember {
	blockSetVersionId?: BlockSetVersionId | null | undefined;
	memberRid: ProductGroupMemberRid;
	source: ProductGroupMemberSpec;
	version?: SemverVersion | null | undefined;
}
...
/**
* Resolved reference to a specific Search Around.
*/
export interface ResolvedSavedSearchAroundV2OutputShape {
	rid: string;
}
...
export type ResolvedShapeResolutionResultUnion = ResolvedShapeResolutionResultUnion_resolutionSuccess | ResolvedShapeResolutionResultUnion_resolutionFailure;
...
export interface ResolvedSqlWorksheetShape {
	sqlWorksheetRid: string;
	version: string;
}
export interface ResolvedStoredProcedureShape {
	securityRid: string;
	specVersion: string;
...
export interface ResolvedVersionedObjectSetShape {
	version: string;
	versionedObjectSetRid: string;
}
/**
...
/**
* Resolves a version for a given member source.
*/
export interface ResolveMemberSourceRequest {
	memberSource: ProductGroupMemberSpec;
}
export interface ResolveMemberSourceResponse {
	blockSetId: BlockSetId;
	blockSetVersionId: BlockSetVersionId;
	marketplaceRid: MarketplaceRid;
	memberSource: ProductGroupMemberSpec;
...
/**
* The provided RID is not a project (e.g., it is a folder).
*/
export interface ResourceIsNotProject {
	resourceRid: CompassFolderRid;
}
...
*/
export type ResourceVersion = ResourceVersion_integer | ResourceVersion_long | ResourceVersion_rid | ResourceVersion_semver | ResourceVersion_string | ResourceVersion_uuid;
/**
* Corresponds 1:1 with the member types of the ResourceVersion union.
*/
export type ResourceVersionType = "INTEGER" | "LONG" | "RID" | "SEMVER" | "STRING" | "UUID";
...
export interface SavedSearchAroundV2CreateBlockRequest {
	rid: string;
}
export interface SavedSearchAroundV2OutputIdentifier {
	rid: string;
}
/**
* An Advanced Search Around (Search Around V2) - a saved, versioned
* graph-traversal query over the Foundry Ontology.
*/
export interface SavedSearchAroundV2OutputShape {
	about: LocalizedTitleAndDescription;
}
/**
...
export type SetInputPresetValueRequest = SetInputPresetValueRequest_fromSource | SetInputPresetValueRequest_resolvedShapeOverrides;
...
export interface SetProjectImmutabilityRequest {
	immutability: BlockSetInstallationImmutability;
	projectRid: CompassProjectRid;
	rolesMap: Record<RoleId, Array<RoleId>>;
}
...
export interface SetProjectMutabilityAllowance_disallowed {
	type: "disallowed";
	disallowed: SetProjectMutabilityDisallowedRationale;
}
export type SetProjectMutabilityAllowance = SetProjectMutabilityAllowance_allowed | SetProjectMutabilityAllowance_disallowed;
export interface SetProjectMutabilityDisallowedRationale_permissionDenied {
	type: "permissionDenied";
	permissionDenied: SetProjectMutabilityPermissionDenied;
}
export interface SetProjectMutabilityDisallowedRationale_resourceIsNotProject {
	type: "resourceIsNotProject";
	resourceIsNotProject: ResourceIsNotProject;
}
/**
* Rationale for why project mutability cannot be changed.
*/
export type SetProjectMutabilityDisallowedRationale = SetProjectMutabilityDisallowedRationale_permissionDenied | SetProjectMutabilityDisallowedRationale_resourceIsNotProject;
/**
* The user does not have permission to change the project's mutability.
*/
export interface SetProjectMutabilityPermissionDenied {
	projectRid: CompassProjectRid;
}
...
/**
* Declarative specification of the desired input mappings and output shapes for a single installation
* within a draft. Replaces the existing mappings entirely. Optional overrides can be provided to
* selectively modify other installation properties.
*/
export interface SetTargetInstallation {
	installationRid: BlockSetInstallationRid;
	overrides?: TargetInstallationOverrides | null | undefined;
	resolvedOutputShapesToAttach: Record<OutputBlockSetShapeId, ResolvedBlockSetOutputShape>;
	targetInputShapes: Record<InputBlockSetShapeId, TargetInputShape>;
}
...
export interface ShapeDisplayMetadata_autopilotWorkbench {
	type: "autopilotWorkbench";
	autopilotWorkbench: SimpleDisplayMetadata;
}
...
export interface ShapeDisplayMetadata_contourRef {
	type: "contourRef";
	contourRef: SimpleDisplayMetadata;
}
...
export interface ShapeDisplayMetadata_functionPackageConfiguration {
	type: "functionPackageConfiguration";
	functionPackageConfiguration: SimpleDisplayMetadata;
}
...
export interface ShapeDisplayMetadata_interfaceActionTypeConstraint {
	type: "interfaceActionTypeConstraint";
	interfaceActionTypeConstraint: SimpleDisplayMetadata;
}
export interface ShapeDisplayMetadata_interfaceParameterConstraint {
	type: "interfaceParameterConstraint";
	interfaceParameterConstraint: SimpleDisplayMetadata;
}
...
export interface ShapeDisplayMetadata_modelStudio {
	type: "modelStudio";
	modelStudio: SimpleDisplayMetadata;
}
export interface ShapeDisplayMetadata_modelStudioConfig {
	type: "modelStudioConfig";
	modelStudioConfig: SimpleDisplayMetadata;
}
...
export interface ShapeDisplayMetadata_storedProcedure {
	type: "storedProcedure";
	storedProcedure: SimpleDisplayMetadata;
}
...
export interface ShapeDisplayMetadata_versionedObjectSet {
	type: "versionedObjectSet";
	versionedObjectSet: SimpleDisplayMetadata;
}
...
export interface ShapeDisplayMetadata_workbenchTemplate {
	type: "workbenchTemplate";
	workbenchTemplate: SimpleDisplayMetadata;
}
export interface ShapeDisplayMetadata_workflowGraph {
	type: "workflowGraph";
	workflowGraph: SimpleDisplayMetadata;
}
export interface ShapeDisplayMetadata_sqlWorksheet {
	type: "sqlWorksheet";
	sqlWorksheet: SimpleDisplayMetadata;
}
...
export interface ShapeInstallationStatusFailed {
	...
	shapeGroupErrorsV2: Array<BlockInstallationFailureV2>;
}
/**
...
export type ShapesAffectedByMarkings = ShapesAffectedByMarkings_datasource | ShapesAffectedByMarkings_propertyType | ShapesAffectedByMarkings_thirdPartyApplication;
...
/**
* A point-in-time resolved version for a product group member, captured when the snapshot was created.
* Unlike ResolvedProductGroupMember, all fields are always populated because the snapshot stores the
* concrete resolved state rather than applying read-time permission filtering.
*/
export interface SnapshotMemberVersion {
	blockSetVersionId: BlockSetVersionId;
	memberRid: ProductGroupMemberRid;
	source: ProductGroupMemberSpec;
	version?: SemverVersion | null | undefined;
...
*/
export type SoftDeleteMode = SoftDeleteMode_trash | SoftDeleteMode_skip | SoftDeleteMode_disable;
/**
...
export interface SparkProfileConstraint_profileFamily {
	type: "profileFamily";
	profileFamily: ProfileFamilyConstraint;
}
export type SparkProfileConstraint = SparkProfileConstraint_allowedProfileNames | SparkProfileConstraint_profileFamily;
/**
...
/**
* The selected spark profile does not belong to the expected profile family.
*/
export interface SparkProfileFamilyMismatch {
	actualFamily: SparkProfileFamilyName;
	expectedFamily: SparkProfileFamilyName;
	profile: SparkProfileName;
}
export type SparkProfileFamilyName = string;
...
export interface SparkProfileIdentifier_nameConstrained {
	type: "nameConstrained";
	nameConstrained: SparkProfileNameConstrained;
}
export type SparkProfileIdentifier = SparkProfileIdentifier_rid | SparkProfileIdentifier_name | SparkProfileIdentifier_nameConstrained;
export interface SparkProfileIdentifierConstraint_sameProfileFamily {
	type: "sameProfileFamily";
	sameProfileFamily: Void;
}
export interface SparkProfileIdentifierConstraint_allowedProfileNames {
	type: "allowedProfileNames";
	allowedProfileNames: AllowedProfileNamesConstraint;
}
export type SparkProfileIdentifierConstraint = SparkProfileIdentifierConstraint_sameProfileFamily | SparkProfileIdentifierConstraint_allowedProfileNames;
export type SparkProfileName = string;
/**
* A spark profile identified by name with an associated constraint.
*/
export interface SparkProfileNameConstrained {
...
/**
* This specifies that the installed profile will govern data peered to this specific remote
* system and namespace pair.
*/
export interface SpecificRemoteStrategy {
	remoteNamespace: NamespaceRid;
	remoteSystem: SystemId;
}
export interface SpecsSettings {
	discovery: DiscoverySettings;
	isStrictFolderTrackingModeEnabled?: boolean | null | undefined;
	targetEnvironment?: TargetEnvironment | null | undefined;
}
...
/**
* Creates a SQL Worksheet
*/
export interface SqlWorksheetCreateBlockRequest {
	rid: string;
	version: SqlWorksheetVersion;
}
/**
* Worksheet with SQL content.
* They are used to run sql analytics, create datasets, or back stored procedures and SQL functions
*/
export interface SqlWorksheetEntityIdentifier {
	sqlWorksheetRid: string;
	version: string;
}
export interface SqlWorksheetShape {
	about: LocalizedTitleAndDescription;
}
export interface SqlWorksheetVersion_uuid {
	type: "uuid";
	uuid: string;
}
export type SqlWorksheetVersion = SqlWorksheetVersion_uuid;
...
/**
* This configuration indicates that on functions block installation...
* (1) The function version that is pre-allocated is always the source function version. If there is a version
* conflict (e.g., from releases after unlocking an installation, reconfiguring an installation, etc.), then
* a new function RID will be pre-allocated.
*
* (2) The API name that is pre-allocated is always the source API name. If there is an API name conflict with
* another existing function in the target location, then an error is thrown.
*
...
/**
* Within a parent shape's group, one or more inputs had a recommendation to `upstream`
* whose mapped upstream outputs no longer exist on the upstream's resolved version.
* Aggregated per upstream so a parent that lost N children produces one entry, not N.
*/
export interface StaleRecommendation {
	source: ExternalRecommendationSource;
	staleMappings: Record<InputBlockSetShapeId, OutputBlockSetShapeId>;
	upstream: ProductGroupMemberRid;
}
...
/**
* Stored Procedure used to store SQL
*/
export interface StoredProcedureEntityIdentifier {
	specVersion: string;
	storedProcedureRid: string;
}
...
export interface StoreMetadata {
	...
	displayName?: StoreName | null | undefined;
	linkedStores: Array<MarketplaceRid>;
	requireApprovals?: boolean | null | undefined;
}
...
export interface StreamDatasetCreateBlockRequest {
	...
	viewRid?: string | null | undefined;
}
export interface StreamingVideoContainerFormat_webm {
	type: "webm";
	webm: WebmStreamingFormat;
}
export interface StreamingVideoContainerFormat_cmaf {
	type: "cmaf";
	cmaf: CmafStreamingFormat;
}
export type StreamingVideoContainerFormat = StreamingVideoContainerFormat_webm | StreamingVideoContainerFormat_cmaf;
export interface StreamingVideoSchema {
	format: StreamingVideoContainerFormat;
}
...
/**
* In strict folder tracking mode only folder discovery specs are supported. The product had a different type of
* discovery spec.
*/
export interface StrictFolderTrackingInvalidDiscoverySpec {
	discoverySpec: DiscoverySpec;
}
/**
* In strict folder tracking mode all outputs need to be either discovered or pulled in as dependencies. The
* given output spec had neither discovery or dependency provenance.
*/
export interface StrictFolderTrackingInvalidProvenance {
	outputSpec: OutputSpec;
	provenance: Array<OutputSpecProvenance>;
}
/**
* In strict folder tracking mode there needs to be exactly one discovery spec. The product has multiple
* discovery specs.
*/
export interface StrictFolderTrackingMultipleDiscoverySpecs {
	discoverySpecs: Array<DiscoverySpec>;
}
/**
...
/**
* Similar to the `MarkingType` enum in Multipass, but we distinguish organization markings from non-organization
* mandatory markings.
*
* - `MANDATORY_NOT_ORGANIZATION`: Supports only mandatory markings (not organization markings).
* - `ORGANIZATION`: Supports organization markings.
* - `CBAC`: Supports CBAC markings.
*/
export type SupportedMarkingsTypeV2 = "MANDATORY_NOT_ORGANIZATION" | "ORGANIZATION" | "CBAC";
/**
* Unique identifier for a Multipass instance.
*/
...
export type TabularDatasourceType = "DATASET" | "RESTRICTED_VIEW" | "STREAM" | "VIRTUAL_TABLE" | "DIRECT_SOURCE";
/**
...
/**
* The target environment the resources should be packaged for. Note that all products should support cloud,
* edge should be considered an additional "add on".
*
* CLOUD: Product only needs to support cloud.
* EDGE/EDGE_DEPRECATED: Product needs to support both cloud _and_ edge.
*
* Note that for most blocks, the packaging is supposed to be compatible with both cloud and edge. This should
* only be used for blocks that need to be packaged differently depending on the target environment.
*/
export type TargetEnvironment = "CLOUD" | "EDGE" | "EDGE_DEPRECATED";
export interface TargetInputShape {
	resolvedShape?: ResolvedBlockSetInputShape | null | undefined;
}
/**
* A snapshot of a target installation within the draft, reflecting the cumulative state of its target version
* and input mappings across all modifications made to the draft. Modifications are then processed asynchronously
* until the resolved draft is consistent with these latest target states.
*/
export interface TargetInstallation {
	installationRid: BlockSetInstallationRid;
	resolvedOutputShapesToAttach: Record<OutputBlockSetShapeId, ResolvedBlockSetOutputShape>;
	targetInputShapes: Record<InputBlockSetShapeId, TargetInputShape>;
	targetLocation: TargetInstallLocationV3;
	targetVersion: InstallableBlockSetVersionId;
}
/**
* Optional, non-declarative overrides for installation properties. Each field is optional -
* absent fields preserve the existing value, present fields replace it.
*/
export interface TargetInstallationOverrides {
	targetLocation?: SetTargetInstallLocation | null | undefined;
}
/**
* Provide an existing installation whose current state and resolved shapes will be copied forward, with the
* target version we want to install.
*/
export interface TargetInstallationSpec {
	installationRid: BlockSetInstallationRid;
	targetVersion: InstallableBlockSetVersionId;
}
export interface TargetInstallationSummary {
	installationRid: BlockSetInstallationRid;
	targetVersion: InstallableBlockSetVersionId;
}
/**
...
/**
* The target install location that will be used during this installation. The block set installation resource
* must already exist and be within the stated Compass location. The Ontology location can be set or overridden
* in the context of a job.
*/
export interface TargetInstallLocationV3 {
	compass: BlockSetCompassInstallLocation;
	ontology?: OntologyInstallLocation | null | undefined;
}
/**
...
/**
* The location that a block set will be registered in.
*/
export interface TargetRegistrationLocation {
	compass: CompassInstallLocation;
	ontology?: OntologyInstallLocation | null | undefined;
}
/**
...
export interface ThirdPartyApplicationCreateBlockRequest {
	applicationVersion?: number | null | undefined;
...
export type TitleOverrideRequest = TitleOverrideRequest_set | TitleOverrideRequest_remove;
...
export type TransportBlockSetInputGroups = Record<BlockSetInputGroupId, InputGroupBlockSetMappingInfo>;
export type TransportBlockSetInputShapes = Record<InputBlockSetShapeId, TransportInputBlockSetMappingInfo>;
export type TransportBlockSetOutputShapes = Record<OutputBlockSetShapeId, TransportOutputBlockSetMappingInfo>;
/**
...
/**
* Metadata about the packaging and publication process for a block set version.
*/
export interface TransportPackagingMetadata {
	publishedByDifferentUser: boolean;
}
...
/**
* One or more input shapes on a downstream member have no valid fulfilling recommendation
* and no other member produces a matching output. All such inputs are aggregated into
* a single finding per member, grouped by rollup parent shape.
*
* A recommendation is considered invalid (and therefore non-fulfilling) when it points at
* an upstream output that no longer exists on the upstream's resolved version. Such inputs
* are surfaced via `staleRecommendations` on each shape entry.
*
* Finding level is ERROR when any unfulfilled input lacks a preset, INFO otherwise.
* Ignored and optional inputs produce no finding. When another member does produce a
* matching output, a MissingRecommendation finding is emitted instead.
*/
export interface UnfulfilledInput {
	downstream: ProductGroupMemberRid;
	unfulfilledShapes: Array<UnfulfilledInputShape>;
}
/**
* Unfulfilled inputs grouped by parent shape. When the parent shape is unfulfilled,
* `missingChildShapeIds` is empty — the parent-level entry covers any unfulfilled children.
* Otherwise, `missingChildShapeIds` lists the unfulfilled children of this parent.
*/
export interface UnfulfilledInputShape {
	missingChildShapeIds: Array<InputBlockSetShapeId>;
	parentShapeId: InputBlockSetShapeId;
	staleRecommendations: Array<StaleRecommendation>;
}
...
export type UninstallMode = UninstallMode_permanentlyDelete | UninstallMode_fieldTestPermanentlyDelete | UninstallMode_softDelete;
...
export type UninstallResponse = UninstallResponse_success | UninstallResponse_failure;
export interface UninstallResponseFailure {
	errors: Array<BlockSetShapesRemovalError>;
	otherErrors: Array<UninstallError>;
	successfullyDeletedOutputs: Record<OutputBlockSetShapeId, ResolvedOutputShape>;
}
...
/**
* The unresolved user-intent encoding the target installations. This is always returned synchronously on
* updates from the user.
*/
export interface UnresolvedJobDraft {
	additionalRecommendationsToConsider: Array<UpstreamRecommendation>;
	installations: Array<TargetInstallation>;
	rid: BlockSetInstallationJobRid;
}
/**
* A member of a product group, representing a block set with a source and backing version policy.
*/
export interface UnresolvedProductGroupMember {
	memberRid: ProductGroupMemberRid;
	source: ProductGroupMemberSpec;
}
/**
...
export interface UpdateAboutRequest_set {
	type: "set";
	set: LocalizedTitleAndDescription;
}
export type UpdateAboutRequest = UpdateAboutRequest_set;
...
export interface UpdateDefaultInstallationSettingsRequest_set {
	type: "set";
	set: DefaultInstallationSettings;
}
export interface UpdateDefaultInstallationSettingsRequest_remove {
	type: "remove";
	remove: Void;
}
export type UpdateDefaultInstallationSettingsRequest = UpdateDefaultInstallationSettingsRequest_set | UpdateDefaultInstallationSettingsRequest_remove;
/**
* An identifier for tracking the processing of external recommendation refresh requests. Increases
...
* processed. If multiple requests are submitted whilst the last update is still being processed, we will process
* the latest request only.
*/
export type UpdateExternalRecsRequestId = number;
/**
* Request to declaratively set the target state for all the installations in an existing draft, e.g., setting
* the input mappings. We will synchronously return the new target state requested by the user, which is a
* culmination of this and other update requests. The fully resolved result of these updates will be returned
* asynchronously.
* Cannot be used to add or remove installations, for this use `modifyJobDraftInstallations`. All installations
* currently in the draft must be included. Throws `JobDraftInstallationsNotInDraft` if unknown installations
* are added, and `JobDraftInstallationsMissingFromUpdateRequest` if any existing installations are omitted.
*/
export interface UpdateJobDraftRequest {
	installations: Array<SetTargetInstallation>;
}
export interface UpdateJobDraftResponse {
	draft: UnresolvedJobDraft;
	metadata: JobDraftMetadata;
}
/**
...
export interface UpdateMarketplaceMetadataVersionRequest_remove {
	type: "remove";
	remove: Void;
}
export type UpdateMarketplaceMetadataVersionRequest = UpdateMarketplaceMetadataVersionRequest_set | UpdateMarketplaceMetadataVersionRequest_remove;
export interface UpdatePackagingSettingsRequest_set {
	type: "set";
	set: PackagingSettings;
}
export interface UpdatePackagingSettingsRequest_remove {
	type: "remove";
	remove: Void;
}
export type UpdatePackagingSettingsRequest = UpdatePackagingSettingsRequest_set | UpdatePackagingSettingsRequest_remove;
/**
...
/**
* Patch-style update of block set version metadata. Only fields that are present in the
* request will be updated. Absent fields are left unchanged.
*/
export interface UpdatePendingBlockSetVersionMetadataRequestV3 {
	about?: UpdateAboutRequest | null | undefined;
	defaultInstallationSettings?: UpdateDefaultInstallationSettingsRequest | null | undefined;
	marketplaceMetadataVersion?: UpdateMarketplaceMetadataVersionRequest | null | undefined;
	packagingSettings?: UpdatePackagingSettingsRequest | null | undefined;
	tagsV2?: UpdateTagsV2Request | null | undefined;
...
export interface UpdatePlaceholdersRequest {
	inputShapesToUpdatePlaceholdersFor: Record<InputBlockSetShapeId, UpdatePlaceholderRequest>;
}
...
export type UpdatePresetsRequest = UpdatePresetsRequest_set | UpdatePresetsRequest_remove;
/**
...
export type UpdateTagsV2Request = UpdateTagsV2Request_set;
export interface UpdateTypedTagsRequest_set {
	type: "set";
	set: Array<TagRid>;
}
export type UpdateTypedTagsRequest = UpdateTypedTagsRequest_set;
export interface UpdateVersionIncrementRequest_set {
	type: "set";
	set: VersionIncrement;
}
export interface UpdateVersionIncrementRequest_remove {
	type: "remove";
	remove: Void;
}
export type UpdateVersionIncrementRequest = UpdateVersionIncrementRequest_set | UpdateVersionIncrementRequest_remove;
...
export type UpdateVisibilityRequest = UpdateVisibilityRequest_set | UpdateVisibilityRequest_remove;
/**
...
export interface UploadingStatusV3 {
	hasErrors: boolean;
	hasWarnings: boolean;
}
/**
* Used to reference an installation and recommendation source, such that external recommendations provided by
* this upstream will be used to resolve inputs for installations within this job draft.
* These upstream installations must not also be members of the target installations in the draft.
*/
export interface UpstreamRecommendation {
	blockSetInstallation: BlockSetInstallationRid;
	recommendationSource: ExternalRecommendationSource;
}
export type Url = string;
/**
* A versioned cross stack identifier for a user managed value type.
*/
export interface UserManagedValueTypeIdentifier {
	apiName: ValueTypeApiName;
	version: ValueTypeVersion;
}
...
export type ValidateMarketplaceMavenGroupFailure = ValidateMarketplaceMavenGroupFailure_groupAlreadyUsed | ValidateMarketplaceMavenGroupFailure_groupMalformed | ValidateMarketplaceMavenGroupFailure_other;
...
export type ValidateMarketplaceMavenGroupResponse = ValidateMarketplaceMavenGroupResponse_success | ValidateMarketplaceMavenGroupResponse_failure;
...
export interface ValidateProductsRequest {
	productGroup: ProductGroupRid;
	productGroupVersionRid?: ProductGroupVersionRid | null | undefined;
}
/**
* Response containing validation findings and an overall status.
*/
export interface ValidateProductsResponse {
	findings: Array<ProductGroupValidationFinding>;
...
export interface ValueTypeCreateBlockRequest {
	valueTypeRid: string;
	valueTypeVersionId?: string | null | undefined;
}
/**
...
export interface ValueTypePresetResolver_userManaged {
	type: "userManaged";
	userManaged: UserManagedValueTypeIdentifier;
}
export interface ValueTypePresetResolver_serviceManaged {
	type: "serviceManaged";
	serviceManaged: ServiceManagedValueTypeIdentifier;
}
/**
* Resolver for user or service defined value types. It is necessary to separate the user and service defined
* value types, despite being identical objects, as each type of value type is locked down by different
* gatekeeper resources.
*/
export type ValueTypePresetResolver = ValueTypePresetResolver_userManaged | ValueTypePresetResolver_serviceManaged;
...
*/
export type ValueTypeShapeValidationError = ValueTypeShapeValidationError_valueTypeNotFound | ValueTypeShapeValidationError_valueTypeVersionNotFound | ValueTypeShapeValidationError_valueTypeBaseTypeMismatch;
/**
...
/**
* Could not find the value type with the requested rid or at the requested version.
*/
...
/**
* Creates a Versioned Object Set
*/
export interface VersionedObjectSetCreateBlockRequest {
	rid: string;
	version?: string | null | undefined;
}
/**
* Identifies a specific version of a versioned object set.
*/
export interface VersionedObjectSetEntityIdentifier {
	version: string;
	versionedObjectSetRid: string;
}
/**
...
export type VersionedObjectSetVersion = string;
/**
* Versioned definition of a product group.
*/
export interface VersionedProductGroupDefinition {
	createdBy: MultipassUserId;
	creationTimestamp: CreationTimestamp;
	members: Array<ResolvedProductGroupMember>;
	productGroupRid: ProductGroupRid;
	productGroupVersionRid: ProductGroupVersionRid;
...
* DEPRECATED: Replaced by block set shapes internal recommendations.
*/
export type VersionRangeBlockSetReference = VersionRangeBlockSetReference_external | VersionRangeBlockSetReference_internal;
...
export type WebmAudioCodec = "OPUS" | "VORBIS";
...
export interface WebmStreamingFormat {
	audioCodec?: WebmAudioCodec | null | undefined;
...
export interface WorkbenchTemplateCreateBlockRequest {
	rid: string;
}
export interface WorkbenchTemplateIdentifier {
	rid: WorkbenchTemplateRid;
}
export type WorkbenchTemplateRid = string;
export interface WorkbenchTemplateShape {
	about: LocalizedTitleAndDescription;
}
/**
* Creates a Workflow Builder Graph block.
*/
export interface WorkflowBuilderGraphCreateBlockRequest {
	rid: string;
	versionId: string;
}
export interface WorkflowBuilderGraphIdentifier_rid {
	type: "rid";
	rid: WorkflowBuilderRid;
}
export type WorkflowBuilderGraphIdentifier = WorkflowBuilderGraphIdentifier_rid;
/**
* Workflow Builder Graph shape that can be used to generate Workflow Builder Graphs.
*/
export interface WorkflowBuilderGraphShape {
	about: LocalizedTitleAndDescription;
}
export type WorkflowBuilderRid = string;
export type WorkflowBuilderVersion = string;
/**
* Creates a Workflow Lineage Graph block.
*/
...
export type WorkshopApplicationSaveLocation = WorkshopApplicationSaveLocation_compass;
/**
