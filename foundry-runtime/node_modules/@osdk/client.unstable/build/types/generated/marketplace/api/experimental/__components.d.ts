import type { BlockSetId as _api_BlockSetId, BlockSetInstallationJobRid as _api_BlockSetInstallationJobRid, BlockSetInstallationRid as _api_BlockSetInstallationRid, BlockSetInstallValidationErrorDetailV2 as _api_BlockSetInstallValidationErrorDetailV2, BlockSetVersion as _api_BlockSetVersion, BlockSetVersionId as _api_BlockSetVersionId, CompassFolderRid as _api_CompassFolderRid, CronWithTimeZoneValue as _api_CronWithTimeZoneValue, ErrorSeverity as _api_ErrorSeverity, InstallationJobValidationError as _api_InstallationJobValidationError, InstallShapeValidationError as _api_InstallShapeValidationError, MarketplaceRid as _api_MarketplaceRid, OntologyRid as _api_OntologyRid, ResolvedAllowOntologySchemaMigrationsShape as _api_ResolvedAllowOntologySchemaMigrationsShape, ResolvedEddieReplayOption as _api_ResolvedEddieReplayOption, ResolvedInstallPrefixShape as _api_ResolvedInstallPrefixShape, SecretName as _api_SecretName } from "../__components.js";
...
export type ErrorUnion = ErrorUnion_shape | ErrorUnion_blockSet | ErrorUnion_job;
...
export type InstallationInputValue = InstallationInputValue_present | InstallationInputValue_unset;
...
export type SimpleResolvedInputShape = SimpleResolvedInputShape_rid | SimpleResolvedInputShape_apiName | SimpleResolvedInputShape_string | SimpleResolvedInputShape_strings | SimpleResolvedInputShape_boolean | SimpleResolvedInputShape_installPrefix | SimpleResolvedInputShape_integer | SimpleResolvedInputShape_cron | SimpleResolvedInputShape_credential | SimpleResolvedInputShape_allowOntologySchemaMigrations | SimpleResolvedInputShape_eddieReplayOption;
...
export type TargetVersion = TargetVersion_latest | TargetVersion_semver | TargetVersion_versionId;
