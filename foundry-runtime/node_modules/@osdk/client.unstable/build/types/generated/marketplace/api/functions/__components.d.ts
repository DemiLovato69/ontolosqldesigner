import type { ActionTypeReference as _api_ActionTypeReference, InterfaceTypeReference as _api_InterfaceTypeReference, LocalizedTitleAndDescription as _api_LocalizedTitleAndDescription, ObjectTypePropertyReference as _api_ObjectTypePropertyReference, ObjectTypeReference as _api_ObjectTypeReference, ValueTypeReference as _api_ValueTypeReference, Void as _api_Void } from "../__components.js";
...
export type BucketKeyType = BucketKeyType_double | BucketKeyType_integer | BucketKeyType_date | BucketKeyType_timestamp | BucketKeyType_range | BucketKeyType_string | BucketKeyType_boolean;
...
export type BucketValueType = BucketValueType_double | BucketValueType_timestamp | BucketValueType_date;
...
export type GeoShapeSubType = GeoShapeSubType_geoPoint | GeoShapeSubType_polygon | GeoShapeSubType_lineString | GeoShapeSubType_multiGeoPoint | GeoShapeSubType_multiPolygon | GeoShapeSubType_multiLineString | GeoShapeSubType_geometryCollection;
/**
...
export type LogicalTypeReference = LogicalTypeReference_ontologyTypeRegistryReference;
...
export type MarkingSubType = MarkingSubType_classificationMarking | MarkingSubType_mandatoryMarking;
...
export type ObjectPrimaryKey = Record<_api_ObjectTypePropertyReference, ObjectPrimaryKeyValue>;
/**
...
export type RangeType = RangeType_integer | RangeType_double | RangeType_timestamp | RangeType_date;
...
export type TimeSeriesValueType = TimeSeriesValueType_numeric | TimeSeriesValueType_enum;
...
export type Value = Value_boolean | Value_integer | Value_long | Value_float | Value_double | Value_string | Value_date | Value_timestamp | Value_list | Value_set | Value_objectLocator;
