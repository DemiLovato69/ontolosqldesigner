import type { ApolloEntityId as _api_ApolloEntityId, ApolloEnvironmentId as _api_ApolloEnvironmentId, ApolloFoundrySpaceIdentifier as _api_ApolloFoundrySpaceIdentifier, ApolloSpaceId as _api_ApolloSpaceId, BlockSetId as _api_BlockSetId, BlockSetInstallationDisplayMetadata as _api_BlockSetInstallationDisplayMetadata, BlockSetInstallationJobRid as _api_BlockSetInstallationJobRid, BlockSetInstallationRid as _api_BlockSetInstallationRid, BlockSetVersionId as _api_BlockSetVersionId, CompassProjectRid as _api_CompassProjectRid, FailedToSubmitJobResult as _api_FailedToSubmitJobResult, InputBlockSetShapeId as _api_InputBlockSetShapeId, InputShapeResolver as _api_InputShapeResolver, InvalidInstallBlockSetsRequest as _api_InvalidInstallBlockSetsRequest, ManagedInstallationName as _api_ManagedInstallationName, MarketplaceRid as _api_MarketplaceRid, MarkingId as _api_MarkingId, MavenGroup as _api_MavenGroup, MavenProductId as _api_MavenProductId, NamespaceRid as _api_NamespaceRid, OrganizationRid as _api_OrganizationRid, ResolvedBlockSetInputShape as _api_ResolvedBlockSetInputShape, RoleGrant as _api_RoleGrant, SlsVersion as _api_SlsVersion, UninstallResponseFailure as _api_UninstallResponseFailure, ValidateInstallBlockSetsResponse as _api_ValidateInstallBlockSetsResponse } from "../../api/__components.js";
...
export interface ApolloAgentEntityInfo {
	...
	secretInputMapping: Record<_api_InputBlockSetShapeId, _apolloagent_api_SecretResolvedBlockSetInputShape>;
}
...
export type CreateInstallationFailureResult = CreateInstallationFailureResult_failedToSubmitJob | CreateInstallationFailureResult_invalidRequest;
...
export type CreateInstallationResponse = CreateInstallationResponse_success | CreateInstallationResponse_failure;
...
export type DeleteInstallationResponse = DeleteInstallationResponse_success | DeleteInstallationResponse_failure;
...
*/
export type GetInstallationResponse = GetInstallationResponse_installation | GetInstallationResponse_failedCreationRequest;
export type InstallBlockSetsValidationError = _api_ValidateInstallBlockSetsResponse;
/**
...
export type ManagedInstallationConfiguration = ManagedInstallationConfiguration_configurationV0;
...
export type ManagedInstallationConfigurationUpdate = ManagedInstallationConfigurationUpdate_configurationV0;
export interface ManagedInstallationConfigurationV0 {
	cbacMarkings: Array<_api_MarkingId>;
	inputMapping: Record<_api_InputBlockSetShapeId, _api_ResolvedBlockSetInputShape>;
	presetInputMapping: Record<_api_InputBlockSetShapeId, _api_InputShapeResolver>;
}
/**
...
export type ManagedInstallationErrorStatus = ManagedInstallationErrorStatus_installBlockSetsValidationError | ManagedInstallationErrorStatus_jobSubmissionError | ManagedInstallationErrorStatus_jobFailedError | ManagedInstallationErrorStatus_uninstallError;
...
*/
export type ManagedInstallationGranularStatus = ManagedInstallationGranularStatus_jobRunning | ManagedInstallationGranularStatus_error | ManagedInstallationGranularStatus_success;
...
export interface NamespaceSettings {
	releaseManagementSettings?: ReleaseManagementNamespaceSettings | null | undefined;
}
...
export type UpdateInstallationFailureResult = UpdateInstallationFailureResult_failedToSubmitJob | UpdateInstallationFailureResult_invalidRequest;
export interface UpdateInstallationForBlockSetRequest {
	apolloAgentUpdate?: ApolloAgentInfoUpdate | null | undefined;
	configurationUpdate?: ManagedInstallationConfigurationUpdate | null | undefined;
	displayMetadata?: _api_BlockSetInstallationDisplayMetadata | null | undefined;
	targetBlockSetVersionId: _api_BlockSetVersionId;
...
export type UpdateInstallationResponse = UpdateInstallationResponse_success | UpdateInstallationResponse_failure;
