import type { ArtifactsRepositoryRid as _api_ArtifactsRepositoryRid, BlockSetId as _api_BlockSetId, BlockSetVersionId as _api_BlockSetVersionId, BlockSetVersionReference as _api_BlockSetVersionReference, CompassProjectRid as _api_CompassProjectRid, EddieEdgePipelineRid as _api_EddieEdgePipelineRid, ErrorGranularOutputSpecResult as _api_ErrorGranularOutputSpecResult, MarketplaceRid as _api_MarketplaceRid, MavenProductId as _api_MavenProductId, MultipassUserId as _api_MultipassUserId, PackageName as _api_PackageName, ReleaseRid as _api_ReleaseRid, ResolvedOutputSpec as _api_ResolvedOutputSpec, SlsVersion as _api_SlsVersion, TargetEnvironment as _api_TargetEnvironment, Void as _api_Void } from "../../api/__components.js";
...
export type DeleteReleaseMetadataForBlockSetResponse = DeleteReleaseMetadataForBlockSetResponse_success;
...
export type FailingGranularOutputSpecResult = FailingGranularOutputSpecResult_error | FailingGranularOutputSpecResult_unsupported;
...
export type ReleaseCreationError = ReleaseCreationError_osdkCreationFailed | ReleaseCreationError_blockSetVersionCreationFailed | ReleaseCreationError_unknownError | ReleaseCreationError_failingResourcesInProject | ReleaseCreationError_apolloPublishError;
...
export type ReleaseCreationStatus = ReleaseCreationStatus_generating | ReleaseCreationStatus_draft | ReleaseCreationStatus_finished | ReleaseCreationStatus_failed;
...
export type ReleaseTargetState = ReleaseTargetState_draft | ReleaseTargetState_finished;
export interface UpdateDraftRequest {
	acknowledgeStaticDataPackaging?: boolean | null | undefined;
	description?: string | null | undefined;
	shouldRetriggerGeneration: boolean;
	targetEnvironmentCompatibility?: Array<_api_TargetEnvironment> | null | undefined;
