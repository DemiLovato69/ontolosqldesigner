...
import type { BaseParameterConstraintType as _api_types_BaseParameterConstraintType, BaseParameterType as _api_types_BaseParameterType, BaseParameterTypeModification as _api_types_BaseParameterTypeModification, ConditionValueId as _api_types_ConditionValueId, DataValue as _api_types_DataValue, Intent as _api_types_Intent, LinkTypeSide as _api_types_LinkTypeSide, MediaMetadataType as _api_types_MediaMetadataType, NowValue as _api_types_NowValue, ObjectLocator as _api_types_ObjectLocator, OntologyIrBaseParameterConstraintType as _api_types_OntologyIrBaseParameterConstraintType, OntologyIrBaseParameterType as _api_types_OntologyIrBaseParameterType, OntologyIrDataValue as _api_types_OntologyIrDataValue, OntologyIrObjectLocator as _api_types_OntologyIrObjectLocator, ParameterRenderHint as _api_types_ParameterRenderHint, ParameterRequiredConfiguration as _api_types_ParameterRequiredConfiguration, ParameterVisibility as _api_types_ParameterVisibility, RelationSide as _api_types_RelationSide, SectionVisibility as _api_types_SectionVisibility, StructFieldIdentifier as _api_types_StructFieldIdentifier, StructParameterFieldApiName as _api_types_StructParameterFieldApiName, TemporalUnit as _api_types_TemporalUnit } from "./types/__components.js";
/**
...
export type ActionEditsValidationCondition = ActionEditsValidationCondition_modification | ActionEditsValidationCondition_creation | ActionEditsValidationCondition_deletion | ActionEditsValidationCondition_and | ActionEditsValidationCondition_or | ActionEditsValidationCondition_not;
...
*/
export type ActionEditsValidationConditionSubject = ActionEditsValidationConditionSubject_parameter | ActionEditsValidationConditionSubject_objectType | ActionEditsValidationConditionSubject_allEdits;
...
export type ActionEditsValidationModification = ActionEditsValidationModification_none | ActionEditsValidationModification_value;
...
export type ActionEditsValidationSubjectState = ActionEditsValidationSubjectState_objectSetMembership;
/**
...
*/
export type Authorization = Authorization_none | Authorization_markingIds | Authorization_redacted;
...
export type AuthorizationModification = AuthorizationModification_markingIds | AuthorizationModification_none;
/**
...
export type Condition = Condition_true | Condition_or | Condition_and | Condition_not | Condition_comparison | Condition_markings | Condition_regex | Condition_executionContext | Condition_redacted;
...
export type ConditionModification = ConditionModification_true | ConditionModification_or | ConditionModification_and | ConditionModification_not | ConditionModification_comparison | ConditionModification_markings | ConditionModification_regex | ConditionModification_executionContext | ConditionModification_redacted;
...
*/
export type DatasourceMigrationTarget = DatasourceMigrationTarget_datasetRidAndBranchId | DatasourceMigrationTarget_streamLocator | DatasourceMigrationTarget_restrictedViewRid | DatasourceMigrationTarget_timeSeriesSyncRid | DatasourceMigrationTarget_restrictedStream | DatasourceMigrationTarget_mediaSourceRids | DatasourceMigrationTarget_mediaSetView | DatasourceMigrationTarget_geotimeSeriesIntegrationRid | DatasourceMigrationTarget_table | DatasourceMigrationTarget_editsOnly | DatasourceMigrationTarget_editsOnlyV2 | DatasourceMigrationTarget_directSourceRid | DatasourceMigrationTarget_derivedPropertiesSourceRid;
/**
...
export type DeletionType = DeletionType_hardDeletion | DeletionType_softDeletion | DeletionType_trashing;
/**
* Response for ActionTypeGetOrganizationsRequest. Please note that this will contain
* OrganizationRid(s) only for ActionTypeRid(s) that are visible to the user.
*/
...
export type InterfaceTypeError = InterfaceTypeError_interfaceTypesNotFound | InterfaceTypeError_interfaceTypesAlreadyExist | InterfaceTypeError_interfaceTypeSchemaMigrationOnBranch;
/**
...
*/
export type LanguageAnalyzer = "ENGLISH" | "FRENCH" | "GERMAN" | "JAPANESE" | "KOREAN" | "ARABIC" | "COMBINED_ARABIC_ENGLISH" | "HEBREW";
/**
...
*/
export type MaterializationIdentifier = MaterializationIdentifier_restrictedViewRid | MaterializationIdentifier_writebackDatasetRid;
/**
...
* Selects which objects' edits are subject to a transition validation.
*/
export type OntologyIrActionEditsValidationConditionSubject = OntologyIrActionEditsValidationConditionSubject_parameter | OntologyIrActionEditsValidationConditionSubject_objectType | OntologyIrActionEditsValidationConditionSubject_allEdits;
...
* Contains an authorization for data read or edited / created by the action type.
*/
export type OntologyIrAuthorization = OntologyIrAuthorization_none | OntologyIrAuthorization_markingIds | OntologyIrAuthorization_redacted;
...
export type OntologyIrCondition = OntologyIrCondition_true | OntologyIrCondition_or | OntologyIrCondition_and | OntologyIrCondition_not | OntologyIrCondition_comparison | OntologyIrCondition_markings | OntologyIrCondition_regex | OntologyIrCondition_executionContext | OntologyIrCondition_redacted;
...
*/
export type OntologyIrSynchronousPreWritebackEffect = OntologyIrSynchronousPreWritebackEffect_runScheduleDeployment | OntologyIrSynchronousPreWritebackEffect_runAsyncFunction;
...
export type ParameterMarkdownOrEmpty = ParameterMarkdownOrEmpty_empty | ParameterMarkdownOrEmpty_markdown;
...
export type ParameterSidcIconOrEmpty = ParameterSidcIconOrEmpty_empty | ParameterSidcIconOrEmpty_sidcIcon;
...
* Union wrapping the various options available for configuring a platform effect which will be executed synchronously.
*/
export type SynchronousPreWritebackEffect = SynchronousPreWritebackEffect_runScheduleDeployment | SynchronousPreWritebackEffect_runAsyncFunction;
...
*/
export type SynchronousPreWritebackEffectModification = SynchronousPreWritebackEffectModification_runScheduleDeployment | SynchronousPreWritebackEffectModification_runAsyncFunction;
