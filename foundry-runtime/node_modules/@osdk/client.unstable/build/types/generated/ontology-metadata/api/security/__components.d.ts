import type { DatasetRid as _api_DatasetRid, DirectSourceRid as _api_DirectSourceRid, MarkingType as _api_MarkingType, ObjectRid as _api_ObjectRid, ObjectTypeRid as _api_ObjectTypeRid, OntologyBranchRid as _api_OntologyBranchRid, PropertySecurityGroupRid as _api_PropertySecurityGroupRid, PropertySecurityGroupType as _api_PropertySecurityGroupType, PropertyTypeId as _api_PropertyTypeId, SecurityGroupComparisonConstant as _api_SecurityGroupComparisonConstant, SecurityGroupSecurityDefinitionModification as _api_SecurityGroupSecurityDefinitionModification, StreamLocatorRid as _api_StreamLocatorRid, TableRid as _api_TableRid, UserId as _api_UserId } from "../__components.js";
...
*/
export type BackingResourceRid = BackingResourceRid_datasetRid | BackingResourceRid_streamLocatorRid | BackingResourceRid_directSourceRid | BackingResourceRid_tableRid | BackingResourceRid_editsOnlyNoRid;
...
*/
export type ObjectRidOrIdInRequest = ObjectRidOrIdInRequest_objectRid | ObjectRidOrIdInRequest_uuid;
/**
...
*/
export type PropertySecurityGroupEvaluationFailureError = PropertySecurityGroupEvaluationFailureError_granularPolicyNotPassed | PropertySecurityGroupEvaluationFailureError_mandatoryPolicyNotPassed | PropertySecurityGroupEvaluationFailureError_cannotViewObjectType | PropertySecurityGroupEvaluationFailureError_objectPolicyNotSatisfied;
/**
...
*/
export type PropertySecurityGroupEvaluationResult = PropertySecurityGroupEvaluationResult_success | PropertySecurityGroupEvaluationResult_indeterminate | PropertySecurityGroupEvaluationResult_failure;
/**
...
*/
export type PropertySecurityGroupRidOrIdInRequest = PropertySecurityGroupRidOrIdInRequest_rid | PropertySecurityGroupRidOrIdInRequest_idInRequest;
/**
...
*/
export type SecurityGroupPropertyValue = SecurityGroupPropertyValue_viewable | SecurityGroupPropertyValue_unviewable;
/**
...
*/
export type SecurityGroupPropertyValueViewable = SecurityGroupPropertyValueViewable_propertyValueUnusableInGps | SecurityGroupPropertyValueViewable_propertyValueUsableInGps;
