...
import type { ActionTypeIdentifier as _api_ActionTypeIdentifier, ActionTypeParameterIdentifier as _api_ActionTypeParameterIdentifier, DatasourceIdentifier as _api_DatasourceIdentifier, DatasourceRid as _api_DatasourceRid, InterfaceActionTypeConstraintRidOrIdInRequest as _api_InterfaceActionTypeConstraintRidOrIdInRequest, InterfaceLinkTypeRidOrIdInRequest as _api_InterfaceLinkTypeRidOrIdInRequest, InterfaceParameterConstraintRidOrIdInRequest as _api_InterfaceParameterConstraintRidOrIdInRequest, InterfacePropertyTypeRidOrIdInRequest as _api_InterfacePropertyTypeRidOrIdInRequest, InterfaceTypeRidOrIdInRequest as _api_InterfaceTypeRidOrIdInRequest, LinkTypeIdentifier as _api_LinkTypeIdentifier, LinkTypeRidOrId as _api_LinkTypeRidOrId, MaterializationIdentifier as _api_MaterializationIdentifier, ObjectTypeIdentifier as _api_ObjectTypeIdentifier, PropertyTypeIdentifier as _api_PropertyTypeIdentifier, PropertyTypeRid as _api_PropertyTypeRid, SharedPropertyTypeRidOrIdInRequest as _api_SharedPropertyTypeRidOrIdInRequest, StructFieldApiNameOrRid as _api_StructFieldApiNameOrRid, TypeGroupRidOrIdInRequest as _api_TypeGroupRidOrIdInRequest } from "../__components.js";
...
export type DatasourceComponent = DatasourceComponent_rid | DatasourceComponent_deleted;
/**
...
export type ImplementingActionTypeErrorCategory = ImplementingActionTypeErrorCategory_definition | ImplementingActionTypeErrorCategory_indeterminate;
...
export type ImplementingLinkTypeErrorCategory = ImplementingLinkTypeErrorCategory_definition | ImplementingLinkTypeErrorCategory_indeterminate;
...
export type InterfaceActionTypeConstraintErrorCategory = InterfaceActionTypeConstraintErrorCategory_definition | InterfaceActionTypeConstraintErrorCategory_parameterConstraint | InterfaceActionTypeConstraintErrorCategory_indeterminate;
...
*/
export type InterfaceImplementationErrorCategory = InterfaceImplementationErrorCategory_implementingActionType | InterfaceImplementationErrorCategory_implementingLinkType | InterfaceImplementationErrorCategory_implementingPropertyType | InterfaceImplementationErrorCategory_definition | InterfaceImplementationErrorCategory_indeterminate;
/**
...
export type InterfaceLinkTypeErrorCategory = InterfaceLinkTypeErrorCategory_definition | InterfaceLinkTypeErrorCategory_indeterminate;
/**
...
export type InterfaceParameterConstraintErrorCategory = InterfaceParameterConstraintErrorCategory_definition | InterfaceParameterConstraintErrorCategory_indeterminate;
/**
...
export type InterfacePropertyTypeErrorCategory = InterfacePropertyTypeErrorCategory_definition | InterfacePropertyTypeErrorCategory_indeterminate;
/**
...
export type InterfaceTypeErrorCategory = InterfaceTypeErrorCategory_definition | InterfaceTypeErrorCategory_interfaceLinkType | InterfaceTypeErrorCategory_interfacePropertyType | InterfaceTypeErrorCategory_interfaceActionTypeConstraint | InterfaceTypeErrorCategory_reference | InterfaceTypeErrorCategory_indeterminate;
/**
...
*/
export type InvalidInterfaceActionTypeConstraintDefinition = InvalidInterfaceActionTypeConstraintDefinition_indeterminate;
...
*/
export type InvalidInterfaceImplementationDefinition = InvalidInterfaceImplementationDefinition_indeterminate;
...
*/
export type InvalidInterfaceLinkTypeDefinition = InvalidInterfaceLinkTypeDefinition_indeterminate;
...
*/
export type InvalidInterfaceParameterConstraintDefinition = InvalidInterfaceParameterConstraintDefinition_indeterminate;
...
*/
export type InvalidInterfacePropertyTypeDefinition = InvalidInterfacePropertyTypeDefinition_indeterminate;
...
export type MaterializationErrorCategory = MaterializationErrorCategory_definition;
/**
...
export type ObjectPropertyTypeErrorCategory = ObjectPropertyTypeErrorCategory_definition | ObjectPropertyTypeErrorCategory_structField | ObjectPropertyTypeErrorCategory_reference | ObjectPropertyTypeErrorCategory_indeterminate;
/**
...
export type ObjectTypeErrorCategory = ObjectTypeErrorCategory_definition | ObjectTypeErrorCategory_propertyType | ObjectTypeErrorCategory_datasource | ObjectTypeErrorCategory_materialization | ObjectTypeErrorCategory_propertySecurityGroup | ObjectTypeErrorCategory_interfaceImplementation | ObjectTypeErrorCategory_schemaMigration | ObjectTypeErrorCategory_reference | ObjectTypeErrorCategory_indeterminate;
/**
...
export type PropertySecurityGroupErrorCategory = PropertySecurityGroupErrorCategory_definition;
/**
...
export type PropertyTypeComponent = PropertyTypeComponent_rid | PropertyTypeComponent_deleted;
...
*/
export type SchemaMigrationComponent = SchemaMigrationComponent_datasource | SchemaMigrationComponent_propertyType;
/**
