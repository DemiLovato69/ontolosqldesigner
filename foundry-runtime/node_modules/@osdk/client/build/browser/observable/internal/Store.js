...
export class Store {
  ...
  getCacheSnapshot() {
    if (__DEV__) {
      const sizeCache = this.#sizeCache ??= new WeakMap();
      const entries = [];
      let totalSize = 0;
      for (const cacheKey of this.layers.truth.keys()) {
