import { ObjectOrInterfaceDefinition, PropertyKeys, ObjectSetSubscription, Logger } from '@osdk/api';
 ...
 */
type SubscribeFn = <Q extends ObjectOrInterfaceDefinition, P extends PropertyKeys<Q>>(objectType: ObjectOrInterfaceDefinition, objectSet: ObjectSet, listener: ObjectSetSubscription.Listener<Q, P>, properties?: Array<P>, shouldLoadRids?: boolean) => Promise<() => void>;
 ...
 */
declare const createClientWithSubscribe: (subscribeFn: SubscribeFn, ...args: Parameters<typeof createClient>) => Client;

export { type SubscribeFn as S, createClient as a, createClientWithSubscribe as b, createClientWithTransaction as c };
