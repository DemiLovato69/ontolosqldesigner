 ...
 */
export function createClientFromWriteableClient(writeableClient, options) {
  ...
  return createClientWithTransaction(options?.transactionId ?? ctx.transactionId, ctx.flushEdits, options?.baseUrl ?? ctx.baseUrl, options?.ontologyRid ?? ctx.ontologyRid, options?.tokenProvider ?? ctx.tokenProvider);
}
//# sourceMappingURL=createClientFromWriteableClient.js.map