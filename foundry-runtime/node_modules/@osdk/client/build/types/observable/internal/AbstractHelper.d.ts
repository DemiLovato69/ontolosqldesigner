...
> {
	...
	protected _subscribe<PAYLOAD extends (TQuery extends Query<any, infer P, any> ? P : never)>(query: TQuery, options: TObserveOptions, subFn: Observer<PAYLOAD>): QuerySubscription<TQuery>;
}
