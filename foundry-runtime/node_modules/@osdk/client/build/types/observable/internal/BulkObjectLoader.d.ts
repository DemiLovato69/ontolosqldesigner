...
export declare class BulkObjectLoader {
	...
	fetch(apiName: string, primaryKey: string | number | boolean, defType?: DefType, select?: readonly string[], loadPropertySecurityMetadata?: boolean, includeAllBaseObjectProperties?: boolean): Promise<ObjectHolder>;
}
