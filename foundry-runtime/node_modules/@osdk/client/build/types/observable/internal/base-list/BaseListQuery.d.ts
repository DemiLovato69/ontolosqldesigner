...
> extends Query<KEY, PAYLOAD, O> {
	...
	*/
	...
	abstract get rdpConfig(): Canonical<Rdp> | undefined;
	/**
	...
	*/
	...
	private _selectFieldSetMemo;
	protected abstract get rawSelect(): Canonical<readonly string[]> | undefined;
	get selectFieldSet(): ReadonlySet<string> | undefined;
	/**
	...
	*/
	_updateList<T extends ObjectCacheKey | Osdk.Instance<any>>(items: T[], status: Status, batch: BatchContext, mode?: ListUpdateMode, totalCount?: string): Entry<KEY>;
	/**
