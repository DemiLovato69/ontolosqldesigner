...
export declare class FunctionQuery extends Query<FunctionCacheKey, FunctionPayload, FunctionObserveOptions> {
	#private;
	constructor(store: Store, subject: Subject<SubjectPayload<FunctionCacheKey>>, queryDef: QueryDefinition<unknown>, params: FunctionParams | undefined, cacheKey: FunctionCacheKey, opts: FunctionObserveOptions, objectSetTypesPromise?: Promise<string[]>);
