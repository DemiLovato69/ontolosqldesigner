...
export declare class LinksHelper extends AbstractHelper<SpecificLinkQuery, ObserveLinks.Options<ObjectOrInterfaceDefinition, string>> {
	whereCanonicalizer: WhereClauseCanonicalizer;
	orderByCanonicalizer: OrderByCanonicalizer;
	selectCanonicalizer: SelectCanonicalizer;
	constructor(store: Store, cacheKeys: CacheKeys<KnownCacheKey>, whereCanonicalizer: WhereClauseCanonicalizer, orderByCanonicalizer: OrderByCanonicalizer, selectCanonicalizer: SelectCanonicalizer);
	getQuery<
		T extends ObjectOrInterfaceDefinition,
		L extends keyof CompileTimeMetadata<T>["links"] & string
	>(options: ObserveLinks.Options<T, L>): SpecificLinkQuery;
