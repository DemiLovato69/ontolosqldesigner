...
export declare class ObjectQuery extends Query<ObjectCacheKey, ObjectPayload, CommonObserveOptions> {
	#private;
	constructor(store: Store, subject: Subject<SubjectPayload<ObjectCacheKey>>, type: string, pk: PrimaryKeyType<ObjectTypeDefinition>, cacheKey: ObjectCacheKey, opts: CommonObserveOptions, defType?: DefType, select?: readonly string[], loadPropertySecurityMetadata?: boolean, includeAllBaseObjectProperties?: boolean);
	...
	writeToStore(data: ObjectHolder, status: Status, batch: BatchContext, selectFields?: ReadonlySet<string>, computedRdpFields?: ReadonlySet<string>): Entry<ObjectCacheKey>;
