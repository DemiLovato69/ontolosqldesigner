...
export declare class ObjectSetHelper extends AbstractHelper<ObjectSetQuery, ObjectSetQueryOptions> {
	...
	constructor(store: Store, cacheKeys: CacheKeys<KnownCacheKey>, whereCanonicalizer: WhereClauseCanonicalizer, orderByCanonicalizer: OrderByCanonicalizer, rdpCanonicalizer: RdpCanonicalizer, selectCanonicalizer: SelectCanonicalizer, objectSetArrayCanonicalizer: ObjectSetArrayCanonicalizer);
