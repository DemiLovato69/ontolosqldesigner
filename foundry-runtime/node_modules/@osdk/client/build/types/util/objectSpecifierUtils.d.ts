...
*/
export declare function extractPrimaryKeyFromObjectSpecifier(ObjectSpecifier: ObjectSpecifier<any>): string;
/**
...
*/
export declare function extractObjectTypeFromObjectSpecifier(ObjectSpecifier: ObjectSpecifier<any>): string;
