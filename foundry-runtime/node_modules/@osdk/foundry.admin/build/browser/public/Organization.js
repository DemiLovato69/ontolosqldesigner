...
//
const _create = [1, "/v2/admin/organizations", 3];
/**
...
const _get = [0, "/v2/admin/organizations/{0}"];
/**
...
const _replace = [2, "/v2/admin/organizations/{0}", 1];
/**
...
const _listAvailableRoles = [0, "/v2/admin/organizations/{0}/listAvailableRoles"];
/**
 ...
 */
export function listAvailableRoles($ctx, ...args) {
