 ...
 */
export declare function list($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [organizationRid: _Core.OrganizationRid]): Promise<_Admin.ListOrganizationRoleAssignmentsResponse>;
/**
 ...
 */
export declare function add($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
 ...
 */
export declare function remove($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
    organizationRid: _Core.OrganizationRid,
    $body: _Admin.RemoveOrganizationRoleAssignmentsRequest
]): Promise<void>;
//# sourceMappingURL=OrganizationRoleAssignment.d.ts.map