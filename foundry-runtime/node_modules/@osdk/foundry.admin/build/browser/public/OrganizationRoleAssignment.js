...
//
const _list = [0, "/v2/admin/organizations/{0}/roleAssignments"];
/**
...
const _add = [1, "/v2/admin/organizations/{0}/roleAssignments/add", 1];
/**
...
const _remove = [1, "/v2/admin/organizations/{0}/roleAssignments/remove", 1];
/**
