 ...
 */
export declare function deleteUser($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [userId: _Core.UserId]): Promise<void>;
/**
 * Lists all Users.
 *
...
export declare function get($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
    userId: _Core.UserId,
    $queryParams?: {
        status?: _Core.UserStatus | undefined;
    }
]): Promise<_Admin.User>;
/**
 ...
 */
export declare function getMarkings($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [userId: _Core.UserId]): Promise<_Admin.GetUserMarkingsResponse>;
/**
 * @public
 *
 * Required Scopes: [api:admin-read]
 ...
 */
export declare function profilePicture($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [userId: _Core.UserId]): Promise<Response>;
/**
 ...
 */
export declare function revokeAllTokens($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [userId: _Core.UserId]): Promise<void>;
