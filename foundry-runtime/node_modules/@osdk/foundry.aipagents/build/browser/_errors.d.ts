...
export interface AgentIterationsExceededLimit {
    ...
    errorDescription: "The Agent was unable to produce an answer in the set number of maximum iterations. This can happen if the Agent gets confused or stuck in a loop, or if the query is too complex. Try a different query or review the Agent configuration in AIP Chatbot Studio.";
...
export interface NoPublishedAgentVersion {
    ...
    errorDescription: "Failed to retrieve the latest published version of the Agent because the Agent has no published versions. Try publishing the Agent in AIP Chatbot Studio to use the latest published version, or specify the version of the Agent to use.";
    errorInstanceId: string;
    parameters: {
        agentRid: unknown;
    };
...
export interface RetryAttemptsExceeded {
    ...
    errorDescription: "Failed to generate a response after retrying up to the configured number of retry attempts. Clients should wait and retry.";
    errorInstanceId: string;
    parameters: {
        agentRid: unknown;
        sessionRid: unknown;
...
export interface RetryDeadlineExceeded {
    ...
    errorDescription: "Failed to generate a response after retrying up to the configured retry deadline. Clients should wait and retry.";
    errorInstanceId: string;
    parameters: {
        agentRid: unknown;
        sessionRid: unknown;
