...
const _deleteSession = [3, "/v2/aipAgents/agents/{0}/sessions/{1}", 2];
/**
 ...
 */
export function deleteSession($ctx, ...args) {
...
const _updateTitle = [2, "/v2/aipAgents/agents/{0}/sessions/{1}/updateTitle", 3];
/**
 ...
 */
export function updateTitle($ctx, ...args) {
