...
export interface AsyncConsistentSnapshotError {
    ...
    errorDescription: "The async query failed because the Ontology snapshot used for consistent reads became stale. Retrying the request typically resolves this.";
...
export interface AsyncFunctionNotSupportedWithTransaction {
    ...
    errorDescription: "The function runtime does not support async execution with a transaction.";
    errorInstanceId: string;
    parameters: {
        functionRid: unknown;
        functionVersion: unknown;
...
export interface AsyncInvalidQueryOutputValue {
    ...
    errorDescription: "The value of the async query's output is invalid. This may be because the return value did not match the specified output type or constraints.";
    errorInstanceId: string;
    parameters: {
...
export interface AsyncQueryEncounteredUserFacingError {
    ...
    errorDescription: "The authored Query failed during async execution because of a user induced error. The message argument is meant to be displayed to the user.";
    errorInstanceId: string;
    parameters: {
        functionRid: unknown;
        functionVersion: unknown;
...
export interface AsyncQueryRuntimeError {
    ...
    errorDescription: "The authored Query failed to execute because of a runtime error during async execution.";
    errorInstanceId: string;
    parameters: {
        functionRid: unknown;
        functionVersion: unknown;
...
export interface CancelExecutionNotSupported {
    ...
    errorDescription: "The function runtime does not support cancelling executions.";
    errorInstanceId: string;
    parameters: {
        functionRid: unknown;
        functionVersion: unknown;
...
export interface ConsistentSnapshotError {
    ...
    errorDescription: "The query failed because the Ontology snapshot used for consistent reads became stale. Retrying the request typically resolves this.";
    errorInstanceId: string;
    parameters: {
        functionRid: unknown;
        functionVersion: unknown;
...
export interface FunctionNotSupportedWithTransaction {
    ...
    errorDescription: "The function runtime does not support execution with a transaction.";
    errorInstanceId: string;
    parameters: {
        functionRid: unknown;
        functionVersion: unknown;
