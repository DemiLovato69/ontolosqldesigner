 ...
 */
export declare function deleteResource($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [resourceRid: _Filesystem.ResourceRid]): Promise<void>;
/**
 ...
 * URL: /v2/filesystem/resources/{resourceRid}
 */
export declare function get($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [resourceRid: _Filesystem.ResourceRid]): Promise<_Filesystem.Resource>;
/**
 ...
 */
export declare function getBatch($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [$body: Array<_Filesystem.GetResourcesBatchRequestElement>]): Promise<_Filesystem.GetResourcesBatchResponse>;
/**
 ...
 */
export declare function getByPath($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [$queryParams: {
 ...
 */
export declare function getByPathBatch($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [$body: Array<_Filesystem.GetByPathResourcesBatchRequestElement>]): Promise<_Filesystem.GetByPathResourcesBatchResponse>;
/**
 ...
 */
export declare function restore($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [resourceRid: _Filesystem.ResourceRid]): Promise<void>;
/**
 ...
 */
export declare function permanentlyDelete($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [resourceRid: _Filesystem.ResourceRid]): Promise<void>;
/**
 ...
 */
export declare function addMarkings($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
 ...
 */
export declare function removeMarkings($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
    resourceRid: _Filesystem.ResourceRid,
 ...
 */
export declare function getAccessRequirements($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [resourceRid: _Filesystem.ResourceRid]): Promise<_Filesystem.AccessRequirements>;
/**
 ...
 */
export declare function markings($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
    resourceRid: _Filesystem.ResourceRid,
    $queryParams?: {
