...
//
const _deleteResource = [3, "/v2/filesystem/resources/{0}"];
/**
 ...
 */
export function deleteResource($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _deleteResource, ...args);
}
const _get = [0, "/v2/filesystem/resources/{0}"];
/**
...
const _getBatch = [1, "/v2/filesystem/resources/getBatch", 1];
/**
...
const _getByPath = [0, "/v2/filesystem/resources/getByPath", 2];
/**
 ...
 */
export function getByPath($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _getByPath, ...args);
}
const _getByPathBatch = [1, "/v2/filesystem/resources/getByPathBatch", 1];
/**
 ...
 */
export function getByPathBatch($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _getByPathBatch, ...args);
}
const _restore = [1, "/v2/filesystem/resources/{0}/restore"];
/**
 ...
 */
export function restore($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _restore, ...args);
}
const _permanentlyDelete = [1, "/v2/filesystem/resources/{0}/permanentlyDelete"];
/**
 ...
 */
export function permanentlyDelete($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _permanentlyDelete, ...args);
}
const _addMarkings = [1, "/v2/filesystem/resources/{0}/addMarkings", 1];
/**
 ...
 */
export function addMarkings($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _addMarkings, ...args);
}
const _removeMarkings = [1, "/v2/filesystem/resources/{0}/removeMarkings", 1];
/**
 ...
 */
export function removeMarkings($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _removeMarkings, ...args);
}
const _getAccessRequirements = [0, "/v2/filesystem/resources/{0}/getAccessRequirements"];
/**
 ...
 */
export function getAccessRequirements($ctx, ...args) {
  return $foundryPlatformFetch($ctx, _getAccessRequirements, ...args);
}
const _markings = [0, "/v2/filesystem/resources/{0}/markings", 2];
/**
 ...
 */
export function markings($ctx, ...args) {
