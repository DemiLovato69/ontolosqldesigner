 ...
 */
export declare function getByRidBatch($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
 ...
 */
export declare function streamingExecute($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
    queryApiName: _Functions.QueryApiName,
 ...
 */
export declare function executeAsync($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [
    queryApiName: _Functions.QueryApiName,
