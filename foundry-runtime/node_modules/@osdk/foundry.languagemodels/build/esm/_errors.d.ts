...
export interface InvalidRequest {
    ...
    errorDescription: "The request was unable to be deserialized as a valid request to this endpoint. This may be either due to missing a required field or including a field which is not supported.";
    errorInstanceId: string;
    parameters: {
        message: unknown;
        params: unknown;
...
export interface LanguageModelInferenceError {
    ...
    errorDescription: "An error was thrown by the underlying model provider during inference.";
    errorInstanceId: string;
    parameters: {
        code: unknown;
        message: unknown;
...
export interface LanguageModelNotAvailable {
    ...
    errorDescription: "The language model requested is not available in this environment.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface LanguageModelPermissionDenied {
    ...
    errorDescription: "The token provided does not have permission to use this language model.";
    errorInstanceId: string;
    parameters: {
...
export interface MultipleSystemPromptsNotSupported {
    ...
    errorDescription: "Multiple system prompts are not currently supported, but will be in the future.";
    errorInstanceId: string;
    parameters: {
...
export interface MultipleToolResultContentsNotSupported {
    ...
    errorDescription: "Multiple tool result contents are not currently supported, but will be in the future.";
    errorInstanceId: string;
    parameters: {
