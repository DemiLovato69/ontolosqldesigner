...
export type CreateConfigValidationFailureReason = ({
    ...
    type: "missingWorkerConfigOutput";
    ...
    type: "datasetSchemaNotFound";
} & DatasetSchemaNotFoundError) | ({
    type: "missingWorkerConfigInput";
 ...
 * Log Safety: SAFE
 */
export type GpuType = "A100" | "A10G" | "A16" | "H100" | "H200" | "L4" | "L40S" | "T4" | "V100";
/**
...
| FAILED | The deployment has failed. No healthy replicas are available. |
   ...
   * Log Safety: SAFE
   */
export type LiveDeploymentState = "ACTIVE" | "STARTING" | "DEGRADED" | "DISABLED" | "FAILED";
/**
 ...
 * Log Safety: UNSAFE
 */
export type ModelFunctionDisplayName = LooselyBrandedString<"ModelFunctionDisplayName">;
/**
 * Log Safety: SAFE
 */
export type ModelFunctionFunctionRid = LooselyBrandedString<"ModelFunctionFunctionRid">;
/**
 * Log Safety: UNSAFE
 */
export type ModelFunctionFunctionVersion = LooselyBrandedString<"ModelFunctionFunctionVersion">;
/**
 * Log Safety: SAFE
 */
...
export type ModelVersionSource = ({
    type: "importedContainerizedModel";
 ...
 * Log Safety: SAFE
 */
export type TrainerType = "GENERIC" | "TIME_SERIES" | "TABULAR_REGRESSION" | "TABULAR_CLASSIFICATION" | "LLM_FINETUNING" | "VLM_FINETUNING";
/**
