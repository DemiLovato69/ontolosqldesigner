...
export interface CondaSolveFailureForProvidedPackages {
    ...
    errorDescription: "Thrown when conda solve fails for the provided input packages.";
...
export interface GpuTypeNotAvailable {
    ...
    errorDescription: "The requested GPU type is not available. Use a GPU type that is available in the deployment's resource queue.";
    errorInstanceId: string;
    parameters: {
...
export interface InvalidExperimentSearchFilter {
    ...
    errorDescription: "The search filter is invalid. This can occur when using an unsupported operator and value type combination in a parameter filter, filtering by an unsupported status, or providing a malformed filter.";
    errorInstanceId: string;
    parameters: {
        reason: unknown;
    };
...
export interface InvalidGpuCount {
    ...
    errorDescription: "The GPU count is invalid. The GPU count must be between 1 and the maximum allowed for the requested GPU type.";
    errorInstanceId: string;
    parameters: {
...
export interface ModelApiTypeUnsupportedForFunction {
    ...
    errorDescription: "The model API contains a data type that is not supported for Ontology function creation.";
    errorInstanceId: string;
    parameters: {
        fieldName: unknown;
...
export interface OntologyBindingRequired {
    ...
    errorDescription: "An ontologyBinding is required when creating or replacing a model function.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface ThreadCountTooHigh {
    ...
    errorDescription: "The specified thread count exceeds the maximum allowed value.";
    errorInstanceId: string;
    parameters: {
...
export interface UnsupportedModelSource {
    ...
    errorDescription: "The Model Version has a source type that is not supported by the API. This can occur when the model was created through a legacy or internal workflow that is not exposed through the public API.";
    errorInstanceId: string;
    parameters: {};
}
