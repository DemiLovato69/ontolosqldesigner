 ...
 * Log Safety: SAFE
 */
export type DocumentSortField = "NAME" | "CREATED_TIME" | "LAST_MODIFIED_TIME" | "LAST_VIEW_TIME";
/**
 * The storage backend for a document type's schema.
 *
 * Log Safety: UNSAFE
 */
export type DocumentStorageType = {
    type: "yjs";
} & YjsSchema;
/**
 * Log Safety: UNSAFE
 ...
 * Log Safety: SAFE
 */
export type ErrorCode = "INTERNAL_ERROR" | "REVISION_TOO_OLD" | "CLIENT_VERSION_TOO_LOW" | "DOCUMENT_TYPE_OPERATIONAL_VERSION_BUMPED";
/**
 ...
 * Log Safety: SAFE
 */
export type SchemaViolationType = "FIELD_ADDED_WITH_INCORRECT_VERSION" | "FIELD_REMOVED" | "RECORD_REMOVED" | "UNION_VARIANT_MODIFICATION" | "UNION_REMOVED" | "INCORRECT_VERSION" | "ADDED_WITH_DEPRECATION" | "UNDEPRECATION_NOT_ALLOWED" | "FIELD_MODIFIED";
/**
 * Log Safety: UNSAFE
 */
