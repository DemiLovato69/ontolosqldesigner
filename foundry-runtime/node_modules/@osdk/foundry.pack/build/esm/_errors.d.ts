...
export interface InvalidDocumentTypeName {
    ...
    errorDescription: "The provided Document Type Name is invalid. First-party document type names must follow the format com.palantir.pack.<assetName>.<documentTypeName>.";
    errorInstanceId: string;
    parameters: {
        documentTypeName: unknown;
    };
