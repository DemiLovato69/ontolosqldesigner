...
export interface ColumnTypesNotSupported {
    ...
    errorDescription: "The query result contains column types that are not supported by the requested serialization format.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface QueryPermissionDenied {
    ...
    errorDescription: "The provided token does not have permission to access the given query.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface ReadQueryInputsPermissionDenied {
    ...
    errorDescription: "The provided token does not have permission to access the inputs to the query.";
    errorInstanceId: string;
    parameters: {
        rids: unknown;
    };
