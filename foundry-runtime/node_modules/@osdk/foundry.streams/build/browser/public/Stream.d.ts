 ...
 */
export declare function get($ctx: $Client | $ClientContext | $OldClient | $OldClientContext, ...args: [datasetRid: _Core.DatasetRid, streamBranchName: _Core.BranchName]): Promise<_Streams.Stream>;
/**
