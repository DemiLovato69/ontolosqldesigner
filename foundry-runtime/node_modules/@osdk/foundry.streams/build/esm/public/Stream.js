...
const _get = [0, "/v2/streams/datasets/{0}/streams/{1}"];
/**
...
const _publishRecord = [1, "/v2/highScale/streams/datasets/{0}/streams/{1}/publishRecord", 1];
/**
...
const _publishRecords = [1, "/v2/highScale/streams/datasets/{0}/streams/{1}/publishRecords", 1];
/**
