...
export interface ActionEditsNotSupportedWithMarketplace {
    ...
    errorDescription: "Returning action edits is not supported when using marketplace bindings.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface BranchNotSupportedWithMarketplaceQuery {
    ...
    errorDescription: "The branch parameter is not supported when executing queries with marketplace bindings.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface DistinctEnumValuesExceededLimit {
    ...
    errorDescription: "An enum time series contained too many distinct enum values. Check that the time series sync is using the correct value column.";
    errorInstanceId: string;
    parameters: {
...
export interface InvalidDerivedPropertyDefinitionOnInterface {
    ...
    errorDescription: "Derived property definition on an interface-typed object set was invalid due to shape of query or type checking.";
    errorInstanceId: string;
    parameters: {
        interfaceType: unknown;
        derivedProperty: unknown;
...
export interface OntologyDefinitionOutOfSync {
    ...
    errorDescription: "The ontology definition is temporarily out of sync. The indexed definition does not yet reflect the latest saved definition for this type. This is typically a transient condition that resolves as indexing completes.";
    errorInstanceId: string;
    parameters: {
        objectTypeRid: unknown;
    };
